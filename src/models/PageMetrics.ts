export interface IPageMetrics   {
        ...
        /** *shows how website is optimized on a 100-point scale* this field shows how website is optimized considering critical on-page issues and warnings detected; `100` is the highest possible score that means website does not have any critical on-page issues and important warnings; **note** that this value depends on the number of crawled pages; learn more about how the metric is calculated in [this help center article](https://dataforseo.com/help-center/how-is-onpage-score-of-a-domain-calculated) */
        onpage_score?: number | undefined
        
        /** *number of non-indexable pages* number of pages that are blocked from being indexed by Google and other search engines by robots.txt, HTTP headers, or meta tags settings; you can receive a list of non-indexable URLs using [this endpoint](https://docs.dataforseo.com/v3/on_page/non_indexable/?bash) */
