...
export interface IMerchantGoogleProductsTaskGetAdvancedResultInfo   {
        ...
        /** *types of search results found in Google Shopping SERP* contains types of all search results (`items`) found in the returned SERP possible item types: `google_shopping_sponsored_carousel`, `google_shopping_paid`, `google_shopping_serp`, `google_shopping_carousel`, `related_searches` */
        item_types?: string[] | undefined
        
        /** *the number of results returned in the **`items`** array* */
        items_count?: number | undefined
        
        /** *additional items present in the element* contains a list of related keywords; if there are none, equals `null` */
