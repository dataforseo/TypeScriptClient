export interface IContentAnalysisPhraseTrendsLiveRequestInfo   {
        ...
        /** *target keyword* **required field** UTF-8 encoding the keywords will be converted to a lowercase format; **Note**: to match an exact phrase instead of a stand-alone keyword, use double quotes and backslashes;  example:  `'keyword': '\'tesla palo alto\''` learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
