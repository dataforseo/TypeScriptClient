export interface IOnPageTaskPostRequestInfo   {
        ...
        /** *store HTML of crawled pages* optional field set to `true` if you want to get the HTML of the page using the [OnPage Raw HTML endpoint](/v3/on_page/raw_html/) default value: `false` */
        store_raw_html?: boolean | undefined
        
        /** *parse content on crawled pages* optional field set to `true` to use the [OnPage Content Parsing endpoint](/v3/on_page/content_parsing/live/) default value: `false` */
        ...
        /** *load javascript on a page* optional field set to `true` if you want to load the scripts available on a page default value: `false` **Note:** if you use this parameter, additional charges will apply; learn more about the cost of tasks with this parameter [in our help article](https://dataforseo.com/help-center/cost-of-onpage-api-parameters); the cost can be calculated on the [Pricing Page](https://dataforseo.com/pricing/on-page/onpage-api) */
        ...
        /** *emulate browser rendering to measure Core Web Vitals* optional field by using this parameter you will be able to emulate a browser when loading a web page; `enable_browser_rendering` loads styles, images, fonts, animations, videos, and other resources on a page; default value: `false` set to `true` to obtain Core Web Vitals (FID, CLS, LCP) metrics in the response; **if you use this field, `enable_javascript`, and `load_resources` parameters must be set to `true`** **Note:** if you use this parameter, additional charges will apply; learn more about the cost of tasks with this parameter [in our help article](https://dataforseo.com/help-center/cost-of-onpage-api-parameters); the cost can be calculated on the [Pricing Page](https://dataforseo.com/pricing/on-page/onpage-api) */
        ...
        /** *enable microdata validation* optional field set to `true` if you want to use the [OnPage API Microdata endpoint](/v3/on_page/microdata/) default value: `false` */
        ...
        /** *calculate keyword density for the target domain* optional field set to `true` if you want to calculate keyword density for website pages default value: `false` **Note:** if you use this parameter, additional charges will apply; learn more about the cost of tasks with this parameter [in our help article](https://dataforseo.com/help-center/cost-of-onpage-api-parameters) once the crawl is completed, you can obtain keyword density values with [the Keyword Density endpoint](/v3/on_page/keyword_density?bash) */
        ...
        /** *prevent certain sitewide checks from running* optional field specify the following `checks` to prevent them from running on the `target` website: `'test_page_not_found'` `'test_canonicalization'` `'test_https_redirect'` `'test_directory_browsing'`example: `'disable_sitewide_checks': ['test_directory_browsing', 'test_page_not_found']`learn more on [our help center](https://dataforseo.com/help-center/how-to-disable-sitewide-checks-in-onpage-api) */
        disable_sitewide_checks?: string[] | undefined
        
        /** *prevent certain page checks from running* optional field specify certain `checks` to prevent them from running and impacting the `onpage_score`example: `'disable_page_checks': ['is_5xx_code', 'is_4xx_code']` */
