...
export interface IAiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo   {
        ...
        /** *array of brands to include in the response* optional field if specified, only the listed brands will be returned in the `items` array example: `['BMW','Audi']` */
        include_brands?: string[] | undefined
        
        /** *array of brands to exclude from the response* optional field if specified, the listed brands will be omitted from the `items` array example: `['BMW','Audi']` */
        exclude_brands?: string[] | undefined
...
export class AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.include_brands = data["include_brands"];
            this.exclude_brands = data["exclude_brands"];
            this.tag = data["tag"];
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveRequestInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["include_brands"] = this.include_brands;
        data["exclude_brands"] = this.exclude_brands;
        data["tag"] = this.tag;
        return data;
    }
}