export interface IOnPageRedirectChainsRequestInfo   {
        ...
        /** *page URL* optional field absolute URL of the target page if you use this field, the API response will return only redirect chains which contain the specified URL */
        url?: string | undefined
        
        /** *the maximum number of returned redirect chains* optional field default value: `100` maximum value: `1000` */
        limit?: number | undefined
        
        /** *offset in the results array of returned redirect chains* optional field default value: `0` maximum value: `2000000` if you specify the `10` value, the first ten redirect chains in the results array will be omitted and the data will be provided for the successive redirect chains */
