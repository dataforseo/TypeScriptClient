...
export class AiOptimizationLlmMentionsTargetMetricsLiteLiveItem  implements IAiOptimizationLlmMentionsTargetMetricsLiteLiveItem {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTargetMetricsLiteLiveItem) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTargetMetricsLiteLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTargetMetricsLiteLiveItem();
        result.init(data);
        return result;
    }
