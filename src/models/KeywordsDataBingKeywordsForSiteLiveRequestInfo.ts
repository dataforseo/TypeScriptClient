export interface IKeywordsDataBingKeywordsForSiteLiveRequestInfo   {
        ...
        /** *domain or URL* **required field** the domain name or URL of the target website */
        ...
        /** *device type* optional field specify this field if you want to get the data for a particular device typepossible values: `all`, `mobile`, `desktop`, `tablet` default value: `all` */
        device?: string | undefined
        
        /** *starting date of the time range* optional field minimal value: 24 months from today's date; if you don't specify this field, data will be provided for the last 12 months; if [Status endpoint](/v3/keywords_data/bing/status/) returns `false` in the `actual_data` field, `date_from` can be set to the month before last and prior; if [Status endpoint](/v3/keywords_data/bing/status/) returns `true` in the `actual_data` field, `date_from` can be set to the last month and prior; date format: `'yyyy-mm-dd'` example: `'2020-01-01'` **Note:** we do not recommend using a custom time range for the past year's dates */
