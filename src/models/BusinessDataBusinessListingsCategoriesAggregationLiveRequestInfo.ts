export interface IBusinessDataBusinessListingsCategoriesAggregationLiveRequestInfo   {
        ...
        /** *GPS coordinates of a location* optional field `location_coordinate` parameter should be specified in the *'latitude,longitude,radius'* format the maximum number of decimal digits for *'latitude'* and *'longitude'*: 7 the minimum value for *'radius'*: `1` the maximum value for *'radius'*: `100000` example: `53.476225,-2.243572,200` learn more about how to set location parameters in this API on our [Help Center](https://dataforseo.com/help-center/how-to-specify-location-settings-in-business-listings-api) */
