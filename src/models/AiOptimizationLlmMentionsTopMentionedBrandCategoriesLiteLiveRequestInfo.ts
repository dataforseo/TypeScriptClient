...
export interface IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo   {
        ...
        /** *target platform* optional field possible values: `chat_gpt`, `google` default value: `google` **Note:** data specific to brand entities is available for `chat_gpt` only; **Note #2:**`chat_gpt` data is available for the `United States` and `English` only */
        ...
        /** *array of brand categories to include in the response* optional field if specified, only the listed brand categories will be returned in the `items` array example: `['company','insurance']` */
        include_brand_categories?: string[] | undefined
        
        /** *array of brand categories to exclude from the response* optional field if specified, the listed brand categories will be omitted from the `items` array example: `['company','insurance']` */
        exclude_brand_categories?: string[] | undefined
...
export class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.include_brand_categories = data["include_brand_categories"];
            this.exclude_brand_categories = data["exclude_brand_categories"];
            this.tag = data["tag"];
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveRequestInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["include_brand_categories"] = this.include_brand_categories;
        data["exclude_brand_categories"] = this.exclude_brand_categories;
        data["tag"] = this.tag;
        return data;
    }
}