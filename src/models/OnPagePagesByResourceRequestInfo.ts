export interface IOnPagePagesByResourceRequestInfo   {
        ...
        /** *resource URL* **required field** you can get this URL in the response of the [Resources](/v3/on_page/resources/) endpoint example: `https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js` */
