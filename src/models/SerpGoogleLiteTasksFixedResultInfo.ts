export interface ISerpGoogleLiteTasksFixedResultInfo   {
...
can take the following values: lite */
...
export class SerpGoogleLiteTasksFixedResultInfo  implements ISerpGoogleLiteTasksFixedResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleLiteTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteTasksFixedResultInfo();
        result.init(data);
        return result;
    }
