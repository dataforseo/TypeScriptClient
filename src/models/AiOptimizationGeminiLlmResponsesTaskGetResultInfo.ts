...
export interface IAiOptimizationGeminiLlmResponsesTaskGetResultInfo   {
...
export class AiOptimizationGeminiLlmResponsesTaskGetResultInfo  implements IAiOptimizationGeminiLlmResponsesTaskGetResultInfo {
...
contains related search queries derived from the main query to provide a more comprehensive response */
    ...
    constructor(data?: IAiOptimizationGeminiLlmResponsesTaskGetResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmResponsesTaskGetResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmResponsesTaskGetResultInfo();
        result.init(data);
        return result;
    }
