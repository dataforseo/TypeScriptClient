export interface ISerpGoogleLiteLiveAdvancedRequestInfo   {
...
export class SerpGoogleLiteLiveAdvancedRequestInfo  implements ISerpGoogleLiteLiveAdvancedRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpGoogleLiteLiveAdvancedRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteLiveAdvancedRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteLiveAdvancedRequestInfo();
        result.init(data);
        return result;
    }
