...
export class AiOptimizationGeminiLlmScraperLiveHtmlResultInfo  implements IAiOptimizationGeminiLlmScraperLiveHtmlResultInfo {
    ...
    constructor(data?: IAiOptimizationGeminiLlmScraperLiveHtmlResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmScraperLiveHtmlResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmScraperLiveHtmlResultInfo();
        result.init(data);
        return result;
    }
