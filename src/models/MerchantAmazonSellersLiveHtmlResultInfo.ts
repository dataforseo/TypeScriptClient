...
export class MerchantAmazonSellersLiveHtmlResultInfo  implements IMerchantAmazonSellersLiveHtmlResultInfo {
    ...
    constructor(data?: IMerchantAmazonSellersLiveHtmlResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonSellersLiveHtmlResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonSellersLiveHtmlResultInfo();
        result.init(data);
        return result;
    }
