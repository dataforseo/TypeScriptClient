...
export interface IAiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo   {
        ...
        /** *array of brands to include in the response* optional field if specified, only the listed brands will be returned in the `items` array example: `'include_brands': ['Audi']` */
        include_brands?: string[] | undefined
        
        /** *array of brands to exclude from the response* optional field if specified, the listed brands will be omitted from the `items` array example: `'exclude_brands': ['Audi']` */
...
export class AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandsLiveRequestInfo();
        result.init(data);
        return result;
    }
