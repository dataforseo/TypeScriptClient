...
export interface IClickstreamKeywordInfo   {
        ...
        /** *distribution of estimated clickstream-based metrics by gender* learn more about how the metric is calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them) */
        gender_distribution?: { [key: string]: number; } | undefined
        
        /** *distribution of clickstream-based metrics by age* learn more about how the metric is calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them) */
