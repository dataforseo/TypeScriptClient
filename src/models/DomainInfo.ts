...
export interface IDomainInfo   {
        ...
        /** *content management system* content management system identified on a website the content of_the `generator`_meta tag the data is taken from the first random page that returns the 200 response code if our crawler was unable to identify the cms, the value would be `null`n */
        ...
        /** *ssl certificate info* information about the Secure Sockets Layer protocol detected on a website */
        ...
        /** *total uncrawlable resources* the total number of resources that could not be crawled; the resource is considered uncrawlable when the actual content type of the resource doesn't match the content type expected by the crawler */
