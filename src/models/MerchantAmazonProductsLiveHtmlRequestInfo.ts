export interface IMerchantAmazonProductsLiveHtmlRequestInfo   {
...
export class MerchantAmazonProductsLiveHtmlRequestInfo  implements IMerchantAmazonProductsLiveHtmlRequestInfo {
    ...
    constructor(data?: IMerchantAmazonProductsLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): MerchantAmazonProductsLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonProductsLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
