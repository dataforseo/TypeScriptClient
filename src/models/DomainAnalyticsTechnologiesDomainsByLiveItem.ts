...
export interface IDomainAnalyticsTechnologiesDomainsByLiveItem   {
        ...
        /** *backlink rank of the target domain* learn more about the metric and how it is calculated in [this help center article](https://dataforseo.com/help-center/what_is_rank_in_backlinks_api) */
        ...
        /** *technologies used by target domain* contains objects with the names of technologies used on the website; to get a full list of technologies and their structure, refer to the [technologies endpoint](/v3/domain_analytics/technologies/technologies/) */
