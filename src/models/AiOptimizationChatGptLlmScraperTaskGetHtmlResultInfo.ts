...
2019-11-15 12:57:46 +00:00 */
    ...
    constructor(data?: IAiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationChatGptLlmScraperTaskGetHtmlResultInfo();
        result.init(data);
        return result;
    }
