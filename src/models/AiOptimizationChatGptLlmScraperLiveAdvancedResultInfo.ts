...
export interface IAiOptimizationChatGptLlmScraperLiveAdvancedResultInfo   {
        ...
        /** *types of search results* contains types of search results (`items`) found in SERP. possible item types: `chat_gpt_text`, `chat_gpt_table`, `chat_gpt_navigation_list`, `chat_gpt_images`, `chat_gpt_local_businesses`, `chat_gpt_products` */
...
export class AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo  implements IAiOptimizationChatGptLlmScraperLiveAdvancedResultInfo {
    ...
    constructor(data?: IAiOptimizationChatGptLlmScraperLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationChatGptLlmScraperLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
