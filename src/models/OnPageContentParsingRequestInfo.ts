export interface IOnPageContentParsingRequestInfo   {
        ...
        /** *ID of the task* **required field** you can get this ID in the response of the [Task POST](/v3/on_page/task_post/) endpoint **note:** the `enable_content_parsing` parameter in the POST request must be set to `true` example: `'07131248-1535-0216-1000-17384017ad04'` */
        id?: string | undefined
