...
export interface IMerchantAmazonSellersLiveAdvancedResultInfo   {
...
export class MerchantAmazonSellersLiveAdvancedResultInfo  implements IMerchantAmazonSellersLiveAdvancedResultInfo {
    ...
    constructor(data?: IMerchantAmazonSellersLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonSellersLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonSellersLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
