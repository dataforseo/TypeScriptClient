export interface IDataforseoLabsGoogleKeywordIdeasLiveRequestInfo   {
        ...
        /** *keywords* **required field** UTF-8 encoding The maximum number of keywords you can specify: 200. The keywords will be converted to lowercase format learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
        ...
        /** *search mode* optional field if set to_`true` the results will be based on the phrase-match search algorithm if set to `false` the results will be based on the broad-match search algorithm default value: `false`n */
        closely_variants?: boolean | undefined
        
        /** *ignore highly similar keywords* optional field if set to_`true` only core keywords will be returned, all highly similar keywords will be excluded;   default value: `false`n */
