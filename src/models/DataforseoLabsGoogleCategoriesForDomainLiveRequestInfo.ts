export interface IDataforseoLabsGoogleCategoriesForDomainLiveRequestInfo   {
        ...
        /** *indicates if the subcategories will be included in the search* optional field if set to `false`, the subcategories will be ignored default value: `false` learn more about the parameter in this [help center article](https://dataforseo.com/help-center/include_subcategories-in-categories-for-domain-endpoint) */
