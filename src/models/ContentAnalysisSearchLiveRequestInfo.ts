export interface IContentAnalysisSearchLiveRequestInfo   {
        ...
        /** *defines the scale used for calculating and displaying the `domain_rank`, and `url_rank` values* optional field you can use this parameter to choose whether rank values are presented on a 0–100 or 0–1000 scale possible values: `one_hundred` — rank values are displayed on a 0–100 scale `one_thousand` — rank values are displayed on a 0–1000 scale default value: `one_thousand` learn more about how this parameter works in [this Help Center article](https://dataforseo.com/help-center/using-the-rank_scale-parameter-in-content-analysis-api) */
