export interface ISerpYoutubeOrganicTasksReadyResultInfo   {
...
export class SerpYoutubeOrganicTasksReadyResultInfo  implements ISerpYoutubeOrganicTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpYoutubeOrganicTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeOrganicTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeOrganicTasksReadyResultInfo();
        result.init(data);
        return result;
    }
