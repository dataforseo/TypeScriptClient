...
export class AiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo  implements IAiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTimeseriesDeltaLiveRequestInfo();
        result.init(data);
        return result;
    }
