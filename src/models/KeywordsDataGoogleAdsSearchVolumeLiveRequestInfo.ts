export interface IKeywordsDataGoogleAdsSearchVolumeLiveRequestInfo   {
        ...
        /** *include keywords associated with adult content*optional field if set to_`true`, adult keywords will be included in the response default value:_`false` **note**_that the API may return no data for such keywords due to_[Google Ads restrictions](https://support.google.com/adspolicy/answer/6008942?hl=en)n */
