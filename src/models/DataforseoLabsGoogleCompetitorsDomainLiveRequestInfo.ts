export interface IDataforseoLabsGoogleCompetitorsDomainLiveRequestInfo   {
        ...
        /** *include or exclude data from clickstream-based metrics in the result* optional field if the parameter is set to_`true`, you will receive `clickstream_etv`, `clickstream_gender_distribution`, and_`clickstream_age_distribution`_fields with clickstream data in the response default value: `false` with this parameter enabled, you will be charged double the price for the request learn more about how clickstream-based metrics are calculated in this [help center article](https://dataforseo.com/help-center/what-are-clickstream-based-metrics-and-how-do-we-calculate-them)n */
        ...
        /** *indicates whether to exclude world's largest websites* optional field default value: `false` set to `true` if you want to get highly-relevant competitors excluding the websites listed below: `wikipedia.orgpinterest.comamazon.comgoogle.comfacebook.comwordpress.commedium.comquora.comreddit.comyoutube.comebay.comuol.com.brinstagram.comolx.comtwitter.comlinkedin.comslideshare.net` */
