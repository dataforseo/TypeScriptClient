export interface ISerpScreenshotRequestInfo   {
        ...
        /** *task identifier* **required field** unique identifier of the associated task in the [UUID](https://en.wikipedia.org/wiki/Universally_unique_identifier) format you will be able to use it within **7 days** to request the results of the task at any time */
        ...
        /** *width of the browser resolution* optional field can be specified in the following range: `240-9999` default value for `desktop`: 1920 default value for `mobile`: 390 default value for `table`: 1024 */
        browser_screen_width?: number | undefined
        
        /** *height of the browser resolution* optional field can be specified in the following range: `240-9999` default value for `desktop`: 1080 default value for `mobile`: 844 default value for `table`: 1366 */
        browser_screen_height?: number | undefined
        
        /** *browser scale factor* optional field can be specified in the following range: `0.5-3` default value for `desktop`: 1 default value for `mobile`: 3 default value for `table`: 2 */
        browser_screen_scale_factor?: number | undefined
        
        /** *number of SERP pages* optional field if `depth` in the corresponding Task POST request exceeds 10 results (or 1 SERP page), specify the number of SERP pages to screenshot; default value: `1` */
