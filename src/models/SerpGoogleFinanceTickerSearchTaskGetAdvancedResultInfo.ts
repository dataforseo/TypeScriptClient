...
export interface ISerpGoogleFinanceTickerSearchTaskGetAdvancedResultInfo   {
        ...
        /** *types of search results in SERP* contains types of search results (`items`) found in SERP; possible item types: [google_finance_market_index](#google_finance_market_index), [google_finance_asset_pair](#google_finance_asset_pair), [google_finance_market_instrument](#google_finance_market_instrument) */
        ...
        /** *items of search results found in SERP* array of items containing market indexes data; possible `type` of items: `google_finance_market_index`, `google_finance_asset_pair`, `google_finance_market_instrument` */
