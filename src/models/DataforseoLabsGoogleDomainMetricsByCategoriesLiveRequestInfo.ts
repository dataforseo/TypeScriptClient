export interface IDataforseoLabsGoogleDomainMetricsByCategoriesLiveRequestInfo   {
        ...
        /** *product and service categories* **required field** The maximum number of categories you can specify: 5 you can download [the full list of possible categories](https://cdn.dataforseo.com/v3/categories/categories_dataforseo_labs_2023_10_25.csv) */
        category_codes?: string[] | undefined
        
        /** *first date of comparison period* **required field** first date for which domain metrics will be provided; date format: `'yyyy-mm-dd'`; example: `'2021-06-01'`; the list available dates is available through the [available history endpoint](/v3/dataforseo_labs/google/available_history/live/); **Note:** `first_date` cannot be greater than today's date; **Also note:** the dates specified in `first_date` and `second_date` cannot point to the same month of the same year; you can specify the dates in any order: `first_date` can be greater than `second_date` and vice versa; minimum date: `'2020-10-01'` */
        first_date?: string | undefined
        
        /** *second date of comparison period* **required field** second date for which domain metrics will be provided; date format: `'yyyy-mm-dd'`; example: `'2021-10-01'`; the list available dates is available through the [available history endpoint](/v3/dataforseo_labs/google/available_history/live/); **Note:** `second_date` cannot be greater than today's date; **Also note:** the dates specified in `first_date` and `second_date` cannot point to the same month of the same year; you can specify the dates in any order: `second_date` can be greater than `first_date` and vice versa; minimum date: `'2020-10-01'` */
        ...
        /** *number of additional domain categories* optional field by using this parameter, you can receive domains relevant to additional categories that are not specified in `category_codes` above; to learn more about the parameter, please refer to [this help center article;](https://dataforseo.com/help-center/what-is-top_categories_count) by default, `top_categories_count` is equal to the number of categories specified in the `category_codes` array; **Note:** `top_categories_count` cannot be less than the number of categories in the `category_codes` array; maximum value: `5` */
