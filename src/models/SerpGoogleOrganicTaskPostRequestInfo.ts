...
export interface ISerpGoogleOrganicTaskPostRequestInfo   {
        ...
        /** *remove specific parameters from URLs* optional field using this field, you can specify up to 10 parameters to remove from URLs in the result example: `'remove_from_url': ['srsltid']` */
        remove_from_url?: string[] | undefined
        
        /** *expand ai overview* optional field set to `true` to expand the `ai_overview` item; default value: `false`; **Note:** this parameter applies only to [HTML task results](/v3/serp/google/organic/task_get/html/?bash) */
        expand_ai_overview?: boolean | undefined
        
        /** *clicks on the corresponding element* optional field specify the click depth on the `people_also_ask` element to get additional `people_also_ask_element` items; **Note** your account will be billed $0.00015 extra for each click regardless of task priority; if the element is absent or we perform fewer clicks than you specified, all extra charges will be returned to your account balance possible values: from `1` to `4` */
