...
amazon_serp, amazon_paid, editorial_recommendations, top_rated_from_our_brands, related_searches */
    ...
    constructor(data?: IMerchantAmazonProductsLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonProductsLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonProductsLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
