export interface ISerpGoogleLiteLiveHtmlRequestInfo   {
...
export class SerpGoogleLiteLiveHtmlRequestInfo  implements ISerpGoogleLiteLiveHtmlRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: ISerpGoogleLiteLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
