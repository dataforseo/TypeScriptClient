...
import { AiOptimizationLlmMentionsTopMentionedPagesLiveItem, IAiOptimizationLlmMentionsTopMentionedPagesLiveItem } from "./AiOptimizationLlmMentionsTopMentionedPagesLiveItem";
...
export class AiOptimizationLlmMentionsTopMentionedPagesLiveResultInfo  implements IAiOptimizationLlmMentionsTopMentionedPagesLiveResultInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedPagesLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(AiOptimizationLlmMentionsTopMentionedPagesLiveItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedPagesLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedPagesLiveResultInfo();
        result.init(data);
        return result;
    }
