...
export interface ILlmMentionsAggregatedMetricsInfo   {
        ...
        /** *aggregated mentions metrics summary* contains overall aggregated LLM mention metrics across all found domains */
...
export class LlmMentionsAggregatedMetricsInfo  implements ILlmMentionsAggregatedMetricsInfo {
    ...
    constructor(data?: ILlmMentionsAggregatedMetricsInfo) {
    ...
    static fromJS(data: any): LlmMentionsAggregatedMetricsInfo {
        data = typeof data === 'object' ? data : {};


        let result = new LlmMentionsAggregatedMetricsInfo();
        result.init(data);
        return result;
    }
