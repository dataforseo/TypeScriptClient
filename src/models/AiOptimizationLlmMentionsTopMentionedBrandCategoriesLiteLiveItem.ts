...
export interface IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem   {
        
        /** *brand category* brand category identifier of aggregated metrics */
...
export class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem  implements IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem();
        result.init(data);
        return result;
    }
