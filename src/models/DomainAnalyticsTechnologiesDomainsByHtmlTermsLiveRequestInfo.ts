export interface IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveRequestInfo   {
        ...
        /** *target keywords in the domain's title, description or meta keywords* optional field UTF-8 encoding maximum number of keywords you can specify: 10  example: `['seo','software']` learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
        ...
        /** *array of results filtering parameters* optional field **you can add several filters at once (8 filters maximum)** you should set a logical operator `and`, `or` between the conditions the following operators are supported: ``, `>=`, `=`, `<>`, `in`, `not_in`, `like`, `not_like` you can use the `%` operator with `like` and `not_like` to match any string of zero or more characters example: `['domain','like','%seo%']` `[['country_iso_code','=','US'],'and',['domain_rank','>',100]]` `[['domain_rank','>',100],'and',[['country_iso_code','=','US'],'or',['country_iso_code','=','CA']]]` for more information about filters, please refer to [Domain Analytics Technologies API - Filters](/v3/domain_analytics/technologies/filters) */
