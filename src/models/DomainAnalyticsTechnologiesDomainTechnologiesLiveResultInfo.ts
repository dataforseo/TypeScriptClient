...
export interface IDomainAnalyticsTechnologiesDomainTechnologiesLiveResultInfo   {
        ...
        /** *technologies used by target domain* contains objects with the names of technologies used on the website [see the full list of available technologies structured by groups and categories](/v3/domain_analytics/technologies/technologies/) */
