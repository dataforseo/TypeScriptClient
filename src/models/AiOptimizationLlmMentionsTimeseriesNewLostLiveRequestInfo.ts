...
export interface IAiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo   {
        ...
        /** *timeseries range* **required field** possible values: `day`, `week`, `month`, `year` */
...
export class AiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo  implements IAiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTimeseriesNewLostLiveRequestInfo();
        result.init(data);
        return result;
    }
