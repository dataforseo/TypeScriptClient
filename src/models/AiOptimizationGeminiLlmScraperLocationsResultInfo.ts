export interface IAiOptimizationGeminiLlmScraperLocationsResultInfo   {
...
export class AiOptimizationGeminiLlmScraperLocationsResultInfo  implements IAiOptimizationGeminiLlmScraperLocationsResultInfo {
    ...
    constructor(data?: IAiOptimizationGeminiLlmScraperLocationsResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmScraperLocationsResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmScraperLocationsResultInfo();
        result.init(data);
        return result;
    }
