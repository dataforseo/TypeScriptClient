export interface ISerpGoogleLiteTaskPostRequestInfo   {
...
export class SerpGoogleLiteTaskPostRequestInfo  implements ISerpGoogleLiteTaskPostRequestInfo {
...
learn more on our Help Center */
    ...
    constructor(data?: ISerpGoogleLiteTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteTaskPostRequestInfo();
        result.init(data);
        return result;
    }
