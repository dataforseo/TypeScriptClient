...
export interface IAiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo   {
        ...
        /** *array of domains to include in the response* optional field if specified, only the listed domains will be returned in the `items` array example: `'include_domains': ['en.wikipedia.org']` */
        include_domains?: string[] | undefined
        
        /** *array of domains to exclude from the response* optional field if specified, the listed domains will be omitted from the `items` array example: `'exclude_domains': ['en.wikipedia.org']` */
...
export class AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedDomainsLiveRequestInfo();
        result.init(data);
        return result;
    }
