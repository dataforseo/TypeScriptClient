...
export interface ISerpGoogleLiteLiveAdvancedResultInfo   {
...
export class SerpGoogleLiteLiveAdvancedResultInfo  implements ISerpGoogleLiteLiveAdvancedResultInfo {
...
total number of retrieved SERPs in the result */
    ...
    constructor(data?: ISerpGoogleLiteLiveAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteLiveAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteLiveAdvancedResultInfo();
        result.init(data);
        return result;
    }
