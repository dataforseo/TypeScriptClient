export interface IKeywordsDataDataforseoTrendsExploreLiveRequestInfo   {
        ...
        /** *keywords* **required field** the maximum number of keywords you can specify: 5 learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
