...
export interface IAiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo   {
...
export class AiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo  implements IAiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IAiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTargetMetricsLiteLiveRequestInfo();
        result.init(data);
        return result;
    }
