...
export class AiOptimizationLlmMentionsMultiTargetMetricsLiveItem  implements IAiOptimizationLlmMentionsMultiTargetMetricsLiveItem {
    ...
    constructor(data?: IAiOptimizationLlmMentionsMultiTargetMetricsLiveItem) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsMultiTargetMetricsLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsMultiTargetMetricsLiveItem();
        result.init(data);
        return result;
    }
