...
export interface ISerpGoogleOrganicLiveAdvancedRequestInfo   {
        ...
        /** *search engine language code* optional field if you specify `language_name` **if you use this field, you don't need to specify `language_name`** you can receive the list of available languages of the search engine with their `language_code` by making a separate request to the `https://api.dataforseo.com/v3/serp/google/languages`**example:**`en` */
