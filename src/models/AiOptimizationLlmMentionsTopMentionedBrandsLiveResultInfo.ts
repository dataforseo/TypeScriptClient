...
import { AiOptimizationLlmMentionsTopMentionedBrandsLiveItem, IAiOptimizationLlmMentionsTopMentionedBrandsLiveItem } from "./AiOptimizationLlmMentionsTopMentionedBrandsLiveItem";
...
export class AiOptimizationLlmMentionsTopMentionedBrandsLiveResultInfo  implements IAiOptimizationLlmMentionsTopMentionedBrandsLiveResultInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandsLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(AiOptimizationLlmMentionsTopMentionedBrandsLiveItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandsLiveResultInfo();
        result.init(data);
        return result;
    }
