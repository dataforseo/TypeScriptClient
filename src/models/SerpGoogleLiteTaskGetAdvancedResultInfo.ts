...
export interface ISerpGoogleLiteTaskGetAdvancedResultInfo   {
...
possible item types:
organic, paid, local_services, commercial_units, people_also_search, images, shopping, popular_products, local_pack, hotels_pack */
...
export class SerpGoogleLiteTaskGetAdvancedResultInfo  implements ISerpGoogleLiteTaskGetAdvancedResultInfo {
...
total number of retrieved SERPs in the result */
    ...
    constructor(data?: ISerpGoogleLiteTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
