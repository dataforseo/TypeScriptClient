...
export class AiOptimizationGeminiLlmResponsesTasksReadyResultInfo  implements IAiOptimizationGeminiLlmResponsesTasksReadyResultInfo {
    ...
    constructor(data?: IAiOptimizationGeminiLlmResponsesTasksReadyResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmResponsesTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmResponsesTasksReadyResultInfo();
        result.init(data);
        return result;
    }
