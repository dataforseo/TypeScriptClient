...
export interface IAiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo   {
        ...
        /** *array of pages to include in the response* optional field if specified, only the listed pages will be returned in the `items` array example: `'include_pages': ['https://example.page/']` */
        include_pages?: string[] | undefined
        
        /** *array of pages to exclude from the response* optional field if specified, the listed pages will be omitted from the `items` array example: `'exclude_pages': ['https://example.page/']` */
...
export class AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedPagesLiveRequestInfo();
        result.init(data);
        return result;
    }
