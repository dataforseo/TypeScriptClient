export interface IOnPageForceStopRequestInfo   {
        ...
        /** *ID of the task* **required field** you can get this ID in the response of the [Task POST](/v3/on_page/task_post/) endpoint example: '07131248-1535-0216-1000-17384017ad04' **note**: you can set up to 1000 `id` values as separate objects in the POST array */
        id?: string | undefined
