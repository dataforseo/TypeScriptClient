...
export interface ISerpBingOrganicTaskGetRegularResultInfo   {
        ...
        /** *types of search results in SERP* contains types of search results (`items`) found in SERP. possible item types: `organic`, `paid` */
        ...
        /** *items inside the element* array of 8 search queries related to the keyword */
