...
export class SerpYoutubeOrganicTaskGetAdvancedResultInfo  implements ISerpYoutubeOrganicTaskGetAdvancedResultInfo {
    ...
    constructor(data?: ISerpYoutubeOrganicTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeOrganicTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeOrganicTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
