...
export interface IAiOptimizationLlmMentionsTopMentionedPagesLiveItem   {
        
        /** *URL of a found page* the URL of a page found in LLM mentions for the specified target */
...
export class AiOptimizationLlmMentionsTopMentionedPagesLiveItem  implements IAiOptimizationLlmMentionsTopMentionedPagesLiveItem {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedPagesLiveItem) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedPagesLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedPagesLiveItem();
        result.init(data);
        return result;
    }
