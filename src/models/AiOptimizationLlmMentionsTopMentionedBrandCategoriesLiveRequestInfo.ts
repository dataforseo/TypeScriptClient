...
export interface IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo   {
        ...
        /** *array of brand_categories to include in the response* optional field if specified, only the listed brand categories will be returned in the `items` array example: `'include_brand_categories': ['business']` */
        include_brand_categories?: string[] | undefined
        
        /** *array of brand categories to exclude from the response* optional field if specified, the listed brand categories will be omitted from the `items` array example: `'exclude_brand_categories': ['business']` */
...
export class AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiveRequestInfo();
        result.init(data);
        return result;
    }
