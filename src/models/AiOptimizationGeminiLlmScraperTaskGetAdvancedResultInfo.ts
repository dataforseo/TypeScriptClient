...
export class AiOptimizationGeminiLlmScraperTaskGetAdvancedResultInfo  implements IAiOptimizationGeminiLlmScraperTaskGetAdvancedResultInfo {
    ...
    constructor(data?: IAiOptimizationGeminiLlmScraperTaskGetAdvancedResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationGeminiLlmScraperTaskGetAdvancedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationGeminiLlmScraperTaskGetAdvancedResultInfo();
        result.init(data);
        return result;
    }
