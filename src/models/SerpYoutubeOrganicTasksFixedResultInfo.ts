export interface ISerpYoutubeOrganicTasksFixedResultInfo   {
        ...
        /** *type of search engine* can take the following values: `{{low_se_type_under}}` */
...
export class SerpYoutubeOrganicTasksFixedResultInfo  implements ISerpYoutubeOrganicTasksFixedResultInfo {
    ...
    constructor(data?: ISerpYoutubeOrganicTasksFixedResultInfo) {
    ...
    static fromJS(data: any): SerpYoutubeOrganicTasksFixedResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeOrganicTasksFixedResultInfo();
        result.init(data);
        return result;
    }
