...
export interface IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo   {
        ...
        /** *array of domains to include in the response* optional field if specified, only the listed domains will be returned in the `items` array example: `['dataforseo.com','seoinsider.com']` */
        include_domains?: string[] | undefined
        
        /** *array of domains to exclude from the response* optional field if specified, the listed domains will be omitted from the `items` array example: `['google.com','bing.com']` */
...
export class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo  implements IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo) {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.include_domains = data["include_domains"];
            this.exclude_domains = data["exclude_domains"];
            this.tag = data["tag"];
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveRequestInfo();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["include_domains"] = this.include_domains;
