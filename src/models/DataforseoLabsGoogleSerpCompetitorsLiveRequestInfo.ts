export interface IDataforseoLabsGoogleSerpCompetitorsLiveRequestInfo   {
        ...
        /** *keywords array* **required field** the results will be based on the keywords you specify in this array UTF-8 encoding; the keywords will be converted to lowercase format; **you can specify the maximum of 200 keywords** learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
