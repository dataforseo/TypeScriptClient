export interface IDomainAnalyticsTechnologiesTechnologiesSummaryLiveRequestInfo   {
        ...
        /** *ids of the target technology groups* **required field if you don't specify `technologies`, `technology_paths`, `categories`, or `keywords`** you can find the full list of technology group ids [on this page](/v3/domain_analytics/technologies/technologies) **note:** you can specify up to 10 technology groups in this array example: `['sales', 'marketing']` */
        ...
        /** *array of results filtering parameters* optional field **you can add several filters at once (8 filters maximum)** you should set a logical operator `and`, `or` between the conditions the following operators are supported: ``, `>=`, `=`, `<>`, `in`, `not_in`, `like`,`not_like` you can use the `%` operator with `like` and `not_like` to match any string of zero or more characters you can use the following parameters to filter the results: `domain_rank`, `last_visited`, `country_iso_code`, `language_code`, `content_language_code` example: `[['country_iso_code','=','US'],'and',['domain_rank','>',800]]` for more information about filters, please refer to [Domain Analytics Technologies API - Filters](/v3/domain_analytics/technologies/filters) */
