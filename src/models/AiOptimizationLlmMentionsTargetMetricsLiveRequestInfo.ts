...
export interface IAiOptimizationLlmMentionsTargetMetricsLiveRequestInfo   {
        ...
        /** *maximum number of elements within internal arrays* optional field you can use this field to limit the number of elements within the following arrays: `sources_domain` `search_results_domain` minimum value: `1` maximum value: `10` default value: `10` */
...
export class AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo  implements IAiOptimizationLlmMentionsTargetMetricsLiveRequestInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTargetMetricsLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTargetMetricsLiveRequestInfo();
        result.init(data);
        return result;
    }
