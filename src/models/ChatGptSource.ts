export interface IChatGptSource   {
...
export class ChatGptSource  implements IChatGptSource {
...
content of the result formatted in the markdown markup language */
    ...
    constructor(data?: IChatGptSource) {
    ...
    static fromJS(data: any): ChatGptSource {
        data = typeof data === 'object' ? data : {};


        let result = new ChatGptSource();
        result.init(data);
        return result;
    }
