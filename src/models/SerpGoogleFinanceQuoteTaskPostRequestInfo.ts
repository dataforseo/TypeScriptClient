export interface ISerpGoogleFinanceQuoteTaskPostRequestInfo   {
        ...
        /** *time window for `google_finance_quote` graph* optional field possible values: `1D`, `5D`, `1M`, `6M`, `YTD`, `1Y`, `5Y`, `MAX` default value: `1D` **Note:** if you specify a value that is different from `1D`, the charge per task will be multiplied by 2 */
