...
export interface IAiOptimizationLlmMentionsTopMentionedBrandsLiveItem   {
        
        /** *brand name* name of the brand found in LLM mentions for the specified target */
...
export class AiOptimizationLlmMentionsTopMentionedBrandsLiveItem  implements IAiOptimizationLlmMentionsTopMentionedBrandsLiveItem {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedBrandsLiveItem) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedBrandsLiveItem {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedBrandsLiveItem();
        result.init(data);
        return result;
    }
