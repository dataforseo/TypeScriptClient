export interface IDataforseoLabsAmazonProductKeywordIntersectionsLiveRequestInfo   {
        ...
        /** *asins of target products* **required field** product IDs of the products for which you need to find keyword intersections; specify the ASINs as in the following example: `'asins': {'1': '019005476X','2': '0190074442'}` **the maximum number of ASINs you can specify in this object is 20;** learn more about the parameter on [this help center page](https://dataforseo.com/help-center/how-to-get-amazon-product-data-using-asin) */
        ...
        /** *mode for finding asin intersections* optional field possible values: `union`, `intersect`; default value: `intersect`; learn more about the parameter in [this help center guide](https://dataforseo.com/help-center/what-is-intersection-mode-in-amazon-keyword-intersections-endpoint) */
