...
export interface ISerpGoogleMapsTaskGetAdvancedResultInfo   {
        ...
        /** *direct URL to search engine results*you can use it to make sure that we provided exact results **Note:** to check location-specific results, follow the provided check url, scroll up and down, then click the *'Search this area'* button */
        ...
        /** *types of search results in SERP* contains types of search results (`items`) found in SERP. possible item types: `maps_search`, `maps_paid_item` */
