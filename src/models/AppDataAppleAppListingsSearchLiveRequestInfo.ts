export interface IAppDataAppleAppListingsSearchLiveRequestInfo   {
        ...
        /** *app categories* optional field the categories you specify are used to search for app listings; you can get the full list of available app listing categories by [this link](http://docs.dataforseo.com/v3/app_data/apple/app_listings/categories) you can specify **up to 10 categories** */
