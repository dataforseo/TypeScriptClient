export interface IBacklinksDomainIntersection   {
        ...
        /** *date and time when our crawler found the backlink from this `target` for the first time* in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00” example: `2019-11-15 12:57:46 +00:00` */
        first_seen?: string | undefined
        
        /** *date and time when the last backlink from this `target` was lost* indicates the date and time when our crawler visited the page and it responded with 4xx or 5xx status code or the last backlink was removed in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00” example: `2019-11-15 12:57:46 +00:00` */
        lost_date?: string | undefined
        
        /** *average spam score of the backlinks pointing to the `target`* learn more about how the metric is calculated on [this help center page](https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated) */
        ...
        /** *types of the referring links* indicates the types of referring links and link count per each type possible values: `anchor`, `image`, `link`, `meta`, `canonical`, `alternate`, `redirect` */
        referring_links_types?: { [key: string]: number; } | undefined
        
        /** *link attributes of the referring links* indicates link attributes of the referring links and the link count per each attribute */
        ...
        /** *semantic locations of the referring links* indicates semantic elements in HTML where the referring links are located and the link count per each semantic location you can get the full list of semantic elements [here](https://www.w3schools.com/html/html5_semantic_elements.asp) */
