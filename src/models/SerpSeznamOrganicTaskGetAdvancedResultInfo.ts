...
export interface ISerpSeznamOrganicTaskGetAdvancedResultInfo   {
        ...
        /** *types of search results in SERP* contains types of search results (`items`) found in SERP. possible item types: [images](#images), [local_pack](#local_pack), [organic](#organic), [related_searches](#related_searches), [top_stories](#top_stories), [featured_snippet](#featured_snippet), [video](#video), [shopping](#shopping) */
