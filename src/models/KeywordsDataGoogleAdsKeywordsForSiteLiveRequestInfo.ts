export interface IKeywordsDataGoogleAdsKeywordsForSiteLiveRequestInfo   {
        ...
        /** *include keywords associated with adult content* optional field if set to `true`, adult keywords will be included in the response default value: `false` **note** that the API may return no data for such keywords due to [Google Ads restrictions](https://support.google.com/adspolicy/answer/6008942?hl=en) */
