...
import { ProductIdentifiers, IProductIdentifiers } from "./ProductIdentifiers";
...
export interface IPopularProductsElement   {
        ...
        /** *identifiers of the product* can include the following identifiers: `product_id`, `data_docid`, `gid` */
        product_identifiers?: ProductIdentifiers | undefined
...
export class PopularProductsElement  implements IPopularProductsElement {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.product_identifiers = data["product_identifiers"] ? ProductIdentifiers.fromJS(data["product_identifiers"]) : <any>undefined;
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["product_identifiers"] = this.product_identifiers ? ProductIdentifiers.fromJS(this.product_identifiers)?.toJSON() : <any>undefined;
        return data;
    }
}