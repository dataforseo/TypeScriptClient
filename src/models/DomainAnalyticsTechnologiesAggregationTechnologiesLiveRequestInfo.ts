export interface IDomainAnalyticsTechnologiesAggregationTechnologiesLiveRequestInfo   {
        ...
        /** *id of the target technology group* **required field if you don't specify `technology`, `category` or `keyword`** at least one field (`group`, `category`, `keyword`, `technology`) must be set you can find the full list of technology group ids [on this page](/v3/domain_analytics/technologies/technologies) example: `'marketing'` */
        group?: string | undefined
        
        /** *id of the target technology category* **required field if you don't specify `group`, `keyword` or `technology`** at least one field (`group`, `category`, `keyword`, `technology`) must be set you can find the full list of technology category ids [on this page](/v3/domain_analytics/technologies/technologies) example: `'crm'` */
        category?: string | undefined
        
        /** *target technology* **required field if you don't specify `group`, `keyword` or `category`** at least one field (`group`, `category`, `keyword`, `technology`) must be set you can find the full list of technologies [on this page](/v3/domain_analytics/technologies/technologies) example: `'Salesforce'` */
        technology?: string | undefined
        
        /** *target keyword in the domain's meta keywords* **required field if you don't specify `group`, `category` or `technology`** at least one field (`group`, `category`, `keyword`, `technology`) must be set UTF-8 encoding example: `'seo'`learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
