export interface ISerpYoutubeOrganicTaskPostRequestInfo   {
        ...
        /** device type optional field return results for a specific device type available values: desktop, mobile */
...
export class SerpYoutubeOrganicTaskPostRequestInfo  implements ISerpYoutubeOrganicTaskPostRequestInfo {
    ...
    constructor(data?: ISerpYoutubeOrganicTaskPostRequestInfo) {
    ...
    static fromJS(data: any): SerpYoutubeOrganicTaskPostRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpYoutubeOrganicTaskPostRequestInfo();
        result.init(data);
        return result;
    }
