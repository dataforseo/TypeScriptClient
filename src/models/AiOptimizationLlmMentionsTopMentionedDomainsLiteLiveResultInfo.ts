import { AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem, IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem } from "./AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem";
...
export class AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveResultInfo  implements IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveResultInfo {
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopMentionedDomainsLiteLiveResultInfo) {
        ...
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                ...
                for (let item of data["items"]) {
                    this.items.push(AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveItem.fromJS(item));
                }
            }
        }
    }

    static fromJS(data: any): AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopMentionedDomainsLiteLiveResultInfo();
        result.init(data);
        return result;
    }
