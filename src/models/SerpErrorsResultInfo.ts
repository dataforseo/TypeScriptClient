export interface ISerpErrorsResultInfo   {
        ...
        /** error code of the task error code of the task generated by DataForSEO see full list of error codes */
        error_code?: number | undefined
        
        /** error message or error URL error message generated by DataForSEO, or URL that caused an error see full list of error messages */
