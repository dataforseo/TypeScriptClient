...
array containing detailed mention metrics for each of the found top domains */
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopDomainsLiveResultInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopDomainsLiveResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new AiOptimizationLlmMentionsTopDomainsLiveResultInfo();
        result.init(data);
        return result;
    }
