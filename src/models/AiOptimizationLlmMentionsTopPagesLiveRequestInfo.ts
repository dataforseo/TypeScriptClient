...
export interface IAiOptimizationLlmMentionsTopPagesLiveRequestInfo   {
...
export class AiOptimizationLlmMentionsTopPagesLiveRequestInfo  implements IAiOptimizationLlmMentionsTopPagesLiveRequestInfo {
...
you will find the specified tag value in the data object of the response */
    ...
    constructor(data?: IAiOptimizationLlmMentionsTopPagesLiveRequestInfo) {
    ...
    static fromJS(data: any): AiOptimizationLlmMentionsTopPagesLiveRequestInfo {
