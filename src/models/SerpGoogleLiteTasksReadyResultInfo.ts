export interface ISerpGoogleLiteTasksReadyResultInfo   {
...
export class SerpGoogleLiteTasksReadyResultInfo  implements ISerpGoogleLiteTasksReadyResultInfo {
...
if SERP HTML is not supported in the specified endpoint, the value will be null */
    ...
    constructor(data?: ISerpGoogleLiteTasksReadyResultInfo) {
    ...
    static fromJS(data: any): SerpGoogleLiteTasksReadyResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new SerpGoogleLiteTasksReadyResultInfo();
        result.init(data);
        return result;
    }
