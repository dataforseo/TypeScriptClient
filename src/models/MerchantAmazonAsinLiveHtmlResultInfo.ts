...
export class MerchantAmazonAsinLiveHtmlResultInfo  implements IMerchantAmazonAsinLiveHtmlResultInfo {
    ...
    constructor(data?: IMerchantAmazonAsinLiveHtmlResultInfo) {
    ...
    static fromJS(data: any): MerchantAmazonAsinLiveHtmlResultInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonAsinLiveHtmlResultInfo();
        result.init(data);
        return result;
    }
