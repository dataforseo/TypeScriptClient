...
export interface ISerpSeznamOrganicTaskPostRequestInfo   {
        ...
        /** *task priority* optional field can take the following values: 1 – normal execution priority (set by default) 2 – high execution priority You will be additionally charged for the tasks with high execution priority. The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/serp/seznam-organic-serp-api) page. */
        priority?: number | undefined
        
        /** *parsing depth* optional field number of results in SERP default value: `10`; maximum value: `500`; **Your account will be billed per each SERP containing up to 10 results;**  Setting depth above 10 may result in additional charges [if the search engine returns more than 10 results](https://dataforseo.com/help-center/how-many-results-scraped); The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/serp/seznam-organic-serp-api) page. */
        depth?: number | undefined
        
        /** *page crawl limit* optional field number of search results pages to crawl default value: `1` max value: `10` **Note:** the `max_crawl_pages` and `depth` parameters complement each other; learn more at [our help center](https://dataforseo.com/help-center/what-is-max-crawl-pages-and-how-does-it-work) */
        ...
        /** *search engine domain* optional field we choose the relevant search engine domain automatically however, you can set a custom search engine domain in this field example: ``*search.seznam.cz* */
