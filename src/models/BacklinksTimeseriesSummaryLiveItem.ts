export interface IBacklinksTimeseriesSummaryLiveItem   {
        ...
        /** *`target` rank for the given `date`* learn more about the metric and how it is calculated in [this help center article](https://dataforseo.com/help-center/what_is_rank_in_backlinks_api) */
