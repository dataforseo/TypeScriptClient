export interface IAppDataAppleAppInfoTaskPostRequestInfo   {
        ...
        /** *id of the app* **required field** ID of the mobile application on App Store; you can find the ID in the URL of every app listed on App Store; example: in the URL `https://apps.apple.com/us/app/id**835599320**` the id is `835599320` */
        ...
        /** *task priority* optional field can take the following values: 1 – normal execution priority (set by default) 2 – high execution priority You will be additionally charged for the tasks with high execution priority. The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/api/app-store) page. */
