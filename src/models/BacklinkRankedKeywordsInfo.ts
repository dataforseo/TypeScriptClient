export interface IBacklinkRankedKeywordsInfo   {
...
export class BacklinkRankedKeywordsInfo  implements IBacklinkRankedKeywordsInfo {
    ...
    constructor(data?: IBacklinkRankedKeywordsInfo) {
    ...
    static fromJS(data: any): BacklinkRankedKeywordsInfo {
        data = typeof data === 'object' ? data : {};


        let result = new BacklinkRankedKeywordsInfo();
        result.init(data);
        return result;
    }
