export interface IMerchantAmazonProductsTaskPostRequestInfo   {
        ...
        /** *keyword* **required field** you can specify **up to 700 characters** in this field **all %## will be decoded (plus character ‘+’ will be decoded to a space character)** if you need to use the “%” character for your `keyword`, please specify it as “%25”; learn more about rules and limitations of `keyword` and `keywords` fields in DataForSEO APIs in this [Help Center article](https://dataforseo.com/help-center/rules-and-limitations-of-keyword-and-keywords-fields-in-dataforseo-apis) */
        ...
        /** *task priority* optional field can take the following values: 1 – normal execution priority (set by default) 2 – high execution priorityYou will be additionally charged for the tasks with high execution priority. The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/merchant/amazon-api) page. */
        ...
        /** *parsing depth* optional field number of results to be retrieved from the Amazon results page default value: `100` max value: `700` **Your account will be billed per each SERP containing up to 100 results;**  Setting depth above 100 may result in additional charges if the search engine returns more than 100 results; The cost can be calculated on the [Pricing](https://dataforseo.com/pricing/merchant/amazon-api) page. */
        depth?: number | undefined
        
        /** *page crawl limit* optional field number of search results pages to crawl max value: `7` **Note:** the `max_crawl_pages` and `depth` parameters complement each other; learn more at [our help center](https://dataforseo.com/help-center/what-is-max-crawl-pages-and-how-does-it-work) */
        ...
        /** *minimum product price* optional field minimum price of the returned products listed on Amazon for the specified query example: `5` **Note:** if you specify `price_min`, the `search_param` parameter will be ignored */
        price_min?: number | undefined
        
        /** *maximum product price* optional field maximum price of the returned products listed on Amazon for the specified query example: `100` **Note:** if you specify `price_max`, the `search_param` parameter will be ignored */
        price_max?: number | undefined
        
        /** *results sorting rules* optional field the following sorting rules are supported: `relevance`, `price_low_to_high`, `price_high_to_low`, `featured`, `avg_customer_review`, `newest_arrival` example: `sort_by:'relevance'` **Note:** if you specify `sort_by`, the `search_param` parameter will be ignored */
