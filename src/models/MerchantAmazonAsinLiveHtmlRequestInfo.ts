export interface IMerchantAmazonAsinLiveHtmlRequestInfo   {
        
        /** *product ID* **required field** [unique product identifier (ASIN)](https://dataforseo.com/help-center/asin-in-amazon-api) in Amazon you can receive the `asin` parameter by making a separate request to the [Amazon Products endpoint](/v3/merchant/amazon/products/products/live/advanced/) */
...
export class MerchantAmazonAsinLiveHtmlRequestInfo  implements IMerchantAmazonAsinLiveHtmlRequestInfo {
    ...
    constructor(data?: IMerchantAmazonAsinLiveHtmlRequestInfo) {
    ...
    static fromJS(data: any): MerchantAmazonAsinLiveHtmlRequestInfo {
        data = typeof data === 'object' ? data : {};


        let result = new MerchantAmazonAsinLiveHtmlRequestInfo();
        result.init(data);
        return result;
    }
