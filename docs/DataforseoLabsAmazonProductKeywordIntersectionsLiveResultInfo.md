...
**location_code** | **number** | *location code in a POST array*. if there is no data, then the value is_`null` |[optional]|
**language_code** | **string** | *language code in a POST array*. if there is no data, then the value is_`null` |[optional]|
