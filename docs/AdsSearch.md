...
**first_shown** | **string** | *date and time when the ad was shown for the first time*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00” |[optional]|
**last_shown** | **string** | *date and time when the ad was shown the last time*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00” |[optional]|