...
**rank** | **number** | target rank. learn more about the metric and how it is calculated in this help center article |[optional]|
**backlinks** | **number** | indicates the number of backlinks |[optional]|
**backlinks_spam_score** | **number** | spam score of the backlinks. displays the total spam score of all backlinks pointing to the target domain, subdomain, or webpage;. to learn more about how the metric is calculated, refer to this Help Center page |[optional]|
