...
**rectangle** | **AiModeRectangleInfo** | rectangle parameters. contains cartesian coordinates and pixel dimensions of the result’s snippet in SERP;. in this case, will equal null |[optional]|