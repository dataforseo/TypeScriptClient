...
**reasoning_tokens** | **number** | number of reasoning tokens<br>total count of tokens used to generate reasoning content |[optional]|
...
**items** | **BaseAiOptimizationLlmResponseElementItem[]** | array of response items<br>contains structured AI response data |[optional]|
