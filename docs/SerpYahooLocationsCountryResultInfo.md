...
**location_type** | **string** | *location type*. indicates the geographic classification of the location. example:. `'location_type': 'Country'`, or `'location_type': 'State'` |[optional]|