...
**location_code_parent** | **number** | the code of the superordinate location. the value will be null as Country is the only supported location_type for this API |[optional]|
