...
**items** | **AiOptimizationLlmMentionsTopMentionedDomainsLiveItem[]** | *individual domain results*. array containing detailed mention metrics for each of the found top domains |[optional]|