...
**installs_count** | **number** | number of installs of the app. the exact number of installs of the app |[optional]|
...
**released_date** | **string** | date and time when the app was released. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”;. example:. 2019-11-15 12:57:46 +00:00 |[optional]|
...
**images** | **string[]** | app images. contains URLs to the images published on the app page on Google Play |[optional]|
**videos** | **string[]** | app videos. contains URLs to the video published on the app page on Google Play |[optional]|
...
**genres** | **string[]** | app genres. contains relevant app categories |[optional]|
**tags** | **string[]** | app tags. contains relevant app tags |[optional]|