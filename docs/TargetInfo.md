...
**target_spam_score** | **number** | spam score of the target. if the target is a domain/subdomain, this fields indicates the average spam score of all pages of that domain/subdomain;. learn more about how the metric is calculated on this help center page |[optional]|