...
**helpful_votes** | **string** | *helpful votes count*. number of users who clicked on the 'Helpful' button under the review text |[optional]|
...
**publication_date** | **string** | *date and time when the review was published*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”;. example:. `2019-11-15 12:57:46 +00:00` |[optional]|
