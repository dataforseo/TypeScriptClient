...
**item_types** | **string[]** | types of search results in SERP. contains types of search results (items) found in SERP.. possible item:. youtube_subtitles |[optional]|
...
**category** | **string** | the category the video belongs to. Note: this field is deprecated and always returns null |[optional]|
