...
**language_code** | **string** | language code. required field if don’t specify language_name. you can receive the list of available languages with their language_code by making a separate request to the. https://api.dataforseo.com/v3/dataforseo_labs/google/categories_for_keywords/languages. example:. en |[optional]|
