...
**time_update** | **string** | *date and time when SERP data was last updated*. in the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format: “YYYY-MM-DDThh:mm:ss.sssssssZ”. example:. `2023-05-23 10:16:19 +00:00` |[optional]|
