...
**categories** | **string[]** | all relevant categories/genres of the app<br>Note: this field returns only one relevant category in the array |[optional]|
**languages** | **string[]** | languages supported in the app<br>Note: this field returns only one supported language in the array |[optional]|
...
**released_date** | **string** | date and time when the app was released<br>in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”;<br>example:<br>2019-11-15 12:57:46 +00:00<br>Note: this field is deprecated and always returns null |[optional]|
