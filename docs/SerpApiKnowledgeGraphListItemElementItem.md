...
**data_attrid** | **string** | google defined data attribute ID. example:. ss:/webfacts:net_worth |[optional]|
**link** | **LinkElement** | link of the element |[optional]|
**items** | **KnowledgeGraphListElement[]** | additional items present in the element. if there are none, equals null |[optional]|