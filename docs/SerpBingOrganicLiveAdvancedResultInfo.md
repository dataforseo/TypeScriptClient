...
**spell** | **SpellInfo** | *autocorrection of the search engine*.             if the search engine provided results for a keyword that was corrected, we will specify the keyword corrected by the search engine and the type of autocorrection.             equals `null` |[optional]|
**refinement_chips** | **RefinementChipsInfo** | *search refinement chips*.             equals `null` |[optional]|
**item_types** | **string[]** | *types of search results in SERP*.             contains types of search results (`items`) found in SERP..             possible item types:.             [answer_box](#answer_box), [carousel](#carousel), [events](#events), [featured_snippet](#featured_snippet), [hotels_pack](#hotels), [images](#images), [jobs](#jobs), [local_pack](#local_pack), [map](#map), [organic](#organic), [paid](#paid), [people_also_ask](#people_also_ask), [people_also_search](#people_also_search), [questions_and_answers](#questions_and_answers),[recipes](#recipes), [related_searches](#related_searches), [shopping](#shopping), [top_stories](#top_stories), [video](#video), [ai_overview](#ai_overview) |[optional]|
