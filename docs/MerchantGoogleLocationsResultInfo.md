...
**location_name_parent** | **string** | the name of the superordinate location. example:. 'location_name': 'Arkansas,United States',. 'location_name_parent': 'United States' |[optional]|
