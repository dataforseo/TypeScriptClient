...
**item_types** | **string[]** | *types of search results in SERP*. contains types of search results (`items`) found in SERP;. possible item types: [google_finance_hero_groups](#google_finance_hero_groups), [google_finance_interested](#google_finance_interested), [google_finance_news](#google_finance_interested), [google_finance_earnings_calendar](#google_finance_earnings_calendar), [google_finance_most_followed](#google_finance_most_followed), [google_finance_market_trends](#google_finance_market_trends), [google_finance_people_also_search](#google_finance_people_also_search) |[optional]|
**se_results_count** | **number** | *total number of results in SERP* |[optional]|
**items_count** | **number** | *the number of results returned in the **`items`** array* |[optional]|
**items** | **BaseSerpApiGoogleFinanceElementItem[]** | *market indexes related to the market trends element*. possible `type` of items: `google_finance_asset_pair_element`, `google_finance_market_instrument_element`, `google_finance_market_index_element` |[optional]|