...
**total** | **AggregatedMetricsInfoTotalInfo** | *aggregated mentions metrics summary*. contains overall aggregated LLM mention metrics across all found domains |[optional]|