...
**endpoint_html** | **string** | URL for collecting the results of the Apple App Searches HTML task. if HTML tasks are not supported in the specified endpoint, the value will be null |[optional]|