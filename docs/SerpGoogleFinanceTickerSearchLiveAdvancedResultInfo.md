...
**item_types** | **string[]** | *types of search results in SERP*. contains types of search results (`items`) found in SERP;. possible item types: [google_finance_market_index](#google_finance_market_index), [google_finance_asset_pair](#google_finance_asset_pair), [google_finance_market_instrument](#google_finance_market_instrument) |[optional]|
