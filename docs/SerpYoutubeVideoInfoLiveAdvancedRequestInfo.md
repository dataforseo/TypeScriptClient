...
|------------ | ------------- | ------------- | -------------|
**video_id** | **string** | ID of the video. required field. you can find video ID in the URL or 'youtube_video' item of YouTube Organic result. example:. vQXvyV0zIP4 |[optional]|
