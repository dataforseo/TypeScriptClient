...
**place_id** | **string** | *unique place identifier*. [place id](https://developers.google.com/places/place-id) of the local establishment featured in the element |[optional]|
