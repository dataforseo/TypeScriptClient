...
[Documentation](../README.md) / BusinessDataYelpReviewsTaskPostResponseInfo
...
### new BusinessDataYelpReviewsTaskPostResponseInfo(data)
...
> **`static`** **fromJS**(`data`): [`BusinessDataYelpReviewsTaskPostResponseInfo`](BusinessDataYelpReviewsTaskPostResponseInfo.md)
