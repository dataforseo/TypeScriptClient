...
[Documentation](../README.md) / AppendixDayLimitsRatesData
...
### new AppendixDayLimitsRatesData(data)
...
> **`static`** **fromJS**(`data`): [`AppendixDayLimitsRatesData`](AppendixDayLimitsRatesData.md)
