...
[Documentation](../globals.md) / KeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo
...
• **data?**: [`IKeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo`](../interfaces/IKeywordsDataClickstreamDataGlobalSearchVolumeLiveResponseInfo.md)
