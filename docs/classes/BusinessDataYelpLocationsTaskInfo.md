...
[Documentation](../README.md) / BusinessDataYelpLocationsTaskInfo
...
### new BusinessDataYelpLocationsTaskInfo(data)
...
> **`static`** **fromJS**(`data`): [`BusinessDataYelpLocationsTaskInfo`](BusinessDataYelpLocationsTaskInfo.md)
