...
**custom_js_client_exception** | **string** | *error when executing a custom js*. if the error occurred when executing the script you specified in the `custom_js` field, the error message would be displayed here |[optional]|
...
**click_depth** | **number** | *number of clicks it takes to get to the page*. indicates the number of clicks from the homepage needed before landing at the target page |[optional]|
