...
**markets** | **GoogleFinanceFuturesChainElement[]** | financial markets data. array of items containing market indexes and other financial information related to these indexes |[optional]|