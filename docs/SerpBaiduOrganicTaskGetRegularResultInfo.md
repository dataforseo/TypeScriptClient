...
**item_types** | **string[]** | *types of search results found in SERP*. contains types of all search results (`items`) found in the returned SERP. possible item types:. `organic`, `paid` |[optional]|
