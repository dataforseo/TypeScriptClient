...
**total_uncrawlable_resources** | **number** | total uncrawlable resources<br>the total number of resources that could not be crawled;<br>the resource is considered uncrawlable when the actual content type of the resource doesn’t match the content type expected by the crawler |[optional]|
