...
**geo_id** | **string** | DataForSEO trends location identifier. you can use this field for matching obtained results with the location_code parameter specified in the request |[optional]|