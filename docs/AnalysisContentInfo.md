...
**text_category** | **number[]** | *text category*. to obtain a full list of available categories, refer to the [Categories](/v3/content_analysis/categories/) endpoint |[optional]|
