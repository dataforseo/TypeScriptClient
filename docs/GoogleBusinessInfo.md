...
**directory** | **BusinessDirectoryInfo** | items of the directory. includes information about businesses that are located within the target business establishment and have the same address |[optional]|
