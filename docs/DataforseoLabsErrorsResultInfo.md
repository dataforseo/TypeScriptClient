...
**error_message** | **string** | error message or error URL. error message (see full list) or URL that caused an error |[optional]|
**http_url** | **string** | URL that caused an error. URL you used for making an API call |[optional]|
