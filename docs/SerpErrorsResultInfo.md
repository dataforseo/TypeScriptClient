...
**error_code** | **number** | error code of the task. error code of the task generated by DataForSEO. see full list of error codes |[optional]|
**error_message** | **string** | error message or error URL. error message generated by DataForSEO, or URL that caused an error. see full list of error messages |[optional]|
