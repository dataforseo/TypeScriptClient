# AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveResultInfo
...
**offset** | **number** | *offset in the results array of the returned mentions data*. `offset` specified in the reqest |[optional]|
...
**items** | **AiOptimizationLlmMentionsTopMentionedBrandsLiteLiveItem[]** | *contains relevant mentions data* |[optional]|