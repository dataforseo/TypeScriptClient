...
**money_spent** | **number** | *cost of AI tokens, USD*. the price charged by the third-party AI model provider for according to its [Pricing](https://ai.google.dev/gemini-api/docs/pricing) |[optional]|
