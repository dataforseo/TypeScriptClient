...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicTasksFixedTaskInfo`**
...
- [cost](ISerpYahooOrganicTasksFixedTaskInfo.md#cost)
- [data](ISerpYahooOrganicTasksFixedTaskInfo.md#data)
- [id](ISerpYahooOrganicTasksFixedTaskInfo.md#id)
- [path](ISerpYahooOrganicTasksFixedTaskInfo.md#path)
- [result](ISerpYahooOrganicTasksFixedTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicTasksFixedTaskInfo.md#status_message)
- [time](ISerpYahooOrganicTasksFixedTaskInfo.md#time)
...
[main.ts:63662](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L63662)
