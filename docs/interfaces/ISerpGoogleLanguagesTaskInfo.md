[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLanguagesTaskInfo
...
- [cost](ISerpGoogleLanguagesTaskInfo.md#cost)
- [data](ISerpGoogleLanguagesTaskInfo.md#data)
- [id](ISerpGoogleLanguagesTaskInfo.md#id)
- [path](ISerpGoogleLanguagesTaskInfo.md#path)
- [result](ISerpGoogleLanguagesTaskInfo.md#result)
- [result\_count](ISerpGoogleLanguagesTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLanguagesTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLanguagesTaskInfo.md#status_message)
- [time](ISerpGoogleLanguagesTaskInfo.md#time)
...
[main.ts:24560](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L24560)
