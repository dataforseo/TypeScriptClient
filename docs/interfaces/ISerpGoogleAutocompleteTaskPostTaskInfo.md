[Documentation](../README.md) / [Exports](../modules.md) / ISerpGoogleAutocompleteTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleAutocompleteTaskPostTaskInfo`**
...
- [cost](ISerpGoogleAutocompleteTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleAutocompleteTaskPostTaskInfo.md#data)
- [id](ISerpGoogleAutocompleteTaskPostTaskInfo.md#id)
- [path](ISerpGoogleAutocompleteTaskPostTaskInfo.md#path)
- [result](ISerpGoogleAutocompleteTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleAutocompleteTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleAutocompleteTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleAutocompleteTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleAutocompleteTaskPostTaskInfo.md#time)
