...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocationsCountryTaskInfo`**
...
- [cost](ISerpBingLocationsCountryTaskInfo.md#cost)
- [data](ISerpBingLocationsCountryTaskInfo.md#data)
- [id](ISerpBingLocationsCountryTaskInfo.md#id)
- [path](ISerpBingLocationsCountryTaskInfo.md#path)
- [result](ISerpBingLocationsCountryTaskInfo.md#result)
- [result\_count](ISerpBingLocationsCountryTaskInfo.md#result_count)
- [status\_code](ISerpBingLocationsCountryTaskInfo.md#status_code)
- [status\_message](ISerpBingLocationsCountryTaskInfo.md#status_message)
- [time](ISerpBingLocationsCountryTaskInfo.md#time)
...
[main.ts:53454](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L53454)
