[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpScreenshotTaskInfo
...
- [cost](ISerpScreenshotTaskInfo.md#cost)
- [data](ISerpScreenshotTaskInfo.md#data)
- [id](ISerpScreenshotTaskInfo.md#id)
- [path](ISerpScreenshotTaskInfo.md#path)
- [result](ISerpScreenshotTaskInfo.md#result)
- [result\_count](ISerpScreenshotTaskInfo.md#result_count)
- [status\_code](ISerpScreenshotTaskInfo.md#status_code)
- [status\_message](ISerpScreenshotTaskInfo.md#status_message)
- [time](ISerpScreenshotTaskInfo.md#time)
...
[main.ts:23666](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L23666)
