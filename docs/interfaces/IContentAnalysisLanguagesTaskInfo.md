[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisLanguagesTaskInfo`**
...
- [cost](IContentAnalysisLanguagesTaskInfo.md#cost)
- [data](IContentAnalysisLanguagesTaskInfo.md#data)
- [id](IContentAnalysisLanguagesTaskInfo.md#id)
- [path](IContentAnalysisLanguagesTaskInfo.md#path)
- [result](IContentAnalysisLanguagesTaskInfo.md#result)
- [result\_count](IContentAnalysisLanguagesTaskInfo.md#result_count)
- [status\_code](IContentAnalysisLanguagesTaskInfo.md#status_code)
- [status\_message](IContentAnalysisLanguagesTaskInfo.md#status_message)
- [time](IContentAnalysisLanguagesTaskInfo.md#time)
...
[main.ts:155791](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L155791)
