...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleHistoricalRankOverviewLiveTaskInfo.md#time)
...
[main.ts:96660](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L96660)
