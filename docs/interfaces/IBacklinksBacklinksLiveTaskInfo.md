...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBacklinksLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBacklinksLiveTaskInfo`**
...
- [cost](IBacklinksBacklinksLiveTaskInfo.md#cost)
- [data](IBacklinksBacklinksLiveTaskInfo.md#data)
- [id](IBacklinksBacklinksLiveTaskInfo.md#id)
- [path](IBacklinksBacklinksLiveTaskInfo.md#path)
- [result](IBacklinksBacklinksLiveTaskInfo.md#result)
- [result\_count](IBacklinksBacklinksLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBacklinksLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBacklinksLiveTaskInfo.md#status_message)
- [time](IBacklinksBacklinksLiveTaskInfo.md#time)
...
[main.ts:131625](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L131625)
