[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageKeywordDensityTaskInfo
...
- [cost](IOnPageKeywordDensityTaskInfo.md#cost)
- [data](IOnPageKeywordDensityTaskInfo.md#data)
- [id](IOnPageKeywordDensityTaskInfo.md#id)
- [path](IOnPageKeywordDensityTaskInfo.md#path)
- [result](IOnPageKeywordDensityTaskInfo.md#result)
- [result\_count](IOnPageKeywordDensityTaskInfo.md#result_count)
- [status\_code](IOnPageKeywordDensityTaskInfo.md#status_code)
- [status\_message](IOnPageKeywordDensityTaskInfo.md#status_message)
- [time](IOnPageKeywordDensityTaskInfo.md#time)
...
[main.ts:150433](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L150433)
