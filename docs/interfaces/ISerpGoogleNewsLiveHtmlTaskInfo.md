[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleNewsLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleNewsLiveHtmlTaskInfo`**
...
- [cost](ISerpGoogleNewsLiveHtmlTaskInfo.md#cost)
- [data](ISerpGoogleNewsLiveHtmlTaskInfo.md#data)
- [id](ISerpGoogleNewsLiveHtmlTaskInfo.md#id)
- [path](ISerpGoogleNewsLiveHtmlTaskInfo.md#path)
- [result](ISerpGoogleNewsLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleNewsLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleNewsLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleNewsLiveHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleNewsLiveHtmlTaskInfo.md#time)
...
[main.ts:43512](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L43512)
