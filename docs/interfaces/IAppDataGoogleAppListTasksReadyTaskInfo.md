[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListTasksReadyTaskInfo`**
...
- [cost](IAppDataGoogleAppListTasksReadyTaskInfo.md#cost)
- [data](IAppDataGoogleAppListTasksReadyTaskInfo.md#data)
- [id](IAppDataGoogleAppListTasksReadyTaskInfo.md#id)
- [path](IAppDataGoogleAppListTasksReadyTaskInfo.md#path)
- [result](IAppDataGoogleAppListTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListTasksReadyTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListTasksReadyTaskInfo.md#time)
...
[main.ts:178742](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L178742)
