[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesDomainsByHtmlTermsLiveTaskInfo.md#time)
...
[main.ts:74998](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L74998)
