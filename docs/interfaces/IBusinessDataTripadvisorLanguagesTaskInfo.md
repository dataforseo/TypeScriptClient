[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorLanguagesTaskInfo`**
...
- [cost](IBusinessDataTripadvisorLanguagesTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorLanguagesTaskInfo.md#data)
- [id](IBusinessDataTripadvisorLanguagesTaskInfo.md#id)
- [path](IBusinessDataTripadvisorLanguagesTaskInfo.md#path)
- [result](IBusinessDataTripadvisorLanguagesTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorLanguagesTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorLanguagesTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorLanguagesTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorLanguagesTaskInfo.md#time)
...
[main.ts:200834](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L200834)
