...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo`**
...
- [cost](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#data)
- [id](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#id)
- [path](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#path)
- [result](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAmazonProductRankOverviewLiveTaskInfo.md#time)
...
[main.ts:100912](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L100912)
