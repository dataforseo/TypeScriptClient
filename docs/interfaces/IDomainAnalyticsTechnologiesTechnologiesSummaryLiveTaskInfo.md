[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesTechnologiesSummaryLiveTaskInfo.md#time)
...
[main.ts:73430](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L73430)
