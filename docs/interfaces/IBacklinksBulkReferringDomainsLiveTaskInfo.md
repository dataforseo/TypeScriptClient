...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBulkReferringDomainsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBulkReferringDomainsLiveTaskInfo`**
...
- [cost](IBacklinksBulkReferringDomainsLiveTaskInfo.md#cost)
- [data](IBacklinksBulkReferringDomainsLiveTaskInfo.md#data)
- [id](IBacklinksBulkReferringDomainsLiveTaskInfo.md#id)
- [path](IBacklinksBulkReferringDomainsLiveTaskInfo.md#path)
- [result](IBacklinksBulkReferringDomainsLiveTaskInfo.md#result)
- [result\_count](IBacklinksBulkReferringDomainsLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBulkReferringDomainsLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBulkReferringDomainsLiveTaskInfo.md#status_message)
- [time](IBacklinksBulkReferringDomainsLiveTaskInfo.md#time)
...
[main.ts:140615](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L140615)
