[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpSearchTaskGetTaskInfo

# Interface: IBusinessDataYelpSearchTaskGetTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)

  ↳ **`IBusinessDataYelpSearchTaskGetTaskInfo`**
...
- [cost](IBusinessDataYelpSearchTaskGetTaskInfo.md#cost)
- [data](IBusinessDataYelpSearchTaskGetTaskInfo.md#data)
- [id](IBusinessDataYelpSearchTaskGetTaskInfo.md#id)
- [path](IBusinessDataYelpSearchTaskGetTaskInfo.md#path)
- [result](IBusinessDataYelpSearchTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataYelpSearchTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpSearchTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpSearchTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataYelpSearchTaskGetTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpSearchTaskGetResultInfo`](../classes/BusinessDataYelpSearchTaskGetResultInfo.md)[]

array of results

#### Defined in

[main.ts:204612](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L204612)
