[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksTimeseriesSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksTimeseriesSummaryLiveTaskInfo`**
...
- [cost](IBacklinksTimeseriesSummaryLiveTaskInfo.md#cost)
- [data](IBacklinksTimeseriesSummaryLiveTaskInfo.md#data)
- [id](IBacklinksTimeseriesSummaryLiveTaskInfo.md#id)
- [path](IBacklinksTimeseriesSummaryLiveTaskInfo.md#path)
- [result](IBacklinksTimeseriesSummaryLiveTaskInfo.md#result)
- [result\_count](IBacklinksTimeseriesSummaryLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksTimeseriesSummaryLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksTimeseriesSummaryLiveTaskInfo.md#status_message)
- [time](IBacklinksTimeseriesSummaryLiveTaskInfo.md#time)
...
[main.ts:138773](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L138773)
