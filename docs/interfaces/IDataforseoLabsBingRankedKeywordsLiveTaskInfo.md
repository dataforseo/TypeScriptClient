...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingRankedKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingRankedKeywordsLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingRankedKeywordsLiveTaskInfo.md#time)
...
[main.ts:105560](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L105560)
