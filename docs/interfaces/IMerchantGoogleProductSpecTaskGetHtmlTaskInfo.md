...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductSpecTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductSpecTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantGoogleProductSpecTaskGetHtmlTaskInfo.md#time)
...
[main.ts:168363](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L168363)
