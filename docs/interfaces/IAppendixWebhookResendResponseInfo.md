...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppendixWebhookResendResponseInfo
...
- [cost](IAppendixWebhookResendResponseInfo.md#cost)
- [status\_code](IAppendixWebhookResendResponseInfo.md#status_code)
- [status\_message](IAppendixWebhookResendResponseInfo.md#status_message)
- [tasks](IAppendixWebhookResendResponseInfo.md#tasks)
- [tasks\_count](IAppendixWebhookResendResponseInfo.md#tasks_count)
- [tasks\_error](IAppendixWebhookResendResponseInfo.md#tasks_error)
- [time](IAppendixWebhookResendResponseInfo.md#time)
- [version](IAppendixWebhookResendResponseInfo.md#version)
...
[main.ts:212671](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L212671)
