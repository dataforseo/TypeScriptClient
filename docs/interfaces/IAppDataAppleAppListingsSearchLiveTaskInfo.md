...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppListingsSearchLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppListingsSearchLiveTaskInfo`**
...
- [cost](IAppDataAppleAppListingsSearchLiveTaskInfo.md#cost)
- [data](IAppDataAppleAppListingsSearchLiveTaskInfo.md#data)
- [id](IAppDataAppleAppListingsSearchLiveTaskInfo.md#id)
- [path](IAppDataAppleAppListingsSearchLiveTaskInfo.md#path)
- [result](IAppDataAppleAppListingsSearchLiveTaskInfo.md#result)
- [result\_count](IAppDataAppleAppListingsSearchLiveTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppListingsSearchLiveTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppListingsSearchLiveTaskInfo.md#status_message)
- [time](IAppDataAppleAppListingsSearchLiveTaskInfo.md#time)
...
[main.ts:187082](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L187082)
