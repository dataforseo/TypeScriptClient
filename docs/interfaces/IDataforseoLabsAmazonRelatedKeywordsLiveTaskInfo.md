[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo`**
...
- [cost](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#data)
- [id](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#id)
- [path](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#path)
- [result](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAmazonRelatedKeywordsLiveTaskInfo.md#time)
...
[main.ts:99512](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L99512)
