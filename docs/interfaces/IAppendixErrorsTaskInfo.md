...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppendixErrorsTaskInfo
...
- [cost](IAppendixErrorsTaskInfo.md#cost)
- [data](IAppendixErrorsTaskInfo.md#data)
- [id](IAppendixErrorsTaskInfo.md#id)
- [path](IAppendixErrorsTaskInfo.md#path)
- [result](IAppendixErrorsTaskInfo.md#result)
- [result\_count](IAppendixErrorsTaskInfo.md#result_count)
- [status\_code](IAppendixErrorsTaskInfo.md#status_code)
- [status\_message](IAppendixErrorsTaskInfo.md#status_message)
- [time](IAppendixErrorsTaskInfo.md#time)
...
[main.ts:212454](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L212454)
