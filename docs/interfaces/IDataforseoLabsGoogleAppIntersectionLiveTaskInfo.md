[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleAppIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleAppIntersectionLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleAppIntersectionLiveTaskInfo.md#time)
...
[main.ts:110104](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L110104)
