...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpSeznamLocationsCountryTaskInfo`**
...
- [cost](ISerpSeznamLocationsCountryTaskInfo.md#cost)
- [data](ISerpSeznamLocationsCountryTaskInfo.md#data)
- [id](ISerpSeznamLocationsCountryTaskInfo.md#id)
- [path](ISerpSeznamLocationsCountryTaskInfo.md#path)
- [result](ISerpSeznamLocationsCountryTaskInfo.md#result)
- [result\_count](ISerpSeznamLocationsCountryTaskInfo.md#result_count)
- [status\_code](ISerpSeznamLocationsCountryTaskInfo.md#status_code)
- [status\_message](ISerpSeznamLocationsCountryTaskInfo.md#status_message)
- [time](ISerpSeznamLocationsCountryTaskInfo.md#time)
...
[main.ts:69068](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L69068)
