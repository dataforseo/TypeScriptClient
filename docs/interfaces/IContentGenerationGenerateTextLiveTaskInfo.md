[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationGenerateTextLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationGenerateTextLiveTaskInfo`**
...
- [cost](IContentGenerationGenerateTextLiveTaskInfo.md#cost)
- [data](IContentGenerationGenerateTextLiveTaskInfo.md#data)
- [id](IContentGenerationGenerateTextLiveTaskInfo.md#id)
- [path](IContentGenerationGenerateTextLiveTaskInfo.md#path)
- [result](IContentGenerationGenerateTextLiveTaskInfo.md#result)
- [result\_count](IContentGenerationGenerateTextLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationGenerateTextLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationGenerateTextLiveTaskInfo.md#status_message)
- [time](IContentGenerationGenerateTextLiveTaskInfo.md#time)
...
[main.ts:160509](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L160509)
