[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantErrorsTaskInfo
...
- [cost](IMerchantErrorsTaskInfo.md#cost)
- [data](IMerchantErrorsTaskInfo.md#data)
- [id](IMerchantErrorsTaskInfo.md#id)
- [path](IMerchantErrorsTaskInfo.md#path)
- [result](IMerchantErrorsTaskInfo.md#result)
- [result\_count](IMerchantErrorsTaskInfo.md#result_count)
- [status\_code](IMerchantErrorsTaskInfo.md#status_code)
- [status\_message](IMerchantErrorsTaskInfo.md#status_message)
- [time](IMerchantErrorsTaskInfo.md#time)
...
[main.ts:163281](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L163281)
