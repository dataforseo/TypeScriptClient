...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksDomainPagesSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksDomainPagesSummaryLiveTaskInfo`**
...
- [cost](IBacklinksDomainPagesSummaryLiveTaskInfo.md#cost)
- [data](IBacklinksDomainPagesSummaryLiveTaskInfo.md#data)
- [id](IBacklinksDomainPagesSummaryLiveTaskInfo.md#id)
- [path](IBacklinksDomainPagesSummaryLiveTaskInfo.md#path)
- [result](IBacklinksDomainPagesSummaryLiveTaskInfo.md#result)
- [result\_count](IBacklinksDomainPagesSummaryLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksDomainPagesSummaryLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksDomainPagesSummaryLiveTaskInfo.md#status_message)
- [time](IBacklinksDomainPagesSummaryLiveTaskInfo.md#time)
...
[main.ts:134315](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L134315)
