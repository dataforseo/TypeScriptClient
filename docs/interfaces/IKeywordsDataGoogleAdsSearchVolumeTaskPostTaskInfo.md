...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsSearchVolumeTaskPostTaskInfo.md#time)
...
[main.ts:113508](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L113508)
