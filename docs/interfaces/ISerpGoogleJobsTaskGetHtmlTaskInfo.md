...
- [cost](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#data)
- [id](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#id)
- [path](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#path)
- [result](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleJobsTaskGetHtmlTaskInfo.md#time)
