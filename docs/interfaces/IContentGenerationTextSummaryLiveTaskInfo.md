[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationTextSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationTextSummaryLiveTaskInfo`**
...
- [cost](IContentGenerationTextSummaryLiveTaskInfo.md#cost)
- [data](IContentGenerationTextSummaryLiveTaskInfo.md#data)
- [id](IContentGenerationTextSummaryLiveTaskInfo.md#id)
- [path](IContentGenerationTextSummaryLiveTaskInfo.md#path)
- [result](IContentGenerationTextSummaryLiveTaskInfo.md#result)
- [result\_count](IContentGenerationTextSummaryLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationTextSummaryLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationTextSummaryLiveTaskInfo.md#status_message)
- [time](IContentGenerationTextSummaryLiveTaskInfo.md#time)
...
[main.ts:162425](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L162425)
