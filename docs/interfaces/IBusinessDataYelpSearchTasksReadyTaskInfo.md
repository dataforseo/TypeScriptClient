[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpSearchTasksReadyTaskInfo

# Interface: IBusinessDataYelpSearchTasksReadyTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)

  ↳ **`IBusinessDataYelpSearchTasksReadyTaskInfo`**
...
- [cost](IBusinessDataYelpSearchTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataYelpSearchTasksReadyTaskInfo.md#data)
- [id](IBusinessDataYelpSearchTasksReadyTaskInfo.md#id)
- [path](IBusinessDataYelpSearchTasksReadyTaskInfo.md#path)
- [result](IBusinessDataYelpSearchTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataYelpSearchTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpSearchTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpSearchTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataYelpSearchTasksReadyTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpSearchTasksReadyResultInfo`](../classes/BusinessDataYelpSearchTasksReadyResultInfo.md)[]

array of results

#### Defined in

[main.ts:203810](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L203810)
