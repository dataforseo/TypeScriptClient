...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisIdListTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisIdListTaskInfo`**
...
- [cost](IContentAnalysisIdListTaskInfo.md#cost)
- [data](IContentAnalysisIdListTaskInfo.md#data)
- [id](IContentAnalysisIdListTaskInfo.md#id)
- [path](IContentAnalysisIdListTaskInfo.md#path)
- [result](IContentAnalysisIdListTaskInfo.md#result)
- [result\_count](IContentAnalysisIdListTaskInfo.md#result_count)
- [status\_code](IContentAnalysisIdListTaskInfo.md#status_code)
- [status\_message](IContentAnalysisIdListTaskInfo.md#status_message)
- [time](IContentAnalysisIdListTaskInfo.md#time)
...
[main.ts:155293](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L155293)
