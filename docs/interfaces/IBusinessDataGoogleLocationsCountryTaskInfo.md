...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleLocationsCountryTaskInfo`**
...
- [cost](IBusinessDataGoogleLocationsCountryTaskInfo.md#cost)
- [data](IBusinessDataGoogleLocationsCountryTaskInfo.md#data)
- [id](IBusinessDataGoogleLocationsCountryTaskInfo.md#id)
- [path](IBusinessDataGoogleLocationsCountryTaskInfo.md#path)
- [result](IBusinessDataGoogleLocationsCountryTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleLocationsCountryTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleLocationsCountryTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleLocationsCountryTaskInfo.md#status_message)
- [time](IBusinessDataGoogleLocationsCountryTaskInfo.md#time)
...
[main.ts:190492](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L190492)
