...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpNaverOrganicTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpNaverOrganicTasksReadyTaskInfo`**
...
- [cost](ISerpNaverOrganicTasksReadyTaskInfo.md#cost)
- [data](ISerpNaverOrganicTasksReadyTaskInfo.md#data)
- [id](ISerpNaverOrganicTasksReadyTaskInfo.md#id)
- [path](ISerpNaverOrganicTasksReadyTaskInfo.md#path)
- [result](ISerpNaverOrganicTasksReadyTaskInfo.md#result)
- [result\_count](ISerpNaverOrganicTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpNaverOrganicTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpNaverOrganicTasksReadyTaskInfo.md#status_message)
- [time](ISerpNaverOrganicTasksReadyTaskInfo.md#time)
...
[main.ts:67734](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L67734)
