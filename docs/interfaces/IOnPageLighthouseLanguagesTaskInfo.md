[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageLighthouseLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageLighthouseLanguagesTaskInfo`**
...
- [cost](IOnPageLighthouseLanguagesTaskInfo.md#cost)
- [data](IOnPageLighthouseLanguagesTaskInfo.md#data)
- [id](IOnPageLighthouseLanguagesTaskInfo.md#id)
- [path](IOnPageLighthouseLanguagesTaskInfo.md#path)
- [result](IOnPageLighthouseLanguagesTaskInfo.md#result)
- [result\_count](IOnPageLighthouseLanguagesTaskInfo.md#result_count)
- [status\_code](IOnPageLighthouseLanguagesTaskInfo.md#status_code)
- [status\_message](IOnPageLighthouseLanguagesTaskInfo.md#status_message)
- [time](IOnPageLighthouseLanguagesTaskInfo.md#time)
...
[main.ts:153615](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L153615)
