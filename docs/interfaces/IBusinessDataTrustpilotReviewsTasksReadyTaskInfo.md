[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotReviewsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotReviewsTasksReadyTaskInfo`**
...
- [cost](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#data)
- [id](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#id)
- [path](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#path)
- [result](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotReviewsTasksReadyTaskInfo.md#time)
...
[main.ts:199812](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L199812)
