[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationCheckGrammarLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationCheckGrammarLanguagesTaskInfo`**
...
- [cost](IContentGenerationCheckGrammarLanguagesTaskInfo.md#cost)
- [data](IContentGenerationCheckGrammarLanguagesTaskInfo.md#data)
- [id](IContentGenerationCheckGrammarLanguagesTaskInfo.md#id)
- [path](IContentGenerationCheckGrammarLanguagesTaskInfo.md#path)
- [result](IContentGenerationCheckGrammarLanguagesTaskInfo.md#result)
- [result\_count](IContentGenerationCheckGrammarLanguagesTaskInfo.md#result_count)
- [status\_code](IContentGenerationCheckGrammarLanguagesTaskInfo.md#status_code)
- [status\_message](IContentGenerationCheckGrammarLanguagesTaskInfo.md#status_message)
- [time](IContentGenerationCheckGrammarLanguagesTaskInfo.md#time)
...
[main.ts:161897](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L161897)
