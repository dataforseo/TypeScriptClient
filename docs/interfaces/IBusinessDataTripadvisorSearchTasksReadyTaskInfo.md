...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorSearchTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorSearchTasksReadyTaskInfo`**
...
- [cost](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#data)
- [id](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#id)
- [path](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#path)
- [result](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorSearchTasksReadyTaskInfo.md#time)
...
[main.ts:201306](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L201306)
