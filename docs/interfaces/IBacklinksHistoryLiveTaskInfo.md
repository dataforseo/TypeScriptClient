[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksHistoryLiveTaskInfo
...
- [cost](IBacklinksHistoryLiveTaskInfo.md#cost)
- [data](IBacklinksHistoryLiveTaskInfo.md#data)
- [id](IBacklinksHistoryLiveTaskInfo.md#id)
- [path](IBacklinksHistoryLiveTaskInfo.md#path)
- [result](IBacklinksHistoryLiveTaskInfo.md#result)
- [result\_count](IBacklinksHistoryLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksHistoryLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksHistoryLiveTaskInfo.md#status_message)
- [time](IBacklinksHistoryLiveTaskInfo.md#time)
...
[main.ts:130497](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L130497)
