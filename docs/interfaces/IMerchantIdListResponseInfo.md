...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantIdListResponseInfo
...
- [cost](IMerchantIdListResponseInfo.md#cost)
- [status\_code](IMerchantIdListResponseInfo.md#status_code)
- [status\_message](IMerchantIdListResponseInfo.md#status_message)
- [tasks](IMerchantIdListResponseInfo.md#tasks)
- [tasks\_count](IMerchantIdListResponseInfo.md#tasks_count)
- [tasks\_error](IMerchantIdListResponseInfo.md#tasks_error)
- [time](IMerchantIdListResponseInfo.md#time)
- [version](IMerchantIdListResponseInfo.md#version)
...
[main.ts:162994](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L162994)
