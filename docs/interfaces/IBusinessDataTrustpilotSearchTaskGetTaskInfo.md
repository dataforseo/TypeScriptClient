...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotSearchTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotSearchTaskGetTaskInfo`**
...
- [cost](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#data)
- [id](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#id)
- [path](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#path)
- [result](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotSearchTaskGetTaskInfo.md#time)
...
[main.ts:199348](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L199348)
