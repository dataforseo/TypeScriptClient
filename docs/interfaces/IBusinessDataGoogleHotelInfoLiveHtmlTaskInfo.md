[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelInfoLiveHtmlTaskInfo.md#time)
...
[main.ts:197697](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L197697)
