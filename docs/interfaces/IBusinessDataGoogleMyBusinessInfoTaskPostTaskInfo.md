...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo`**
...
- [cost](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#cost)
- [data](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#data)
- [id](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#id)
- [path](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#path)
- [result](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataGoogleMyBusinessInfoTaskPostTaskInfo.md#time)
...
[main.ts:190762](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L190762)
