...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleKeywordsForSiteLiveTaskInfo.md#time)
...
[main.ts:79906](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L79906)
