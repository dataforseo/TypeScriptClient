...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppendixStatusTaskInfo
...
- [cost](IAppendixStatusTaskInfo.md#cost)
- [data](IAppendixStatusTaskInfo.md#data)
- [id](IAppendixStatusTaskInfo.md#id)
- [path](IAppendixStatusTaskInfo.md#path)
- [result](IAppendixStatusTaskInfo.md#result)
- [result\_count](IAppendixStatusTaskInfo.md#result_count)
- [status\_code](IAppendixStatusTaskInfo.md#status_code)
- [status\_message](IAppendixStatusTaskInfo.md#status_message)
- [time](IAppendixStatusTaskInfo.md#time)
...
[main.ts:212916](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L212916)
