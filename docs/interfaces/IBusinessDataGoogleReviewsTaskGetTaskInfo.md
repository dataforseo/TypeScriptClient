[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleReviewsTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleReviewsTaskGetTaskInfo`**
...
- [cost](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#cost)
- [data](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#data)
- [id](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#id)
- [path](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#path)
- [result](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataGoogleReviewsTaskGetTaskInfo.md#time)
...
[main.ts:198604](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L198604)
