...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordPerformanceTasksReadyTaskInfo.md#time)
...
[main.ts:127061](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L127061)
