...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppendixUserDataTaskInfo
...
- [cost](IAppendixUserDataTaskInfo.md#cost)
- [data](IAppendixUserDataTaskInfo.md#data)
- [id](IAppendixUserDataTaskInfo.md#id)
- [path](IAppendixUserDataTaskInfo.md#path)
- [result](IAppendixUserDataTaskInfo.md#result)
- [result\_count](IAppendixUserDataTaskInfo.md#result_count)
- [status\_code](IAppendixUserDataTaskInfo.md#status_code)
- [status\_message](IAppendixUserDataTaskInfo.md#status_message)
- [time](IAppendixUserDataTaskInfo.md#time)
...
[main.ts:212288](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L212288)
