[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeLanguagesTaskInfo
...
- [cost](ISerpYoutubeLanguagesTaskInfo.md#cost)
- [data](ISerpYoutubeLanguagesTaskInfo.md#data)
- [id](ISerpYoutubeLanguagesTaskInfo.md#id)
- [path](ISerpYoutubeLanguagesTaskInfo.md#path)
- [result](ISerpYoutubeLanguagesTaskInfo.md#result)
- [result\_count](ISerpYoutubeLanguagesTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeLanguagesTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeLanguagesTaskInfo.md#status_message)
- [time](ISerpYoutubeLanguagesTaskInfo.md#time)
...
[main.ts:57672](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L57672)
