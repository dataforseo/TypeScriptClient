...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataBusinessListingsLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataBusinessListingsLocationsTaskInfo`**
...
- [cost](IBusinessDataBusinessListingsLocationsTaskInfo.md#cost)
- [data](IBusinessDataBusinessListingsLocationsTaskInfo.md#data)
- [id](IBusinessDataBusinessListingsLocationsTaskInfo.md#id)
- [path](IBusinessDataBusinessListingsLocationsTaskInfo.md#path)
- [result](IBusinessDataBusinessListingsLocationsTaskInfo.md#result)
- [result\_count](IBusinessDataBusinessListingsLocationsTaskInfo.md#result_count)
- [status\_code](IBusinessDataBusinessListingsLocationsTaskInfo.md#status_code)
- [status\_message](IBusinessDataBusinessListingsLocationsTaskInfo.md#status_message)
- [time](IBusinessDataBusinessListingsLocationsTaskInfo.md#time)
...
[main.ts:187944](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L187944)
