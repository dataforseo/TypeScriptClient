...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingSearchVolumeTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingSearchVolumeTaskGetTaskInfo`**
...
- [cost](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#cost)
- [data](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#data)
- [id](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#id)
- [path](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#path)
- [result](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#result)
- [result\_count](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#status_message)
- [time](IKeywordsDataBingSearchVolumeTaskGetTaskInfo.md#time)
...
[main.ts:123059](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L123059)
