[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsKeywordsForKeywordsLiveTaskInfo.md#time)
...
[main.ts:117505](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L117505)
