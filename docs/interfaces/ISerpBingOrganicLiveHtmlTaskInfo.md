...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicLiveHtmlTaskInfo`**
...
- [cost](ISerpBingOrganicLiveHtmlTaskInfo.md#cost)
- [data](ISerpBingOrganicLiveHtmlTaskInfo.md#data)
- [id](ISerpBingOrganicLiveHtmlTaskInfo.md#id)
- [path](ISerpBingOrganicLiveHtmlTaskInfo.md#path)
- [result](ISerpBingOrganicLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpBingOrganicLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicLiveHtmlTaskInfo.md#status_message)
- [time](ISerpBingOrganicLiveHtmlTaskInfo.md#time)
...
[main.ts:55626](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L55626)
