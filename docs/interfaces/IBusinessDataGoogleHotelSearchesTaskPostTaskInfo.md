[Documentation](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelSearchesTaskPostTaskInfo
...
- [cost](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelSearchesTaskPostTaskInfo.md#time)
