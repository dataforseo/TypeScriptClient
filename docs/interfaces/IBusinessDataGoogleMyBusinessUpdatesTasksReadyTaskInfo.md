[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo`**
...
- [cost](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#data)
- [id](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#id)
- [path](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#path)
- [result](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataGoogleMyBusinessUpdatesTasksReadyTaskInfo.md#time)
...
[main.ts:192287](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L192287)
