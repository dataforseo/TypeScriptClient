[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsCategoriesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsCategoriesTaskInfo`**
...
- [cost](IDataforseoLabsCategoriesTaskInfo.md#cost)
- [data](IDataforseoLabsCategoriesTaskInfo.md#data)
- [id](IDataforseoLabsCategoriesTaskInfo.md#id)
- [path](IDataforseoLabsCategoriesTaskInfo.md#path)
- [result](IDataforseoLabsCategoriesTaskInfo.md#result)
- [result\_count](IDataforseoLabsCategoriesTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsCategoriesTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsCategoriesTaskInfo.md#status_message)
- [time](IDataforseoLabsCategoriesTaskInfo.md#time)
...
[main.ts:78262](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L78262)
