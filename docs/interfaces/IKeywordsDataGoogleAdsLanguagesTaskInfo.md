...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsLanguagesTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsLanguagesTaskInfo.md#time)
...
[main.ts:113404](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L113404)
