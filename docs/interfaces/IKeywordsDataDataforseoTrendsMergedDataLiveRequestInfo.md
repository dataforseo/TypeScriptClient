[Documentation](../README.md) / [Exports](../modules.md) / IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo
...
- [date\_from](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#date_from)
- [date\_to](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#date_to)
- [keywords](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#keywords)
- [location\_code](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#location_code)
- [location\_name](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#location_name)
- [tag](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#tag)
- [time\_range](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#time_range)
- [type](IKeywordsDataDataforseoTrendsMergedDataLiveRequestInfo.md#type)
