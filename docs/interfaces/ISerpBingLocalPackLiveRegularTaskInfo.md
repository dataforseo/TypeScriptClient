...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackLiveRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackLiveRegularTaskInfo`**
...
- [cost](ISerpBingLocalPackLiveRegularTaskInfo.md#cost)
- [data](ISerpBingLocalPackLiveRegularTaskInfo.md#data)
- [id](ISerpBingLocalPackLiveRegularTaskInfo.md#id)
- [path](ISerpBingLocalPackLiveRegularTaskInfo.md#path)
- [result](ISerpBingLocalPackLiveRegularTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackLiveRegularTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackLiveRegularTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackLiveRegularTaskInfo.md#status_message)
- [time](ISerpBingLocalPackLiveRegularTaskInfo.md#time)
...
[main.ts:56892](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L56892)
