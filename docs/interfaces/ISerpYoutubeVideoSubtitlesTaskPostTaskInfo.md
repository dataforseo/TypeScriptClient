[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoSubtitlesTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoSubtitlesTaskPostTaskInfo`**
...
- [cost](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#cost)
- [data](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#data)
- [id](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#id)
- [path](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#path)
- [result](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoSubtitlesTaskPostTaskInfo.md#time)
...
[main.ts:59734](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L59734)
