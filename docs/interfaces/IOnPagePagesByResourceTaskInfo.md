[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPagePagesByResourceTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPagePagesByResourceTaskInfo`**
...
- [cost](IOnPagePagesByResourceTaskInfo.md#cost)
- [data](IOnPagePagesByResourceTaskInfo.md#data)
- [id](IOnPagePagesByResourceTaskInfo.md#id)
- [path](IOnPagePagesByResourceTaskInfo.md#path)
- [result](IOnPagePagesByResourceTaskInfo.md#result)
- [result\_count](IOnPagePagesByResourceTaskInfo.md#result_count)
- [status\_code](IOnPagePagesByResourceTaskInfo.md#status_code)
- [status\_message](IOnPagePagesByResourceTaskInfo.md#status_message)
- [time](IOnPagePagesByResourceTaskInfo.md#time)
...
[main.ts:145649](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L145649)
