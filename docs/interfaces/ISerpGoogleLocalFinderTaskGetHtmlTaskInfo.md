[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocalFinderTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleLocalFinderTaskGetHtmlTaskInfo`**
...
- [cost](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#data)
- [id](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#id)
- [path](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#path)
- [result](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleLocalFinderTaskGetHtmlTaskInfo.md#time)
...
[main.ts:40898](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L40898)
