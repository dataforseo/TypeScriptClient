[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleSellersTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleSellersTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantGoogleSellersTaskGetHtmlTaskInfo.md#time)
...
[main.ts:167193](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L167193)
