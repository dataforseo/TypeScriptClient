...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicLiveAdvancedTaskInfo`**
...
- [cost](ISerpYahooOrganicLiveAdvancedTaskInfo.md#cost)
- [data](ISerpYahooOrganicLiveAdvancedTaskInfo.md#data)
- [id](ISerpYahooOrganicLiveAdvancedTaskInfo.md#id)
- [path](ISerpYahooOrganicLiveAdvancedTaskInfo.md#path)
- [result](ISerpYahooOrganicLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpYahooOrganicLiveAdvancedTaskInfo.md#time)
...
[main.ts:64922](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L64922)
