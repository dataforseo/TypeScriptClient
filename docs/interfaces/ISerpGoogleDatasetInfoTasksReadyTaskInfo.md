[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetInfoTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetInfoTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetInfoTasksReadyTaskInfo.md#time)
...
[main.ts:52232](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L52232)
