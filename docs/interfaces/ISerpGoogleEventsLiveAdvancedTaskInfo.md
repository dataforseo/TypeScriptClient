[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleEventsLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleEventsLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleEventsLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleEventsLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleEventsLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleEventsLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleEventsLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleEventsLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleEventsLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleEventsLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleEventsLiveAdvancedTaskInfo.md#time)
...
[main.ts:45506](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L45506)
