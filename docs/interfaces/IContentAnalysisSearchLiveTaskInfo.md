...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisSearchLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisSearchLiveTaskInfo`**
...
- [cost](IContentAnalysisSearchLiveTaskInfo.md#cost)
- [data](IContentAnalysisSearchLiveTaskInfo.md#data)
- [id](IContentAnalysisSearchLiveTaskInfo.md#id)
- [path](IContentAnalysisSearchLiveTaskInfo.md#path)
- [result](IContentAnalysisSearchLiveTaskInfo.md#result)
- [result\_count](IContentAnalysisSearchLiveTaskInfo.md#result_count)
- [status\_code](IContentAnalysisSearchLiveTaskInfo.md#status_code)
- [status\_message](IContentAnalysisSearchLiveTaskInfo.md#status_message)
- [time](IContentAnalysisSearchLiveTaskInfo.md#time)
...
[main.ts:156975](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L156975)
