[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleHistoricalSerpsLiveTaskInfo.md#time)
...
[main.ts:92394](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L92394)
