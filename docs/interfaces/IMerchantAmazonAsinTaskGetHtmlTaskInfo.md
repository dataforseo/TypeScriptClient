...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonAsinTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonAsinTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantAmazonAsinTaskGetHtmlTaskInfo.md#time)
...
[main.ts:173496](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L173496)
