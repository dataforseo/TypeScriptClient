...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetInfoTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetInfoTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetInfoTasksFixedTaskInfo.md#time)
...
[main.ts:52444](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L52444)
