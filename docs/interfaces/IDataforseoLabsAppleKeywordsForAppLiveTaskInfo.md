...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAppleKeywordsForAppLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAppleKeywordsForAppLiveTaskInfo`**
...
- [cost](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#data)
- [id](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#id)
- [path](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#path)
- [result](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAppleKeywordsForAppLiveTaskInfo.md#time)
...
[main.ts:111044](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L111044)
