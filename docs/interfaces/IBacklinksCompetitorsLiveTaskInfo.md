[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksCompetitorsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksCompetitorsLiveTaskInfo`**
...
- [cost](IBacklinksCompetitorsLiveTaskInfo.md#cost)
- [data](IBacklinksCompetitorsLiveTaskInfo.md#data)
- [id](IBacklinksCompetitorsLiveTaskInfo.md#id)
- [path](IBacklinksCompetitorsLiveTaskInfo.md#path)
- [result](IBacklinksCompetitorsLiveTaskInfo.md#result)
- [result\_count](IBacklinksCompetitorsLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksCompetitorsLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksCompetitorsLiveTaskInfo.md#status_message)
- [time](IBacklinksCompetitorsLiveTaskInfo.md#time)
...
[main.ts:136313](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L136313)
