[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingLocationsTaskInfo`**
...
- [cost](IKeywordsDataBingLocationsTaskInfo.md#cost)
- [data](IKeywordsDataBingLocationsTaskInfo.md#data)
- [id](IKeywordsDataBingLocationsTaskInfo.md#id)
- [path](IKeywordsDataBingLocationsTaskInfo.md#path)
- [result](IKeywordsDataBingLocationsTaskInfo.md#result)
- [result\_count](IKeywordsDataBingLocationsTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingLocationsTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingLocationsTaskInfo.md#status_message)
- [time](IKeywordsDataBingLocationsTaskInfo.md#time)
...
[main.ts:122059](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L122059)
