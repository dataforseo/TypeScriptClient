[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocalFinderLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleLocalFinderLiveHtmlTaskInfo`**
...
- [cost](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#cost)
- [data](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#data)
- [id](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#id)
- [path](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#path)
- [result](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleLocalFinderLiveHtmlTaskInfo.md#time)
...
[main.ts:41900](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L41900)
