...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpLocationsCountryTaskInfo

# Interface: IBusinessDataYelpLocationsCountryTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  
  ↳ **`IBusinessDataYelpLocationsCountryTaskInfo`**
...
- [cost](IBusinessDataYelpLocationsCountryTaskInfo.md#cost)
- [data](IBusinessDataYelpLocationsCountryTaskInfo.md#data)
- [id](IBusinessDataYelpLocationsCountryTaskInfo.md#id)
- [path](IBusinessDataYelpLocationsCountryTaskInfo.md#path)
- [result](IBusinessDataYelpLocationsCountryTaskInfo.md#result)
- [result\_count](IBusinessDataYelpLocationsCountryTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpLocationsCountryTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpLocationsCountryTaskInfo.md#status_message)
- [time](IBusinessDataYelpLocationsCountryTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpLocationsCountryResultInfo`](../classes/BusinessDataYelpLocationsCountryResultInfo.md)[]

array of results

#### Defined in

[main.ts:203108](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L203108)
