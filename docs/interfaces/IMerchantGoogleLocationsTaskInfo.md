...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleLocationsTaskInfo`**
...
- [cost](IMerchantGoogleLocationsTaskInfo.md#cost)
- [data](IMerchantGoogleLocationsTaskInfo.md#data)
- [id](IMerchantGoogleLocationsTaskInfo.md#id)
- [path](IMerchantGoogleLocationsTaskInfo.md#path)
- [result](IMerchantGoogleLocationsTaskInfo.md#result)
- [result\_count](IMerchantGoogleLocationsTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleLocationsTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleLocationsTaskInfo.md#status_message)
- [time](IMerchantGoogleLocationsTaskInfo.md#time)
...
[main.ts:163637](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L163637)
