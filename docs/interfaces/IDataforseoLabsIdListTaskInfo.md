[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsIdListTaskInfo
...
- [cost](IDataforseoLabsIdListTaskInfo.md#cost)
- [data](IDataforseoLabsIdListTaskInfo.md#data)
- [id](IDataforseoLabsIdListTaskInfo.md#id)
- [path](IDataforseoLabsIdListTaskInfo.md#path)
- [result](IDataforseoLabsIdListTaskInfo.md#result)
- [result\_count](IDataforseoLabsIdListTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsIdListTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsIdListTaskInfo.md#status_message)
- [time](IDataforseoLabsIdListTaskInfo.md#time)
...
[main.ts:76710](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L76710)
