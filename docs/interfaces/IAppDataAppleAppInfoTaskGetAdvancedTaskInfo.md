...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppInfoTaskGetAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppInfoTaskGetAdvancedTaskInfo`**
...
- [cost](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#cost)
- [data](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#data)
- [id](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#id)
- [path](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#path)
- [result](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#result)
- [result\_count](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#status_message)
- [time](IAppDataAppleAppInfoTaskGetAdvancedTaskInfo.md#time)
...
[main.ts:184816](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L184816)
