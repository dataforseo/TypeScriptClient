...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesTaskGetHtmlTaskInfo`**
...
- [cost](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#data)
- [id](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#id)
- [path](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#path)
- [result](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleImagesTaskGetHtmlTaskInfo.md#time)
...
[main.ts:46614](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L46614)
