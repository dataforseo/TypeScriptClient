[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelInfoTaskGetHtmlTaskInfo.md#time)
...
[main.ts:196471](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L196471)
