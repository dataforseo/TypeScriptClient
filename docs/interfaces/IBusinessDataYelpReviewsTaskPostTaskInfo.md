...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataYelpReviewsTaskPostTaskInfo`**
...
- [cost](IBusinessDataYelpReviewsTaskPostTaskInfo.md#cost)
- [data](IBusinessDataYelpReviewsTaskPostTaskInfo.md#data)
- [id](IBusinessDataYelpReviewsTaskPostTaskInfo.md#id)
- [path](IBusinessDataYelpReviewsTaskPostTaskInfo.md#path)
- [result](IBusinessDataYelpReviewsTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataYelpReviewsTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpReviewsTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpReviewsTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataYelpReviewsTaskPostTaskInfo.md#time)
