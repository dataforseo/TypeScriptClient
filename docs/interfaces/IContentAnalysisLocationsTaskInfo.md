...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisLocationsTaskInfo`**
...
- [cost](IContentAnalysisLocationsTaskInfo.md#cost)
- [data](IContentAnalysisLocationsTaskInfo.md#data)
- [id](IContentAnalysisLocationsTaskInfo.md#id)
- [path](IContentAnalysisLocationsTaskInfo.md#path)
- [result](IContentAnalysisLocationsTaskInfo.md#result)
- [result\_count](IContentAnalysisLocationsTaskInfo.md#result_count)
- [status\_code](IContentAnalysisLocationsTaskInfo.md#status_code)
- [status\_message](IContentAnalysisLocationsTaskInfo.md#status_message)
- [time](IContentAnalysisLocationsTaskInfo.md#time)
...
[main.ts:155625](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L155625)
