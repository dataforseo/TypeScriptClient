...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageSummaryTaskInfo
...
- [cost](IOnPageSummaryTaskInfo.md#cost)
- [data](IOnPageSummaryTaskInfo.md#data)
- [id](IOnPageSummaryTaskInfo.md#id)
- [path](IOnPageSummaryTaskInfo.md#path)
- [result](IOnPageSummaryTaskInfo.md#result)
- [result\_count](IOnPageSummaryTaskInfo.md#result_count)
- [status\_code](IOnPageSummaryTaskInfo.md#status_code)
- [status\_message](IOnPageSummaryTaskInfo.md#status_message)
- [time](IOnPageSummaryTaskInfo.md#time)
...
[main.ts:143819](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L143819)
