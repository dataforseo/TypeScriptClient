[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataErrorsTaskInfo
...
- [cost](IBusinessDataErrorsTaskInfo.md#cost)
- [data](IBusinessDataErrorsTaskInfo.md#data)
- [id](IBusinessDataErrorsTaskInfo.md#id)
- [path](IBusinessDataErrorsTaskInfo.md#path)
- [result](IBusinessDataErrorsTaskInfo.md#result)
- [result\_count](IBusinessDataErrorsTaskInfo.md#result_count)
- [status\_code](IBusinessDataErrorsTaskInfo.md#status_code)
- [status\_message](IBusinessDataErrorsTaskInfo.md#status_message)
- [time](IBusinessDataErrorsTaskInfo.md#time)
...
[main.ts:187772](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L187772)
