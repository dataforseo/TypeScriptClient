...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppListTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppListTasksReadyTaskInfo`**
...
- [cost](IAppDataAppleAppListTasksReadyTaskInfo.md#cost)
- [data](IAppDataAppleAppListTasksReadyTaskInfo.md#data)
- [id](IAppDataAppleAppListTasksReadyTaskInfo.md#id)
- [path](IAppDataAppleAppListTasksReadyTaskInfo.md#path)
- [result](IAppDataAppleAppListTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataAppleAppListTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppListTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppListTasksReadyTaskInfo.md#status_message)
- [time](IAppDataAppleAppListTasksReadyTaskInfo.md#time)
...
[main.ts:185364](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L185364)
