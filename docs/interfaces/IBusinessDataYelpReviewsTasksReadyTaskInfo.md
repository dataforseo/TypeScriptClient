...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpReviewsTasksReadyTaskInfo

# Interface: IBusinessDataYelpReviewsTasksReadyTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  
  ↳ **`IBusinessDataYelpReviewsTasksReadyTaskInfo`**
...
- [cost](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#data)
- [id](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#id)
- [path](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#path)
- [result](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataYelpReviewsTasksReadyTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpReviewsTasksReadyResultInfo`](../classes/BusinessDataYelpReviewsTasksReadyResultInfo.md)[]

array of results

#### Defined in

[main.ts:205172](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L205172)
