...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataIdListResponseInfo
...
- [cost](IAppDataIdListResponseInfo.md#cost)
- [status\_code](IAppDataIdListResponseInfo.md#status_code)
- [status\_message](IAppDataIdListResponseInfo.md#status_message)
- [tasks](IAppDataIdListResponseInfo.md#tasks)
- [tasks\_count](IAppDataIdListResponseInfo.md#tasks_count)
- [tasks\_error](IAppDataIdListResponseInfo.md#tasks_error)
- [time](IAppDataIdListResponseInfo.md#time)
- [version](IAppDataIdListResponseInfo.md#version)
...
[main.ts:176619](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L176619)
