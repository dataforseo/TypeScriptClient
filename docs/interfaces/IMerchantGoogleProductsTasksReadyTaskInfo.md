[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductsTasksReadyTaskInfo`**
...
- [cost](IMerchantGoogleProductsTasksReadyTaskInfo.md#cost)
- [data](IMerchantGoogleProductsTasksReadyTaskInfo.md#data)
- [id](IMerchantGoogleProductsTasksReadyTaskInfo.md#id)
- [path](IMerchantGoogleProductsTasksReadyTaskInfo.md#path)
- [result](IMerchantGoogleProductsTasksReadyTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductsTasksReadyTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductsTasksReadyTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductsTasksReadyTaskInfo.md#status_message)
- [time](IMerchantGoogleProductsTasksReadyTaskInfo.md#time)
...
[main.ts:164367](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L164367)
