[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingRelevantPagesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingRelevantPagesLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingRelevantPagesLiveTaskInfo.md#time)
...
[main.ts:106690](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L106690)
