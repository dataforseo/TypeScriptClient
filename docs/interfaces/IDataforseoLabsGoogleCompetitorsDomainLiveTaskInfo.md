[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleCompetitorsDomainLiveTaskInfo.md#time)
...
[main.ts:88652](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L88652)
