...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAvailableFiltersTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAvailableFiltersTaskInfo`**
...
- [cost](IDataforseoLabsAvailableFiltersTaskInfo.md#cost)
- [data](IDataforseoLabsAvailableFiltersTaskInfo.md#data)
- [id](IDataforseoLabsAvailableFiltersTaskInfo.md#id)
- [path](IDataforseoLabsAvailableFiltersTaskInfo.md#path)
- [result](IDataforseoLabsAvailableFiltersTaskInfo.md#result)
- [result\_count](IDataforseoLabsAvailableFiltersTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAvailableFiltersTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAvailableFiltersTaskInfo.md#status_message)
- [time](IDataforseoLabsAvailableFiltersTaskInfo.md#time)
...
[main.ts:77782](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L77782)
