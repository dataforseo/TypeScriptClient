[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicTasksFixedTaskInfo`**
...
- [cost](ISerpBingOrganicTasksFixedTaskInfo.md#cost)
- [data](ISerpBingOrganicTasksFixedTaskInfo.md#data)
- [id](ISerpBingOrganicTasksFixedTaskInfo.md#id)
- [path](ISerpBingOrganicTasksFixedTaskInfo.md#path)
- [result](ISerpBingOrganicTasksFixedTaskInfo.md#result)
- [result\_count](ISerpBingOrganicTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicTasksFixedTaskInfo.md#status_message)
- [time](ISerpBingOrganicTasksFixedTaskInfo.md#time)
...
[main.ts:54148](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L54148)
