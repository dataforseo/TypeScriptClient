...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamLocationsTaskInfo
...
- [cost](ISerpSeznamLocationsTaskInfo.md#cost)
- [data](ISerpSeznamLocationsTaskInfo.md#data)
- [id](ISerpSeznamLocationsTaskInfo.md#id)
- [path](ISerpSeznamLocationsTaskInfo.md#path)
- [result](ISerpSeznamLocationsTaskInfo.md#result)
- [result\_count](ISerpSeznamLocationsTaskInfo.md#result_count)
- [status\_code](ISerpSeznamLocationsTaskInfo.md#status_code)
- [status\_message](ISerpSeznamLocationsTaskInfo.md#status_message)
- [time](ISerpSeznamLocationsTaskInfo.md#time)
...
[main.ts:68880](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L68880)
