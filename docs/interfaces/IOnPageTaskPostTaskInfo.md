[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageTaskPostTaskInfo
...
- [cost](IOnPageTaskPostTaskInfo.md#cost)
- [data](IOnPageTaskPostTaskInfo.md#data)
- [id](IOnPageTaskPostTaskInfo.md#id)
- [path](IOnPageTaskPostTaskInfo.md#path)
- [result](IOnPageTaskPostTaskInfo.md#result)
- [result\_count](IOnPageTaskPostTaskInfo.md#result_count)
- [status\_code](IOnPageTaskPostTaskInfo.md#status_code)
- [status\_message](IOnPageTaskPostTaskInfo.md#status_message)
- [time](IOnPageTaskPostTaskInfo.md#time)
...
[main.ts:142961](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L142961)
