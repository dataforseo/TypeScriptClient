...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetInfoTaskPostTaskInfo`**
...
- [cost](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#data)
- [id](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#id)
- [path](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#path)
- [result](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetInfoTaskPostTaskInfo.md#time)
...
[main.ts:52020](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L52020)
