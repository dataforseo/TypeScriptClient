[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamOrganicTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpSeznamOrganicTasksFixedTaskInfo`**
...
- [cost](ISerpSeznamOrganicTasksFixedTaskInfo.md#cost)
- [data](ISerpSeznamOrganicTasksFixedTaskInfo.md#data)
- [id](ISerpSeznamOrganicTasksFixedTaskInfo.md#id)
- [path](ISerpSeznamOrganicTasksFixedTaskInfo.md#path)
- [result](ISerpSeznamOrganicTasksFixedTaskInfo.md#result)
- [result\_count](ISerpSeznamOrganicTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpSeznamOrganicTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpSeznamOrganicTasksFixedTaskInfo.md#status_message)
- [time](ISerpSeznamOrganicTasksFixedTaskInfo.md#time)
...
[main.ts:70056](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L70056)
