[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataBusinessListingsSearchLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataBusinessListingsSearchLiveTaskInfo`**
...
- [cost](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#cost)
- [data](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#data)
- [id](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#id)
- [path](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#path)
- [result](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#result)
- [result\_count](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#result_count)
- [status\_code](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#status_code)
- [status\_message](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#status_message)
- [time](IBusinessDataBusinessListingsSearchLiveTaskInfo.md#time)
...
[main.ts:189502](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L189502)
