...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsKeywordsForSiteTasksReadyTaskInfo.md#time)
...
[main.ts:114836](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L114836)
