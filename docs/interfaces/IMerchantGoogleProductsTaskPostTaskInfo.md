...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductsTaskPostTaskInfo`**
...
- [cost](IMerchantGoogleProductsTaskPostTaskInfo.md#cost)
- [data](IMerchantGoogleProductsTaskPostTaskInfo.md#data)
- [id](IMerchantGoogleProductsTaskPostTaskInfo.md#id)
- [path](IMerchantGoogleProductsTaskPostTaskInfo.md#path)
- [result](IMerchantGoogleProductsTaskPostTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductsTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductsTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductsTaskPostTaskInfo.md#status_message)
- [time](IMerchantGoogleProductsTaskPostTaskInfo.md#time)
...
[main.ts:164167](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L164167)
