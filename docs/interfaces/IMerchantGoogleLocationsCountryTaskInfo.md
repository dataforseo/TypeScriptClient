[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleLocationsCountryTaskInfo`**
...
- [cost](IMerchantGoogleLocationsCountryTaskInfo.md#cost)
- [data](IMerchantGoogleLocationsCountryTaskInfo.md#data)
- [id](IMerchantGoogleLocationsCountryTaskInfo.md#id)
- [path](IMerchantGoogleLocationsCountryTaskInfo.md#path)
- [result](IMerchantGoogleLocationsCountryTaskInfo.md#result)
- [result\_count](IMerchantGoogleLocationsCountryTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleLocationsCountryTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleLocationsCountryTaskInfo.md#status_message)
- [time](IMerchantGoogleLocationsCountryTaskInfo.md#time)
...
[main.ts:163827](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L163827)
