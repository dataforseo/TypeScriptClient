[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleLocationsTaskInfo`**
...
- [cost](IAppDataGoogleLocationsTaskInfo.md#cost)
- [data](IAppDataGoogleLocationsTaskInfo.md#data)
- [id](IAppDataGoogleLocationsTaskInfo.md#id)
- [path](IAppDataGoogleLocationsTaskInfo.md#path)
- [result](IAppDataGoogleLocationsTaskInfo.md#result)
- [result\_count](IAppDataGoogleLocationsTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleLocationsTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleLocationsTaskInfo.md#status_message)
- [time](IAppDataGoogleLocationsTaskInfo.md#time)
...
[main.ts:177270](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L177270)
