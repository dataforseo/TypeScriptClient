...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpAiSummaryResponseInfo
...
- [cost](ISerpAiSummaryResponseInfo.md#cost)
- [status\_code](ISerpAiSummaryResponseInfo.md#status_code)
- [status\_message](ISerpAiSummaryResponseInfo.md#status_message)
- [tasks](ISerpAiSummaryResponseInfo.md#tasks)
- [tasks\_count](ISerpAiSummaryResponseInfo.md#tasks_count)
- [tasks\_error](ISerpAiSummaryResponseInfo.md#tasks_error)
- [time](ISerpAiSummaryResponseInfo.md#time)
- [version](ISerpAiSummaryResponseInfo.md#version)
...
[main.ts:24053](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L24053)
