[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocationsTaskInfo
...
- [cost](ISerpGoogleLocationsTaskInfo.md#cost)
- [data](ISerpGoogleLocationsTaskInfo.md#data)
- [id](ISerpGoogleLocationsTaskInfo.md#id)
- [path](ISerpGoogleLocationsTaskInfo.md#path)
- [result](ISerpGoogleLocationsTaskInfo.md#result)
- [result\_count](ISerpGoogleLocationsTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocationsTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocationsTaskInfo.md#status_message)
- [time](ISerpGoogleLocationsTaskInfo.md#time)
...
[main.ts:24196](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L24196)
