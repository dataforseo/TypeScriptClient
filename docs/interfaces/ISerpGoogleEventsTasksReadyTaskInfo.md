[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleEventsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleEventsTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleEventsTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleEventsTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleEventsTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleEventsTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleEventsTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleEventsTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleEventsTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleEventsTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleEventsTasksReadyTaskInfo.md#time)
...
[main.ts:44148](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L44148)
