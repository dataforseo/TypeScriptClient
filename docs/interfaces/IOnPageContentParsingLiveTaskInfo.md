[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageContentParsingLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageContentParsingLiveTaskInfo`**
...
- [cost](IOnPageContentParsingLiveTaskInfo.md#cost)
- [data](IOnPageContentParsingLiveTaskInfo.md#data)
- [id](IOnPageContentParsingLiveTaskInfo.md#id)
- [path](IOnPageContentParsingLiveTaskInfo.md#path)
- [result](IOnPageContentParsingLiveTaskInfo.md#result)
- [result\_count](IOnPageContentParsingLiveTaskInfo.md#result_count)
- [status\_code](IOnPageContentParsingLiveTaskInfo.md#status_code)
- [status\_message](IOnPageContentParsingLiveTaskInfo.md#status_message)
- [time](IOnPageContentParsingLiveTaskInfo.md#time)
...
[main.ts:152925](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L152925)
