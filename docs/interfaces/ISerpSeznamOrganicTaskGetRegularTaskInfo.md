...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamOrganicTaskGetRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpSeznamOrganicTaskGetRegularTaskInfo`**
...
- [cost](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#cost)
- [data](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#data)
- [id](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#id)
- [path](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#path)
- [result](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#result)
- [result\_count](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#result_count)
- [status\_code](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#status_code)
- [status\_message](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#status_message)
- [time](ISerpSeznamOrganicTaskGetRegularTaskInfo.md#time)
...
[main.ts:70322](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L70322)
