[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduOrganicTaskGetRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBaiduOrganicTaskGetRegularTaskInfo`**
...
- [cost](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#cost)
- [data](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#data)
- [id](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#id)
- [path](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#path)
- [result](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#result)
- [result\_count](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#result_count)
- [status\_code](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#status_code)
- [status\_message](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#status_message)
- [time](ISerpBaiduOrganicTaskGetRegularTaskInfo.md#time)
...
[main.ts:66792](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L66792)
