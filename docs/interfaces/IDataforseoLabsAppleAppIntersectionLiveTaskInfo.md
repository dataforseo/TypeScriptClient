[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAppleAppIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAppleAppIntersectionLiveTaskInfo`**
...
- [cost](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#data)
- [id](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#id)
- [path](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#path)
- [result](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAppleAppIntersectionLiveTaskInfo.md#time)
...
[main.ts:112158](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L112158)
