[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageNonIndexableTaskInfo
...
- [cost](IOnPageNonIndexableTaskInfo.md#cost)
- [data](IOnPageNonIndexableTaskInfo.md#data)
- [id](IOnPageNonIndexableTaskInfo.md#id)
- [path](IOnPageNonIndexableTaskInfo.md#path)
- [result](IOnPageNonIndexableTaskInfo.md#result)
- [result\_count](IOnPageNonIndexableTaskInfo.md#result_count)
- [status\_code](IOnPageNonIndexableTaskInfo.md#status_code)
- [status\_message](IOnPageNonIndexableTaskInfo.md#status_message)
- [time](IOnPageNonIndexableTaskInfo.md#time)
...
[main.ts:149569](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L149569)
