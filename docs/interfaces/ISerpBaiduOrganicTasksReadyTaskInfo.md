...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduOrganicTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBaiduOrganicTasksReadyTaskInfo`**
...
- [cost](ISerpBaiduOrganicTasksReadyTaskInfo.md#cost)
- [data](ISerpBaiduOrganicTasksReadyTaskInfo.md#data)
- [id](ISerpBaiduOrganicTasksReadyTaskInfo.md#id)
- [path](ISerpBaiduOrganicTasksReadyTaskInfo.md#path)
- [result](ISerpBaiduOrganicTasksReadyTaskInfo.md#result)
- [result\_count](ISerpBaiduOrganicTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpBaiduOrganicTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpBaiduOrganicTasksReadyTaskInfo.md#status_message)
- [time](ISerpBaiduOrganicTasksReadyTaskInfo.md#time)
...
[main.ts:66320](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L66320)
