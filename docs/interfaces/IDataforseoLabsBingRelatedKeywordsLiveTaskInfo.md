[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingRelatedKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingRelatedKeywordsLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingRelatedKeywordsLiveTaskInfo.md#time)
...
[main.ts:106174](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L106174)
