[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicTaskGetHtmlTaskInfo`**
...
- [cost](ISerpBingOrganicTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpBingOrganicTaskGetHtmlTaskInfo.md#data)
- [id](ISerpBingOrganicTaskGetHtmlTaskInfo.md#id)
- [path](ISerpBingOrganicTaskGetHtmlTaskInfo.md#path)
- [result](ISerpBingOrganicTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpBingOrganicTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpBingOrganicTaskGetHtmlTaskInfo.md#time)
...
[main.ts:54888](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L54888)
