...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleLanguagesTaskInfo`**
...
- [cost](IAppDataGoogleLanguagesTaskInfo.md#cost)
- [data](IAppDataGoogleLanguagesTaskInfo.md#data)
- [id](IAppDataGoogleLanguagesTaskInfo.md#id)
- [path](IAppDataGoogleLanguagesTaskInfo.md#path)
- [result](IAppDataGoogleLanguagesTaskInfo.md#result)
- [result\_count](IAppDataGoogleLanguagesTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleLanguagesTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleLanguagesTaskInfo.md#status_message)
- [time](IAppDataGoogleLanguagesTaskInfo.md#time)
...
[main.ts:177436](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L177436)
