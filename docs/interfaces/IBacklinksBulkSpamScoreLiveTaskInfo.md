...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBulkSpamScoreLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBulkSpamScoreLiveTaskInfo`**
...
- [cost](IBacklinksBulkSpamScoreLiveTaskInfo.md#cost)
- [data](IBacklinksBulkSpamScoreLiveTaskInfo.md#data)
- [id](IBacklinksBulkSpamScoreLiveTaskInfo.md#id)
- [path](IBacklinksBulkSpamScoreLiveTaskInfo.md#path)
- [result](IBacklinksBulkSpamScoreLiveTaskInfo.md#result)
- [result\_count](IBacklinksBulkSpamScoreLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBulkSpamScoreLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBulkSpamScoreLiveTaskInfo.md#status_message)
- [time](IBacklinksBulkSpamScoreLiveTaskInfo.md#time)
...
[main.ts:140257](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L140257)
