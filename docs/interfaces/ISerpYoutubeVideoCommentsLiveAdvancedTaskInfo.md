[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo`**
...
- [cost](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#cost)
- [data](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#data)
- [id](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#id)
- [path](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#path)
- [result](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoCommentsLiveAdvancedTaskInfo.md#time)
...
[main.ts:62572](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L62572)
