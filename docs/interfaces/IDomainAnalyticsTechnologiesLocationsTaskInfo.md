...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesLocationsTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesLocationsTaskInfo.md#time)
...
[main.ts:71872](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L71872)
