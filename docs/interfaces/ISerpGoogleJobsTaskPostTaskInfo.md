...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleJobsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleJobsTaskPostTaskInfo`**
...
- [cost](ISerpGoogleJobsTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleJobsTaskPostTaskInfo.md#data)
- [id](ISerpGoogleJobsTaskPostTaskInfo.md#id)
- [path](ISerpGoogleJobsTaskPostTaskInfo.md#path)
- [result](ISerpGoogleJobsTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleJobsTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleJobsTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleJobsTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleJobsTaskPostTaskInfo.md#time)
...
[main.ts:48622](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L48622)
