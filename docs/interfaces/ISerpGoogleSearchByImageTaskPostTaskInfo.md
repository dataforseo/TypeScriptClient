...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleSearchByImageTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleSearchByImageTaskPostTaskInfo`**
...
- [cost](ISerpGoogleSearchByImageTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleSearchByImageTaskPostTaskInfo.md#data)
- [id](ISerpGoogleSearchByImageTaskPostTaskInfo.md#id)
- [path](ISerpGoogleSearchByImageTaskPostTaskInfo.md#path)
- [result](ISerpGoogleSearchByImageTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleSearchByImageTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleSearchByImageTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleSearchByImageTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleSearchByImageTaskPostTaskInfo.md#time)
...
[main.ts:47530](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L47530)
