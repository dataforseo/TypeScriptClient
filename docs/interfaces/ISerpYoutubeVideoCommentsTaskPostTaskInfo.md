[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoCommentsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoCommentsTaskPostTaskInfo`**
...
- [cost](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#cost)
- [data](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#data)
- [id](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#id)
- [path](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#path)
- [result](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoCommentsTaskPostTaskInfo.md#time)
...
[main.ts:61340](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L61340)
