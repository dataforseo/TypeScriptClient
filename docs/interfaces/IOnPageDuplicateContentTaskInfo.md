[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageDuplicateContentTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageDuplicateContentTaskInfo`**
...
- [cost](IOnPageDuplicateContentTaskInfo.md#cost)
- [data](IOnPageDuplicateContentTaskInfo.md#data)
- [id](IOnPageDuplicateContentTaskInfo.md#id)
- [path](IOnPageDuplicateContentTaskInfo.md#path)
- [result](IOnPageDuplicateContentTaskInfo.md#result)
- [result\_count](IOnPageDuplicateContentTaskInfo.md#result_count)
- [status\_code](IOnPageDuplicateContentTaskInfo.md#status_code)
- [status\_message](IOnPageDuplicateContentTaskInfo.md#status_message)
- [time](IOnPageDuplicateContentTaskInfo.md#time)
...
[main.ts:147811](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L147811)
