...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleJobsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleJobsTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleJobsTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleJobsTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleJobsTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleJobsTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleJobsTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleJobsTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleJobsTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleJobsTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleJobsTasksReadyTaskInfo.md#time)
...
[main.ts:48834](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L48834)
