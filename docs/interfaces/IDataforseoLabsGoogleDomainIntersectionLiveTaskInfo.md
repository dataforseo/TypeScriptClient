[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleDomainIntersectionLiveTaskInfo.md#time)
...
[main.ts:89254](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L89254)
