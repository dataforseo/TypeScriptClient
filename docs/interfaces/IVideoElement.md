...
- [preview](IVideoElement.md#preview)
- [source](IVideoElement.md#source)
- [timestamp](IVideoElement.md#timestamp)
- [title](IVideoElement.md#title)
- [type](IVideoElement.md#type)
- [url](IVideoElement.md#url)
