[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleLocationsTaskInfo`**
...
- [cost](IAppDataAppleLocationsTaskInfo.md#cost)
- [data](IAppDataAppleLocationsTaskInfo.md#data)
- [id](IAppDataAppleLocationsTaskInfo.md#id)
- [path](IAppDataAppleLocationsTaskInfo.md#path)
- [result](IAppDataAppleLocationsTaskInfo.md#result)
- [result\_count](IAppDataAppleLocationsTaskInfo.md#result_count)
- [status\_code](IAppDataAppleLocationsTaskInfo.md#status_code)
- [status\_message](IAppDataAppleLocationsTaskInfo.md#status_message)
- [time](IAppDataAppleLocationsTaskInfo.md#time)
...
[main.ts:182868](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L182868)
