...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetSearchTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetSearchTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetSearchTasksReadyTaskInfo.md#time)
...
[main.ts:50288](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L50288)
