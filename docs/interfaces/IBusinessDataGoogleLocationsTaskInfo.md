[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleLocationsTaskInfo`**
...
- [cost](IBusinessDataGoogleLocationsTaskInfo.md#cost)
- [data](IBusinessDataGoogleLocationsTaskInfo.md#data)
- [id](IBusinessDataGoogleLocationsTaskInfo.md#id)
- [path](IBusinessDataGoogleLocationsTaskInfo.md#path)
- [result](IBusinessDataGoogleLocationsTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleLocationsTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleLocationsTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleLocationsTaskInfo.md#status_message)
- [time](IBusinessDataGoogleLocationsTaskInfo.md#time)
...
[main.ts:190300](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L190300)
