...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordPerformanceTaskPostTaskInfo.md#time)
...
[main.ts:126869](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L126869)
