[Documentation](../README.md) / [Exports](../modules.md) / IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo`**
...
- [cost](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#cost)
- [data](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#data)
- [id](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#id)
- [path](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#path)
- [result](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#result)
- [result\_count](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#result_count)
- [status\_code](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#status_code)
- [status\_message](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#status_message)
- [time](IKeywordsDataDataforseoTrendsMergedDataLiveTaskInfo.md#time)
