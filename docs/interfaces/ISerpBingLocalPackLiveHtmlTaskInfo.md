[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackLiveHtmlTaskInfo`**
...
- [cost](ISerpBingLocalPackLiveHtmlTaskInfo.md#cost)
- [data](ISerpBingLocalPackLiveHtmlTaskInfo.md#data)
- [id](ISerpBingLocalPackLiveHtmlTaskInfo.md#id)
- [path](ISerpBingLocalPackLiveHtmlTaskInfo.md#path)
- [result](ISerpBingLocalPackLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackLiveHtmlTaskInfo.md#status_message)
- [time](ISerpBingLocalPackLiveHtmlTaskInfo.md#time)
...
[main.ts:57110](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L57110)
