...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleSellersTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleSellersTasksReadyTaskInfo`**
...
- [cost](IMerchantGoogleSellersTasksReadyTaskInfo.md#cost)
- [data](IMerchantGoogleSellersTasksReadyTaskInfo.md#data)
- [id](IMerchantGoogleSellersTasksReadyTaskInfo.md#id)
- [path](IMerchantGoogleSellersTasksReadyTaskInfo.md#path)
- [result](IMerchantGoogleSellersTasksReadyTaskInfo.md#result)
- [result\_count](IMerchantGoogleSellersTasksReadyTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleSellersTasksReadyTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleSellersTasksReadyTaskInfo.md#status_message)
- [time](IMerchantGoogleSellersTasksReadyTaskInfo.md#time)
...
[main.ts:166381](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L166381)
