...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLanguagesTaskInfo
...
- [cost](ISerpBingLanguagesTaskInfo.md#cost)
- [data](ISerpBingLanguagesTaskInfo.md#data)
- [id](ISerpBingLanguagesTaskInfo.md#id)
- [path](ISerpBingLanguagesTaskInfo.md#path)
- [result](ISerpBingLanguagesTaskInfo.md#result)
- [result\_count](ISerpBingLanguagesTaskInfo.md#result_count)
- [status\_code](ISerpBingLanguagesTaskInfo.md#status_code)
- [status\_message](ISerpBingLanguagesTaskInfo.md#status_message)
- [time](ISerpBingLanguagesTaskInfo.md#time)
...
[main.ts:53620](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L53620)
