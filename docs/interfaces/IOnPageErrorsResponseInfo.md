...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageErrorsResponseInfo
...
- [cost](IOnPageErrorsResponseInfo.md#cost)
- [status\_code](IOnPageErrorsResponseInfo.md#status_code)
- [status\_message](IOnPageErrorsResponseInfo.md#status_message)
- [tasks](IOnPageErrorsResponseInfo.md#tasks)
- [tasks\_count](IOnPageErrorsResponseInfo.md#tasks_count)
- [tasks\_error](IOnPageErrorsResponseInfo.md#tasks_error)
- [time](IOnPageErrorsResponseInfo.md#time)
- [version](IOnPageErrorsResponseInfo.md#version)
...
[main.ts:142120](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L142120)
