...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocationsTaskInfo
...
- [cost](ISerpBingLocationsTaskInfo.md#cost)
- [data](ISerpBingLocationsTaskInfo.md#data)
- [id](ISerpBingLocationsTaskInfo.md#id)
- [path](ISerpBingLocationsTaskInfo.md#path)
- [result](ISerpBingLocationsTaskInfo.md#result)
- [result\_count](ISerpBingLocationsTaskInfo.md#result_count)
- [status\_code](ISerpBingLocationsTaskInfo.md#status_code)
- [status\_message](ISerpBingLocationsTaskInfo.md#status_message)
- [time](ISerpBingLocationsTaskInfo.md#time)
...
[main.ts:53256](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L53256)
