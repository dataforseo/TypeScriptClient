[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksSummaryLiveTaskInfo
...
- [cost](IBacklinksSummaryLiveTaskInfo.md#cost)
- [data](IBacklinksSummaryLiveTaskInfo.md#data)
- [id](IBacklinksSummaryLiveTaskInfo.md#id)
- [path](IBacklinksSummaryLiveTaskInfo.md#path)
- [result](IBacklinksSummaryLiveTaskInfo.md#result)
- [result\_count](IBacklinksSummaryLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksSummaryLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksSummaryLiveTaskInfo.md#status_message)
- [time](IBacklinksSummaryLiveTaskInfo.md#time)
...
[main.ts:129843](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L129843)
