...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsKeywordsForSiteTaskGetTaskInfo.md#time)
...
[main.ts:115286](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L115286)
