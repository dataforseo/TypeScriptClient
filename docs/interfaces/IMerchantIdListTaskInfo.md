...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantIdListTaskInfo
...
- [cost](IMerchantIdListTaskInfo.md#cost)
- [data](IMerchantIdListTaskInfo.md#data)
- [id](IMerchantIdListTaskInfo.md#id)
- [path](IMerchantIdListTaskInfo.md#path)
- [result](IMerchantIdListTaskInfo.md#result)
- [result\_count](IMerchantIdListTaskInfo.md#result_count)
- [status\_code](IMerchantIdListTaskInfo.md#status_code)
- [status\_message](IMerchantIdListTaskInfo.md#status_message)
- [time](IMerchantIdListTaskInfo.md#time)
...
[main.ts:162939](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L162939)
