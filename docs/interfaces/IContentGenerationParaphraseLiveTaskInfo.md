[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationParaphraseLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationParaphraseLiveTaskInfo`**
...
- [cost](IContentGenerationParaphraseLiveTaskInfo.md#cost)
- [data](IContentGenerationParaphraseLiveTaskInfo.md#data)
- [id](IContentGenerationParaphraseLiveTaskInfo.md#id)
- [path](IContentGenerationParaphraseLiveTaskInfo.md#path)
- [result](IContentGenerationParaphraseLiveTaskInfo.md#result)
- [result\_count](IContentGenerationParaphraseLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationParaphraseLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationParaphraseLiveTaskInfo.md#status_message)
- [time](IContentGenerationParaphraseLiveTaskInfo.md#time)
...
[main.ts:161317](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L161317)
