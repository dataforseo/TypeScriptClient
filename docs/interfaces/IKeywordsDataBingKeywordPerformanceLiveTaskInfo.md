[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordPerformanceLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordPerformanceLiveTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordPerformanceLiveTaskInfo.md#time)
...
[main.ts:127879](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L127879)
