[Documentation](../README.md) / [Exports](../modules.md) / ISerpGoogleAutocompleteTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleAutocompleteTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleAutocompleteTasksReadyTaskInfo.md#time)
