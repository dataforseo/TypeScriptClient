...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataYelpLanguagesTaskInfo`**
...
- [cost](IBusinessDataYelpLanguagesTaskInfo.md#cost)
- [data](IBusinessDataYelpLanguagesTaskInfo.md#data)
- [id](IBusinessDataYelpLanguagesTaskInfo.md#id)
- [path](IBusinessDataYelpLanguagesTaskInfo.md#path)
- [result](IBusinessDataYelpLanguagesTaskInfo.md#result)
- [result\_count](IBusinessDataYelpLanguagesTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpLanguagesTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpLanguagesTaskInfo.md#status_message)
- [time](IBusinessDataYelpLanguagesTaskInfo.md#time)
...
[main.ts:203274](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L203274)
