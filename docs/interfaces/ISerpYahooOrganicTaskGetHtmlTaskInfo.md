[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicTaskGetHtmlTaskInfo`**
...
- [cost](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#data)
- [id](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#id)
- [path](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#path)
- [result](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpYahooOrganicTaskGetHtmlTaskInfo.md#time)
...
[main.ts:64404](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L64404)
