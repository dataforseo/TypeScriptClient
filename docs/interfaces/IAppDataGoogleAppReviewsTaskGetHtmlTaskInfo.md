...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo`**
...
- [cost](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#cost)
- [data](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#data)
- [id](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#id)
- [path](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#path)
- [result](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#status_message)
- [time](IAppDataGoogleAppReviewsTaskGetHtmlTaskInfo.md#time)
...
[main.ts:181832](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L181832)
