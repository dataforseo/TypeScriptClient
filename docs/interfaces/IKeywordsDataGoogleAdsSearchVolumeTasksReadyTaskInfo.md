...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsSearchVolumeTasksReadyTaskInfo.md#time)
...
[main.ts:113700](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L113700)
