...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleBulkAppMetricsLiveTaskInfo.md#time)
...
[main.ts:108164](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L108164)
