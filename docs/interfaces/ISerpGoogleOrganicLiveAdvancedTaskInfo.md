[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleOrganicLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleOrganicLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleOrganicLiveAdvancedTaskInfo.md#time)
...
[main.ts:37034](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L37034)
