...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageRawHtmlResponseInfo
...
- [cost](IOnPageRawHtmlResponseInfo.md#cost)
- [status\_code](IOnPageRawHtmlResponseInfo.md#status_code)
- [status\_message](IOnPageRawHtmlResponseInfo.md#status_message)
- [tasks](IOnPageRawHtmlResponseInfo.md#tasks)
- [tasks\_count](IOnPageRawHtmlResponseInfo.md#tasks_count)
- [tasks\_error](IOnPageRawHtmlResponseInfo.md#tasks_error)
- [time](IOnPageRawHtmlResponseInfo.md#time)
- [version](IOnPageRawHtmlResponseInfo.md#version)
...
[main.ts:151428](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L151428)
