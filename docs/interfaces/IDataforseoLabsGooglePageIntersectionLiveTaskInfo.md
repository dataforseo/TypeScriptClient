[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGooglePageIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGooglePageIntersectionLiveTaskInfo`**
...
- [cost](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#data)
- [id](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#id)
- [path](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#path)
- [result](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGooglePageIntersectionLiveTaskInfo.md#time)
...
[main.ts:97386](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L97386)
