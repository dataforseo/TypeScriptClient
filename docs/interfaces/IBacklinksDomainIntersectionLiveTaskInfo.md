[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksDomainIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksDomainIntersectionLiveTaskInfo`**
...
- [cost](IBacklinksDomainIntersectionLiveTaskInfo.md#cost)
- [data](IBacklinksDomainIntersectionLiveTaskInfo.md#data)
- [id](IBacklinksDomainIntersectionLiveTaskInfo.md#id)
- [path](IBacklinksDomainIntersectionLiveTaskInfo.md#path)
- [result](IBacklinksDomainIntersectionLiveTaskInfo.md#result)
- [result\_count](IBacklinksDomainIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksDomainIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksDomainIntersectionLiveTaskInfo.md#status_message)
- [time](IBacklinksDomainIntersectionLiveTaskInfo.md#time)
...
[main.ts:137273](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L137273)
