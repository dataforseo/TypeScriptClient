[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageRedirectChainsTaskInfo
...
- [cost](IOnPageRedirectChainsTaskInfo.md#cost)
- [data](IOnPageRedirectChainsTaskInfo.md#data)
- [id](IOnPageRedirectChainsTaskInfo.md#id)
- [path](IOnPageRedirectChainsTaskInfo.md#path)
- [result](IOnPageRedirectChainsTaskInfo.md#result)
- [result\_count](IOnPageRedirectChainsTaskInfo.md#result_count)
- [status\_code](IOnPageRedirectChainsTaskInfo.md#status_code)
- [status\_message](IOnPageRedirectChainsTaskInfo.md#status_message)
- [time](IOnPageRedirectChainsTaskInfo.md#time)
...
[main.ts:149193](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L149193)
