[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppInfoTaskPostTaskInfo`**
...
- [cost](IAppDataGoogleAppInfoTaskPostTaskInfo.md#cost)
- [data](IAppDataGoogleAppInfoTaskPostTaskInfo.md#data)
- [id](IAppDataGoogleAppInfoTaskPostTaskInfo.md#id)
- [path](IAppDataGoogleAppInfoTaskPostTaskInfo.md#path)
- [result](IAppDataGoogleAppInfoTaskPostTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppInfoTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppInfoTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppInfoTaskPostTaskInfo.md#status_message)
- [time](IAppDataGoogleAppInfoTaskPostTaskInfo.md#time)
...
[main.ts:179504](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L179504)
