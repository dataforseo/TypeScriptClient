[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleMapsTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleMapsTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleMapsTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleMapsTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleMapsTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleMapsTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleMapsTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleMapsTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleMapsTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleMapsTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleMapsTasksFixedTaskInfo.md#time)
...
[main.ts:38148](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L38148)
