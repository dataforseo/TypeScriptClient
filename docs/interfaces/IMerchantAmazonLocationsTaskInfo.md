[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonLocationsTaskInfo`**
...
- [cost](IMerchantAmazonLocationsTaskInfo.md#cost)
- [data](IMerchantAmazonLocationsTaskInfo.md#data)
- [id](IMerchantAmazonLocationsTaskInfo.md#id)
- [path](IMerchantAmazonLocationsTaskInfo.md#path)
- [result](IMerchantAmazonLocationsTaskInfo.md#result)
- [result\_count](IMerchantAmazonLocationsTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonLocationsTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonLocationsTaskInfo.md#status_message)
- [time](IMerchantAmazonLocationsTaskInfo.md#time)
...
[main.ts:169879](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L169879)
