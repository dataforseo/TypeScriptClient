...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationGrammarRulesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationGrammarRulesTaskInfo`**
...
- [cost](IContentGenerationGrammarRulesTaskInfo.md#cost)
- [data](IContentGenerationGrammarRulesTaskInfo.md#data)
- [id](IContentGenerationGrammarRulesTaskInfo.md#id)
- [path](IContentGenerationGrammarRulesTaskInfo.md#path)
- [result](IContentGenerationGrammarRulesTaskInfo.md#result)
- [result\_count](IContentGenerationGrammarRulesTaskInfo.md#result_count)
- [status\_code](IContentGenerationGrammarRulesTaskInfo.md#status_code)
- [status\_message](IContentGenerationGrammarRulesTaskInfo.md#status_message)
- [time](IContentGenerationGrammarRulesTaskInfo.md#time)
...
[main.ts:162065](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L162065)
