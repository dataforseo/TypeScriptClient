[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackTasksReadyTaskInfo`**
...
- [cost](ISerpBingLocalPackTasksReadyTaskInfo.md#cost)
- [data](ISerpBingLocalPackTasksReadyTaskInfo.md#data)
- [id](ISerpBingLocalPackTasksReadyTaskInfo.md#id)
- [path](ISerpBingLocalPackTasksReadyTaskInfo.md#path)
- [result](ISerpBingLocalPackTasksReadyTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackTasksReadyTaskInfo.md#status_message)
- [time](ISerpBingLocalPackTasksReadyTaskInfo.md#time)
...
[main.ts:55942](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L55942)
