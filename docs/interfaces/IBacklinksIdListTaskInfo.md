[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksIdListTaskInfo
...
- [cost](IBacklinksIdListTaskInfo.md#cost)
- [data](IBacklinksIdListTaskInfo.md#data)
- [id](IBacklinksIdListTaskInfo.md#id)
- [path](IBacklinksIdListTaskInfo.md#path)
- [result](IBacklinksIdListTaskInfo.md#result)
- [result\_count](IBacklinksIdListTaskInfo.md#result_count)
- [status\_code](IBacklinksIdListTaskInfo.md#status_code)
- [status\_message](IBacklinksIdListTaskInfo.md#status_message)
- [time](IBacklinksIdListTaskInfo.md#time)
...
[main.ts:128227](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L128227)
