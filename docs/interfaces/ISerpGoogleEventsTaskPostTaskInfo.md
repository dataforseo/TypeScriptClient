[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleEventsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleEventsTaskPostTaskInfo`**
...
- [cost](ISerpGoogleEventsTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleEventsTaskPostTaskInfo.md#data)
- [id](ISerpGoogleEventsTaskPostTaskInfo.md#id)
- [path](ISerpGoogleEventsTaskPostTaskInfo.md#path)
- [result](ISerpGoogleEventsTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleEventsTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleEventsTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleEventsTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleEventsTaskPostTaskInfo.md#time)
...
[main.ts:43936](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L43936)
