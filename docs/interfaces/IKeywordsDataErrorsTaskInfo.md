[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataErrorsTaskInfo
...
- [cost](IKeywordsDataErrorsTaskInfo.md#cost)
- [data](IKeywordsDataErrorsTaskInfo.md#data)
- [id](IKeywordsDataErrorsTaskInfo.md#id)
- [path](IKeywordsDataErrorsTaskInfo.md#path)
- [result](IKeywordsDataErrorsTaskInfo.md#result)
- [result\_count](IKeywordsDataErrorsTaskInfo.md#result_count)
- [status\_code](IKeywordsDataErrorsTaskInfo.md#status_code)
- [status\_message](IKeywordsDataErrorsTaskInfo.md#status_message)
- [time](IKeywordsDataErrorsTaskInfo.md#time)
...
[main.ts:112848](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L112848)
