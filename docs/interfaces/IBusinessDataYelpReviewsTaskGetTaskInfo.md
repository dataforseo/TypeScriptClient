...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpReviewsTaskGetTaskInfo

# Interface: IBusinessDataYelpReviewsTaskGetTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  
  ↳ **`IBusinessDataYelpReviewsTaskGetTaskInfo`**
...
- [cost](IBusinessDataYelpReviewsTaskGetTaskInfo.md#cost)
- [data](IBusinessDataYelpReviewsTaskGetTaskInfo.md#data)
- [id](IBusinessDataYelpReviewsTaskGetTaskInfo.md#id)
- [path](IBusinessDataYelpReviewsTaskGetTaskInfo.md#path)
- [result](IBusinessDataYelpReviewsTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataYelpReviewsTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpReviewsTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpReviewsTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataYelpReviewsTaskGetTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpReviewsTaskGetResultInfo`](../classes/BusinessDataYelpReviewsTaskGetResultInfo.md)[]

array of results

#### Defined in

[main.ts:205562](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L205562)
