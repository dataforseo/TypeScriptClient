...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsErrorsTaskInfo
...
- [cost](IDataforseoLabsErrorsTaskInfo.md#cost)
- [data](IDataforseoLabsErrorsTaskInfo.md#data)
- [id](IDataforseoLabsErrorsTaskInfo.md#id)
- [path](IDataforseoLabsErrorsTaskInfo.md#path)
- [result](IDataforseoLabsErrorsTaskInfo.md#result)
- [result\_count](IDataforseoLabsErrorsTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsErrorsTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsErrorsTaskInfo.md#status_message)
- [time](IDataforseoLabsErrorsTaskInfo.md#time)
...
[main.ts:77278](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L77278)
