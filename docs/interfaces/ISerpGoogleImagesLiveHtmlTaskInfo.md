...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesLiveHtmlTaskInfo`**
...
- [cost](ISerpGoogleImagesLiveHtmlTaskInfo.md#cost)
- [data](ISerpGoogleImagesLiveHtmlTaskInfo.md#data)
- [id](ISerpGoogleImagesLiveHtmlTaskInfo.md#id)
- [path](ISerpGoogleImagesLiveHtmlTaskInfo.md#path)
- [result](ISerpGoogleImagesLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesLiveHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleImagesLiveHtmlTaskInfo.md#time)
...
[main.ts:47092](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L47092)
