...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksErrorsTaskInfo
...
- [cost](IBacklinksErrorsTaskInfo.md#cost)
- [data](IBacklinksErrorsTaskInfo.md#data)
- [id](IBacklinksErrorsTaskInfo.md#id)
- [path](IBacklinksErrorsTaskInfo.md#path)
- [result](IBacklinksErrorsTaskInfo.md#result)
- [result\_count](IBacklinksErrorsTaskInfo.md#result_count)
- [status\_code](IBacklinksErrorsTaskInfo.md#status_code)
- [status\_message](IBacklinksErrorsTaskInfo.md#status_message)
- [time](IBacklinksErrorsTaskInfo.md#time)
...
[main.ts:128567](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L128567)
