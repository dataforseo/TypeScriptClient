[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo`**
...
- [cost](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#data)
- [id](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#id)
- [path](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#path)
- [result](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAmazonProductCompetitorsLiveTaskInfo.md#time)
...
[main.ts:101460](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L101460)
