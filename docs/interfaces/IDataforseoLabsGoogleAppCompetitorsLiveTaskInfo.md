...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleAppCompetitorsLiveTaskInfo.md#time)
...
[main.ts:109528](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L109528)
