...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksDomainPagesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksDomainPagesLiveTaskInfo`**
...
- [cost](IBacklinksDomainPagesLiveTaskInfo.md#cost)
- [data](IBacklinksDomainPagesLiveTaskInfo.md#data)
- [id](IBacklinksDomainPagesLiveTaskInfo.md#id)
- [path](IBacklinksDomainPagesLiveTaskInfo.md#path)
- [result](IBacklinksDomainPagesLiveTaskInfo.md#result)
- [result\_count](IBacklinksDomainPagesLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksDomainPagesLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksDomainPagesLiveTaskInfo.md#status_message)
- [time](IBacklinksDomainPagesLiveTaskInfo.md#time)
...
[main.ts:133547](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L133547)
