...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleKeywordsForAppLiveTaskInfo.md#time)
...
[main.ts:108912](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L108912)
