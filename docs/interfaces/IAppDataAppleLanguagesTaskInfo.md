[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleLanguagesTaskInfo`**
...
- [cost](IAppDataAppleLanguagesTaskInfo.md#cost)
- [data](IAppDataAppleLanguagesTaskInfo.md#data)
- [id](IAppDataAppleLanguagesTaskInfo.md#id)
- [path](IAppDataAppleLanguagesTaskInfo.md#path)
- [result](IAppDataAppleLanguagesTaskInfo.md#result)
- [result\_count](IAppDataAppleLanguagesTaskInfo.md#result_count)
- [status\_code](IAppDataAppleLanguagesTaskInfo.md#status_code)
- [status\_message](IAppDataAppleLanguagesTaskInfo.md#status_message)
- [time](IAppDataAppleLanguagesTaskInfo.md#time)
...
[main.ts:183034](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L183034)
