...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonSellersTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonSellersTasksReadyTaskInfo`**
...
- [cost](IMerchantAmazonSellersTasksReadyTaskInfo.md#cost)
- [data](IMerchantAmazonSellersTasksReadyTaskInfo.md#data)
- [id](IMerchantAmazonSellersTasksReadyTaskInfo.md#id)
- [path](IMerchantAmazonSellersTasksReadyTaskInfo.md#path)
- [result](IMerchantAmazonSellersTasksReadyTaskInfo.md#result)
- [result\_count](IMerchantAmazonSellersTasksReadyTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonSellersTasksReadyTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonSellersTasksReadyTaskInfo.md#status_message)
- [time](IMerchantAmazonSellersTasksReadyTaskInfo.md#time)
...
[main.ts:174052](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L174052)
