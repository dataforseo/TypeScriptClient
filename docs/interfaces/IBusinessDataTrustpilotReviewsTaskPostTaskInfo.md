...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotReviewsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotReviewsTaskPostTaskInfo`**
...
- [cost](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#data)
- [id](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#id)
- [path](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#path)
- [result](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotReviewsTaskPostTaskInfo.md#time)
...
[main.ts:199624](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L199624)
