[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooLocationsCountryTaskInfo`**
...
- [cost](ISerpYahooLocationsCountryTaskInfo.md#cost)
- [data](ISerpYahooLocationsCountryTaskInfo.md#data)
- [id](ISerpYahooLocationsCountryTaskInfo.md#id)
- [path](ISerpYahooLocationsCountryTaskInfo.md#path)
- [result](ISerpYahooLocationsCountryTaskInfo.md#result)
- [result\_count](ISerpYahooLocationsCountryTaskInfo.md#result_count)
- [status\_code](ISerpYahooLocationsCountryTaskInfo.md#status_code)
- [status\_message](ISerpYahooLocationsCountryTaskInfo.md#status_message)
- [time](ISerpYahooLocationsCountryTaskInfo.md#time)
...
[main.ts:62968](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L62968)
