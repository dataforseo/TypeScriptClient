[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductSpecTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductSpecTasksReadyTaskInfo`**
...
- [cost](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#cost)
- [data](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#data)
- [id](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#id)
- [path](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#path)
- [result](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#status_message)
- [time](IMerchantGoogleProductSpecTasksReadyTaskInfo.md#time)
...
[main.ts:167773](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L167773)
