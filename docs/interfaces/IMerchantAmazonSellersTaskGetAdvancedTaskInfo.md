[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonSellersTaskGetAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonSellersTaskGetAdvancedTaskInfo`**
...
- [cost](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#cost)
- [data](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#data)
- [id](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#id)
- [path](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#path)
- [result](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#result)
- [result\_count](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#status_message)
- [time](IMerchantAmazonSellersTaskGetAdvancedTaskInfo.md#time)
...
[main.ts:174578](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L174578)
