[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotSearchTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotSearchTasksReadyTaskInfo`**
...
- [cost](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#data)
- [id](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#id)
- [path](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#path)
- [result](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotSearchTasksReadyTaskInfo.md#time)
...
[main.ts:199050](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L199050)
