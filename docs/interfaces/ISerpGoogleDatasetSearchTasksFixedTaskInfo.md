[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetSearchTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetSearchTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetSearchTasksFixedTaskInfo.md#time)
...
[main.ts:50500](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L50500)
