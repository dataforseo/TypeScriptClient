[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonSellersTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonSellersTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantAmazonSellersTaskGetHtmlTaskInfo.md#time)
...
[main.ts:174794](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L174794)
