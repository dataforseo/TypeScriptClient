[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonLanguagesTaskInfo`**
...
- [cost](IMerchantAmazonLanguagesTaskInfo.md#cost)
- [data](IMerchantAmazonLanguagesTaskInfo.md#data)
- [id](IMerchantAmazonLanguagesTaskInfo.md#id)
- [path](IMerchantAmazonLanguagesTaskInfo.md#path)
- [result](IMerchantAmazonLanguagesTaskInfo.md#result)
- [result\_count](IMerchantAmazonLanguagesTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonLanguagesTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonLanguagesTaskInfo.md#status_message)
- [time](IMerchantAmazonLanguagesTaskInfo.md#time)
...
[main.ts:170237](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L170237)
