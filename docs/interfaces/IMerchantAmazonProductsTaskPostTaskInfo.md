[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonProductsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonProductsTaskPostTaskInfo`**
...
- [cost](IMerchantAmazonProductsTaskPostTaskInfo.md#cost)
- [data](IMerchantAmazonProductsTaskPostTaskInfo.md#data)
- [id](IMerchantAmazonProductsTaskPostTaskInfo.md#id)
- [path](IMerchantAmazonProductsTaskPostTaskInfo.md#path)
- [result](IMerchantAmazonProductsTaskPostTaskInfo.md#result)
- [result\_count](IMerchantAmazonProductsTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonProductsTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonProductsTaskPostTaskInfo.md#status_message)
- [time](IMerchantAmazonProductsTaskPostTaskInfo.md#time)
...
[main.ts:170394](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L170394)
