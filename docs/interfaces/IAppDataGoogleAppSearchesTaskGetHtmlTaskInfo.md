...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo`**
...
- [cost](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#cost)
- [data](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#data)
- [id](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#id)
- [path](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#path)
- [result](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#status_message)
- [time](IAppDataGoogleAppSearchesTaskGetHtmlTaskInfo.md#time)
...
[main.ts:178174](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L178174)
