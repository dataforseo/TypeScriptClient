[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduOrganicTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBaiduOrganicTaskPostTaskInfo`**
...
- [cost](ISerpBaiduOrganicTaskPostTaskInfo.md#cost)
- [data](ISerpBaiduOrganicTaskPostTaskInfo.md#data)
- [id](ISerpBaiduOrganicTaskPostTaskInfo.md#id)
- [path](ISerpBaiduOrganicTaskPostTaskInfo.md#path)
- [result](ISerpBaiduOrganicTaskPostTaskInfo.md#result)
- [result\_count](ISerpBaiduOrganicTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpBaiduOrganicTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpBaiduOrganicTaskPostTaskInfo.md#status_message)
- [time](ISerpBaiduOrganicTaskPostTaskInfo.md#time)
...
[main.ts:66108](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L66108)
