...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo`**
...
- [cost](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#data)
- [id](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#id)
- [path](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#path)
- [result](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAmazonProductKeywordIntersectionsLiveTaskInfo.md#time)
...
[main.ts:102028](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L102028)
