...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBulkBacklinksLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBulkBacklinksLiveTaskInfo`**
...
- [cost](IBacklinksBulkBacklinksLiveTaskInfo.md#cost)
- [data](IBacklinksBulkBacklinksLiveTaskInfo.md#data)
- [id](IBacklinksBulkBacklinksLiveTaskInfo.md#id)
- [path](IBacklinksBulkBacklinksLiveTaskInfo.md#path)
- [result](IBacklinksBulkBacklinksLiveTaskInfo.md#result)
- [result\_count](IBacklinksBulkBacklinksLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBulkBacklinksLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBulkBacklinksLiveTaskInfo.md#status_message)
- [time](IBacklinksBulkBacklinksLiveTaskInfo.md#time)
...
[main.ts:139913](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L139913)
