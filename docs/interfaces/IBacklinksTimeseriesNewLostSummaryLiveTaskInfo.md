...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksTimeseriesNewLostSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksTimeseriesNewLostSummaryLiveTaskInfo`**
...
- [cost](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#cost)
- [data](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#data)
- [id](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#id)
- [path](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#path)
- [result](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#result)
- [result\_count](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#status_message)
- [time](IBacklinksTimeseriesNewLostSummaryLiveTaskInfo.md#time)
...
[main.ts:139237](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L139237)
