[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageLighthouseVersionsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageLighthouseVersionsTaskInfo`**
...
- [cost](IOnPageLighthouseVersionsTaskInfo.md#cost)
- [data](IOnPageLighthouseVersionsTaskInfo.md#data)
- [id](IOnPageLighthouseVersionsTaskInfo.md#id)
- [path](IOnPageLighthouseVersionsTaskInfo.md#path)
- [result](IOnPageLighthouseVersionsTaskInfo.md#result)
- [result\_count](IOnPageLighthouseVersionsTaskInfo.md#result_count)
- [status\_code](IOnPageLighthouseVersionsTaskInfo.md#status_code)
- [status\_message](IOnPageLighthouseVersionsTaskInfo.md#status_message)
- [time](IOnPageLighthouseVersionsTaskInfo.md#time)
...
[main.ts:154011](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L154011)
