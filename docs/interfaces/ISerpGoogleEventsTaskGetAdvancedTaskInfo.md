...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleEventsTaskGetAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleEventsTaskGetAdvancedTaskInfo`**
...
- [cost](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#data)
- [id](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#id)
- [path](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#path)
- [result](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleEventsTaskGetAdvancedTaskInfo.md#time)
...
[main.ts:45000](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L45000)
