[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonAsinTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonAsinTaskPostTaskInfo`**
...
- [cost](IMerchantAmazonAsinTaskPostTaskInfo.md#cost)
- [data](IMerchantAmazonAsinTaskPostTaskInfo.md#data)
- [id](IMerchantAmazonAsinTaskPostTaskInfo.md#id)
- [path](IMerchantAmazonAsinTaskPostTaskInfo.md#path)
- [result](IMerchantAmazonAsinTaskPostTaskInfo.md#result)
- [result\_count](IMerchantAmazonAsinTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonAsinTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonAsinTaskPostTaskInfo.md#status_message)
- [time](IMerchantAmazonAsinTaskPostTaskInfo.md#time)
...
[main.ts:172060](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L172060)
