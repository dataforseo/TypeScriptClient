...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleDatasetSearchLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleDatasetSearchLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleDatasetSearchLiveAdvancedTaskInfo.md#time)
...
[main.ts:51720](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L51720)
