[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListTaskPostTaskInfo`**
...
- [cost](IAppDataGoogleAppListTaskPostTaskInfo.md#cost)
- [data](IAppDataGoogleAppListTaskPostTaskInfo.md#data)
- [id](IAppDataGoogleAppListTaskPostTaskInfo.md#id)
- [path](IAppDataGoogleAppListTaskPostTaskInfo.md#path)
- [result](IAppDataGoogleAppListTaskPostTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListTaskPostTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListTaskPostTaskInfo.md#time)
...
[main.ts:178548](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L178548)
