[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingDomainIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingDomainIntersectionLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingDomainIntersectionLiveTaskInfo.md#time)
...
[main.ts:103862](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L103862)
