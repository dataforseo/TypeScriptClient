[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingSearchVolumeTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingSearchVolumeTaskPostTaskInfo`**
...
- [cost](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#data)
- [id](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#id)
- [path](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#path)
- [result](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataBingSearchVolumeTaskPostTaskInfo.md#time)
...
[main.ts:122607](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L122607)
