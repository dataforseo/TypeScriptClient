...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpNaverOrganicTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpNaverOrganicTasksFixedTaskInfo`**
...
- [cost](ISerpNaverOrganicTasksFixedTaskInfo.md#cost)
- [data](ISerpNaverOrganicTasksFixedTaskInfo.md#data)
- [id](ISerpNaverOrganicTasksFixedTaskInfo.md#id)
- [path](ISerpNaverOrganicTasksFixedTaskInfo.md#path)
- [result](ISerpNaverOrganicTasksFixedTaskInfo.md#result)
- [result\_count](ISerpNaverOrganicTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpNaverOrganicTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpNaverOrganicTasksFixedTaskInfo.md#status_message)
- [time](ISerpNaverOrganicTasksFixedTaskInfo.md#time)
...
[main.ts:67946](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L67946)
