[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksIndexTaskInfo
...
- [cost](IBacklinksIndexTaskInfo.md#cost)
- [data](IBacklinksIndexTaskInfo.md#data)
- [id](IBacklinksIndexTaskInfo.md#id)
- [path](IBacklinksIndexTaskInfo.md#path)
- [result](IBacklinksIndexTaskInfo.md#result)
- [result\_count](IBacklinksIndexTaskInfo.md#result_count)
- [status\_code](IBacklinksIndexTaskInfo.md#status_code)
- [status\_message](IBacklinksIndexTaskInfo.md#status_message)
- [time](IBacklinksIndexTaskInfo.md#time)
...
[main.ts:129137](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L129137)
