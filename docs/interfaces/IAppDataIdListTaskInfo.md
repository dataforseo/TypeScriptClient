...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataIdListTaskInfo
...
- [cost](IAppDataIdListTaskInfo.md#cost)
- [data](IAppDataIdListTaskInfo.md#data)
- [id](IAppDataIdListTaskInfo.md#id)
- [path](IAppDataIdListTaskInfo.md#path)
- [result](IAppDataIdListTaskInfo.md#result)
- [result\_count](IAppDataIdListTaskInfo.md#result_count)
- [status\_code](IAppDataIdListTaskInfo.md#status_code)
- [status\_message](IAppDataIdListTaskInfo.md#status_message)
- [time](IAppDataIdListTaskInfo.md#time)
...
[main.ts:176564](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L176564)
