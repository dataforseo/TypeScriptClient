...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleSearchIntentLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleSearchIntentLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleSearchIntentLiveTaskInfo.md#time)
...
[main.ts:83044](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L83044)
