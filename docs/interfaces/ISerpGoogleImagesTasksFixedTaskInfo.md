...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleImagesTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleImagesTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleImagesTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleImagesTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleImagesTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleImagesTasksFixedTaskInfo.md#time)
...
[main.ts:46034](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L46034)
