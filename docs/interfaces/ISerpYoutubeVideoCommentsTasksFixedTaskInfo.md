...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoCommentsTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoCommentsTasksFixedTaskInfo`**
...
- [cost](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#cost)
- [data](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#data)
- [id](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#id)
- [path](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#path)
- [result](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoCommentsTasksFixedTaskInfo.md#time)
...
[main.ts:61764](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L61764)
