[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonSellersTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonSellersTaskPostTaskInfo`**
...
- [cost](IMerchantAmazonSellersTaskPostTaskInfo.md#cost)
- [data](IMerchantAmazonSellersTaskPostTaskInfo.md#data)
- [id](IMerchantAmazonSellersTaskPostTaskInfo.md#id)
- [path](IMerchantAmazonSellersTaskPostTaskInfo.md#path)
- [result](IMerchantAmazonSellersTaskPostTaskInfo.md#result)
- [result\_count](IMerchantAmazonSellersTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonSellersTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonSellersTaskPostTaskInfo.md#status_message)
- [time](IMerchantAmazonSellersTaskPostTaskInfo.md#time)
...
[main.ts:173852](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L173852)
