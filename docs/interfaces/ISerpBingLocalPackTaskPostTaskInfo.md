[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackTaskPostTaskInfo`**
...
- [cost](ISerpBingLocalPackTaskPostTaskInfo.md#cost)
- [data](ISerpBingLocalPackTaskPostTaskInfo.md#data)
- [id](ISerpBingLocalPackTaskPostTaskInfo.md#id)
- [path](ISerpBingLocalPackTaskPostTaskInfo.md#path)
- [result](ISerpBingLocalPackTaskPostTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackTaskPostTaskInfo.md#status_message)
- [time](ISerpBingLocalPackTaskPostTaskInfo.md#time)
...
[main.ts:55730](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L55730)
