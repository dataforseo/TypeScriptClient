[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageDuplicateTagsTaskInfo
...
- [cost](IOnPageDuplicateTagsTaskInfo.md#cost)
- [data](IOnPageDuplicateTagsTaskInfo.md#data)
- [id](IOnPageDuplicateTagsTaskInfo.md#id)
- [path](IOnPageDuplicateTagsTaskInfo.md#path)
- [result](IOnPageDuplicateTagsTaskInfo.md#result)
- [result\_count](IOnPageDuplicateTagsTaskInfo.md#result_count)
- [status\_code](IOnPageDuplicateTagsTaskInfo.md#status_code)
- [status\_message](IOnPageDuplicateTagsTaskInfo.md#status_message)
- [time](IOnPageDuplicateTagsTaskInfo.md#time)
...
[main.ts:147369](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L147369)
