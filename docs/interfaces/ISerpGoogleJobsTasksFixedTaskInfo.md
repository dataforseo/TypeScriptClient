...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleJobsTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleJobsTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleJobsTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleJobsTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleJobsTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleJobsTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleJobsTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleJobsTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleJobsTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleJobsTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleJobsTasksFixedTaskInfo.md#time)
...
[main.ts:49046](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L49046)
