...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocalFinderTaskPostTaskInfo
...
- [cost](ISerpGoogleLocalFinderTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleLocalFinderTaskPostTaskInfo.md#data)
- [id](ISerpGoogleLocalFinderTaskPostTaskInfo.md#id)
- [path](ISerpGoogleLocalFinderTaskPostTaskInfo.md#path)
- [result](ISerpGoogleLocalFinderTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleLocalFinderTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocalFinderTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocalFinderTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleLocalFinderTaskPostTaskInfo.md#time)
...
[main.ts:39996](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L39996)
