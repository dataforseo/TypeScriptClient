...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpSearchTaskPostTaskInfo

# Interface: IBusinessDataYelpSearchTaskPostTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  
  ↳ **`IBusinessDataYelpSearchTaskPostTaskInfo`**
...
- [cost](IBusinessDataYelpSearchTaskPostTaskInfo.md#cost)
- [data](IBusinessDataYelpSearchTaskPostTaskInfo.md#data)
- [id](IBusinessDataYelpSearchTaskPostTaskInfo.md#id)
- [path](IBusinessDataYelpSearchTaskPostTaskInfo.md#path)
- [result](IBusinessDataYelpSearchTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataYelpSearchTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpSearchTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpSearchTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataYelpSearchTaskPostTaskInfo.md#time)
...
[main.ts:203614](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L203614)
