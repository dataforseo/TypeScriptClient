...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotSearchTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotSearchTaskPostTaskInfo`**
...
- [cost](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#data)
- [id](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#id)
- [path](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#path)
- [result](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotSearchTaskPostTaskInfo.md#time)
...
[main.ts:198862](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L198862)
