...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListingsSearchLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListingsSearchLiveTaskInfo`**
...
- [cost](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#cost)
- [data](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#data)
- [id](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#id)
- [path](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#path)
- [result](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListingsSearchLiveTaskInfo.md#time)
...
[main.ts:182502](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L182502)
