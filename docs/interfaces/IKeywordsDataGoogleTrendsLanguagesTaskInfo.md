[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleTrendsLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleTrendsLanguagesTaskInfo`**
...
- [cost](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#cost)
- [data](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#data)
- [id](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#id)
- [path](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#path)
- [result](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleTrendsLanguagesTaskInfo.md#time)
...
[main.ts:119539](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L119539)
