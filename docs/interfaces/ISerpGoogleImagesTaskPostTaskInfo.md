[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesTaskPostTaskInfo`**
...
- [cost](ISerpGoogleImagesTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleImagesTaskPostTaskInfo.md#data)
- [id](ISerpGoogleImagesTaskPostTaskInfo.md#id)
- [path](ISerpGoogleImagesTaskPostTaskInfo.md#path)
- [result](ISerpGoogleImagesTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleImagesTaskPostTaskInfo.md#time)
...
[main.ts:45610](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L45610)
