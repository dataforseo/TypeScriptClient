...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelSearchesTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelSearchesTaskGetTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelSearchesTaskGetTaskInfo.md#time)
...
[main.ts:194080](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L194080)
