[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppReviewsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppReviewsTasksReadyTaskInfo`**
...
- [cost](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#cost)
- [data](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#data)
- [id](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#id)
- [path](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#path)
- [result](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#status_message)
- [time](IAppDataAppleAppReviewsTasksReadyTaskInfo.md#time)
...
[main.ts:186140](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L186140)
