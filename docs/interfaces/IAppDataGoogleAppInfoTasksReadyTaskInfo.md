...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppInfoTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppInfoTasksReadyTaskInfo`**
...
- [cost](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#cost)
- [data](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#data)
- [id](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#id)
- [path](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#path)
- [result](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#status_message)
- [time](IAppDataGoogleAppInfoTasksReadyTaskInfo.md#time)
...
[main.ts:179698](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L179698)
