[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicTasksReadyTaskInfo`**
...
- [cost](ISerpBingOrganicTasksReadyTaskInfo.md#cost)
- [data](ISerpBingOrganicTasksReadyTaskInfo.md#data)
- [id](ISerpBingOrganicTasksReadyTaskInfo.md#id)
- [path](ISerpBingOrganicTasksReadyTaskInfo.md#path)
- [result](ISerpBingOrganicTasksReadyTaskInfo.md#result)
- [result\_count](ISerpBingOrganicTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicTasksReadyTaskInfo.md#status_message)
- [time](ISerpBingOrganicTasksReadyTaskInfo.md#time)
...
[main.ts:53936](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L53936)
