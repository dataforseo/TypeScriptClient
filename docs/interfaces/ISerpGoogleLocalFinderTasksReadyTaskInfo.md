...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocalFinderTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleLocalFinderTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleLocalFinderTasksReadyTaskInfo.md#time)
...
[main.ts:40208](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L40208)
