[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorReviewsTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorReviewsTaskGetTaskInfo`**
...
- [cost](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#data)
- [id](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#id)
- [path](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#path)
- [result](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorReviewsTaskGetTaskInfo.md#time)
...
[main.ts:202724](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L202724)
