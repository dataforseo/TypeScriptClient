...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageRawHtmlTaskInfo
...
- [cost](IOnPageRawHtmlTaskInfo.md#cost)
- [data](IOnPageRawHtmlTaskInfo.md#data)
- [id](IOnPageRawHtmlTaskInfo.md#id)
- [path](IOnPageRawHtmlTaskInfo.md#path)
- [result](IOnPageRawHtmlTaskInfo.md#result)
- [result\_count](IOnPageRawHtmlTaskInfo.md#result_count)
- [status\_code](IOnPageRawHtmlTaskInfo.md#status_code)
- [status\_message](IOnPageRawHtmlTaskInfo.md#status_message)
- [time](IOnPageRawHtmlTaskInfo.md#time)
...
[main.ts:151373](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L151373)
