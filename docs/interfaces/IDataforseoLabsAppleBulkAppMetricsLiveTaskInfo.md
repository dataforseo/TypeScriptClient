[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo`**
...
- [cost](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#data)
- [id](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#id)
- [path](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#path)
- [result](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsAppleBulkAppMetricsLiveTaskInfo.md#time)
...
[main.ts:110468](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L110468)
