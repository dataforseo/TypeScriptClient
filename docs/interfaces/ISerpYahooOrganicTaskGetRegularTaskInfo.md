...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicTaskGetRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicTaskGetRegularTaskInfo`**
...
- [cost](ISerpYahooOrganicTaskGetRegularTaskInfo.md#cost)
- [data](ISerpYahooOrganicTaskGetRegularTaskInfo.md#data)
- [id](ISerpYahooOrganicTaskGetRegularTaskInfo.md#id)
- [path](ISerpYahooOrganicTaskGetRegularTaskInfo.md#path)
- [result](ISerpYahooOrganicTaskGetRegularTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicTaskGetRegularTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicTaskGetRegularTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicTaskGetRegularTaskInfo.md#status_message)
- [time](ISerpYahooOrganicTaskGetRegularTaskInfo.md#time)
...
[main.ts:63924](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L63924)
