[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisCategoryTrendsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisCategoryTrendsLiveTaskInfo`**
...
- [cost](IContentAnalysisCategoryTrendsLiveTaskInfo.md#cost)
- [data](IContentAnalysisCategoryTrendsLiveTaskInfo.md#data)
- [id](IContentAnalysisCategoryTrendsLiveTaskInfo.md#id)
- [path](IContentAnalysisCategoryTrendsLiveTaskInfo.md#path)
- [result](IContentAnalysisCategoryTrendsLiveTaskInfo.md#result)
- [result\_count](IContentAnalysisCategoryTrendsLiveTaskInfo.md#result_count)
- [status\_code](IContentAnalysisCategoryTrendsLiveTaskInfo.md#status_code)
- [status\_message](IContentAnalysisCategoryTrendsLiveTaskInfo.md#status_message)
- [time](IContentAnalysisCategoryTrendsLiveTaskInfo.md#time)
...
[main.ts:159683](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L159683)
