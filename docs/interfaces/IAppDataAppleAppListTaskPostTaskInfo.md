[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppListTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppListTaskPostTaskInfo`**
...
- [cost](IAppDataAppleAppListTaskPostTaskInfo.md#cost)
- [data](IAppDataAppleAppListTaskPostTaskInfo.md#data)
- [id](IAppDataAppleAppListTaskPostTaskInfo.md#id)
- [path](IAppDataAppleAppListTaskPostTaskInfo.md#path)
- [result](IAppDataAppleAppListTaskPostTaskInfo.md#result)
- [result\_count](IAppDataAppleAppListTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppListTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppListTaskPostTaskInfo.md#status_message)
- [time](IAppDataAppleAppListTaskPostTaskInfo.md#time)
...
[main.ts:185170](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L185170)
