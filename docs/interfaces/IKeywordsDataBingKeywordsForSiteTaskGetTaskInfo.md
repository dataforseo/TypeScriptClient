[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordsForSiteTaskGetTaskInfo.md#time)
...
[main.ts:124403](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L124403)
