...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingSerpCompetitorsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingSerpCompetitorsLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingSerpCompetitorsLiveTaskInfo.md#time)
...
[main.ts:107212](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L107212)
