[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataYelpLocationsTaskInfo

# Interface: IBusinessDataYelpLocationsTaskInfo

## Hierarchy

- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)

  ↳ **`IBusinessDataYelpLocationsTaskInfo`**
...
- [cost](IBusinessDataYelpLocationsTaskInfo.md#cost)
- [data](IBusinessDataYelpLocationsTaskInfo.md#data)
- [id](IBusinessDataYelpLocationsTaskInfo.md#id)
- [path](IBusinessDataYelpLocationsTaskInfo.md#path)
- [result](IBusinessDataYelpLocationsTaskInfo.md#result)
- [result\_count](IBusinessDataYelpLocationsTaskInfo.md#result_count)
- [status\_code](IBusinessDataYelpLocationsTaskInfo.md#status_code)
- [status\_message](IBusinessDataYelpLocationsTaskInfo.md#status_message)
- [time](IBusinessDataYelpLocationsTaskInfo.md#time)
...
• `Optional` **result**: [`BusinessDataYelpLocationsResultInfo`](../classes/BusinessDataYelpLocationsResultInfo.md)[]

array of results

#### Defined in

[main.ts:202916](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L202916)
