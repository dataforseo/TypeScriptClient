...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageLinksTaskInfo
...
- [cost](IOnPageLinksTaskInfo.md#cost)
- [data](IOnPageLinksTaskInfo.md#data)
- [id](IOnPageLinksTaskInfo.md#id)
- [path](IOnPageLinksTaskInfo.md#path)
- [result](IOnPageLinksTaskInfo.md#result)
- [result\_count](IOnPageLinksTaskInfo.md#result_count)
- [status\_code](IOnPageLinksTaskInfo.md#status_code)
- [status\_message](IOnPageLinksTaskInfo.md#status_message)
- [time](IOnPageLinksTaskInfo.md#time)
...
[main.ts:148337](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L148337)
