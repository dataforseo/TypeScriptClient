[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListTaskGetHtmlTaskInfo`**
...
- [cost](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#cost)
- [data](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#data)
- [id](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#id)
- [path](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#path)
- [result](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListTaskGetHtmlTaskInfo.md#time)
...
[main.ts:179184](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L179184)
