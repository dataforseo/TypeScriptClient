...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicLiveRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicLiveRegularTaskInfo`**
...
- [cost](ISerpYahooOrganicLiveRegularTaskInfo.md#cost)
- [data](ISerpYahooOrganicLiveRegularTaskInfo.md#data)
- [id](ISerpYahooOrganicLiveRegularTaskInfo.md#id)
- [path](ISerpYahooOrganicLiveRegularTaskInfo.md#path)
- [result](ISerpYahooOrganicLiveRegularTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicLiveRegularTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicLiveRegularTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicLiveRegularTaskInfo.md#status_message)
- [time](ISerpYahooOrganicLiveRegularTaskInfo.md#time)
...
[main.ts:64662](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L64662)
