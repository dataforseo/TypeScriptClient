[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksAvailableFiltersTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksAvailableFiltersTaskInfo`**
...
- [cost](IBacklinksAvailableFiltersTaskInfo.md#cost)
- [data](IBacklinksAvailableFiltersTaskInfo.md#data)
- [id](IBacklinksAvailableFiltersTaskInfo.md#id)
- [path](IBacklinksAvailableFiltersTaskInfo.md#path)
- [result](IBacklinksAvailableFiltersTaskInfo.md#result)
- [result\_count](IBacklinksAvailableFiltersTaskInfo.md#result_count)
- [status\_code](IBacklinksAvailableFiltersTaskInfo.md#status_code)
- [status\_message](IBacklinksAvailableFiltersTaskInfo.md#status_message)
- [time](IBacklinksAvailableFiltersTaskInfo.md#time)
...
[main.ts:128879](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L128879)
