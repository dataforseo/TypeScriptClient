[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationCheckGrammarLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationCheckGrammarLiveTaskInfo`**
...
- [cost](IContentGenerationCheckGrammarLiveTaskInfo.md#cost)
- [data](IContentGenerationCheckGrammarLiveTaskInfo.md#data)
- [id](IContentGenerationCheckGrammarLiveTaskInfo.md#id)
- [path](IContentGenerationCheckGrammarLiveTaskInfo.md#path)
- [result](IContentGenerationCheckGrammarLiveTaskInfo.md#result)
- [result\_count](IContentGenerationCheckGrammarLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationCheckGrammarLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationCheckGrammarLiveTaskInfo.md#status_message)
- [time](IContentGenerationCheckGrammarLiveTaskInfo.md#time)
...
[main.ts:161731](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L161731)
