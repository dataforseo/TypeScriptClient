...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleRelevantPagesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleRelevantPagesLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleRelevantPagesLiveTaskInfo.md#time)
...
[main.ts:90422](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L90422)
