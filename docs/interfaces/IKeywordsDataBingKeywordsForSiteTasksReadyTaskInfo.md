...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordsForSiteTasksReadyTaskInfo.md#time)
...
[main.ts:124139](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L124139)
