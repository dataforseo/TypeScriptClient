...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackTaskGetHtmlTaskInfo`**
...
- [cost](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#cost)
- [data](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#data)
- [id](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#id)
- [path](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#path)
- [result](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#status_message)
- [time](ISerpBingLocalPackTaskGetHtmlTaskInfo.md#time)
...
[main.ts:56632](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L56632)
