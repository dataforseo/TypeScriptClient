[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocalFinderTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleLocalFinderTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleLocalFinderTasksFixedTaskInfo.md#time)
...
[main.ts:40420](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L40420)
