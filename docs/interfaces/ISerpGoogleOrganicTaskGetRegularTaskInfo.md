[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleOrganicTaskGetRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleOrganicTaskGetRegularTaskInfo`**
...
- [cost](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#cost)
- [data](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#data)
- [id](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#id)
- [path](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#path)
- [result](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#result)
- [result\_count](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#result_count)
- [status\_code](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#status_code)
- [status\_message](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#status_message)
- [time](ISerpGoogleOrganicTaskGetRegularTaskInfo.md#time)
...
[main.ts:26052](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L26052)
