...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpErrorsTaskInfo
...
- [cost](ISerpErrorsTaskInfo.md#cost)
- [data](ISerpErrorsTaskInfo.md#data)
- [id](ISerpErrorsTaskInfo.md#id)
- [path](ISerpErrorsTaskInfo.md#path)
- [result](ISerpErrorsTaskInfo.md#result)
- [result\_count](ISerpErrorsTaskInfo.md#result_count)
- [status\_code](ISerpErrorsTaskInfo.md#status_code)
- [status\_message](ISerpErrorsTaskInfo.md#status_message)
- [time](ISerpErrorsTaskInfo.md#time)
...
[main.ts:23338](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L23338)
