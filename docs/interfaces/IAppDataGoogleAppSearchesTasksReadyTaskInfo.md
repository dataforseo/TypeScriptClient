...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppSearchesTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppSearchesTasksReadyTaskInfo`**
...
- [cost](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#cost)
- [data](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#data)
- [id](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#id)
- [path](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#path)
- [result](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#status_message)
- [time](IAppDataGoogleAppSearchesTasksReadyTaskInfo.md#time)
...
[main.ts:177734](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L177734)
