[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleRankedKeywordsLiveTaskInfo.md#time)
...
[main.ts:87286](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L87286)
