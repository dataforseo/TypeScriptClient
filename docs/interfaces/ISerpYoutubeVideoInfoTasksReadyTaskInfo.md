[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoInfoTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoInfoTasksReadyTaskInfo`**
...
- [cost](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#cost)
- [data](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#data)
- [id](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#id)
- [path](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#path)
- [result](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoInfoTasksReadyTaskInfo.md#time)
...
[main.ts:58222](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L58222)
