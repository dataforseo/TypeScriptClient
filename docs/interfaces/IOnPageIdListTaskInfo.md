...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageIdListTaskInfo
...
- [cost](IOnPageIdListTaskInfo.md#cost)
- [data](IOnPageIdListTaskInfo.md#data)
- [id](IOnPageIdListTaskInfo.md#id)
- [path](IOnPageIdListTaskInfo.md#path)
- [result](IOnPageIdListTaskInfo.md#result)
- [result\_count](IOnPageIdListTaskInfo.md#result_count)
- [status\_code](IOnPageIdListTaskInfo.md#status_code)
- [status\_message](IOnPageIdListTaskInfo.md#status_message)
- [time](IOnPageIdListTaskInfo.md#time)
...
[main.ts:141723](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L141723)
