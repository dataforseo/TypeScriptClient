[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksReferringNetworksLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksReferringNetworksLiveTaskInfo`**
...
- [cost](IBacklinksReferringNetworksLiveTaskInfo.md#cost)
- [data](IBacklinksReferringNetworksLiveTaskInfo.md#data)
- [id](IBacklinksReferringNetworksLiveTaskInfo.md#id)
- [path](IBacklinksReferringNetworksLiveTaskInfo.md#path)
- [result](IBacklinksReferringNetworksLiveTaskInfo.md#result)
- [result\_count](IBacklinksReferringNetworksLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksReferringNetworksLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksReferringNetworksLiveTaskInfo.md#status_message)
- [time](IBacklinksReferringNetworksLiveTaskInfo.md#time)
...
[main.ts:135865](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L135865)
