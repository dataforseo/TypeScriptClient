[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleRelatedKeywordsLiveTaskInfo.md#time)
...
[main.ts:80544](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L80544)
