...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleSellersAdUrlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleSellersAdUrlTaskInfo`**
...
- [cost](IMerchantGoogleSellersAdUrlTaskInfo.md#cost)
- [data](IMerchantGoogleSellersAdUrlTaskInfo.md#data)
- [id](IMerchantGoogleSellersAdUrlTaskInfo.md#id)
- [path](IMerchantGoogleSellersAdUrlTaskInfo.md#path)
- [result](IMerchantGoogleSellersAdUrlTaskInfo.md#result)
- [result\_count](IMerchantGoogleSellersAdUrlTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleSellersAdUrlTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleSellersAdUrlTaskInfo.md#status_message)
- [time](IMerchantGoogleSellersAdUrlTaskInfo.md#time)
...
[main.ts:169687](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L169687)
