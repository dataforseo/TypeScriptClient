[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductsTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductsTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantGoogleProductsTaskGetHtmlTaskInfo.md#time)
...
[main.ts:165785](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L165785)
