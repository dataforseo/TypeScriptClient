[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonProductsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonProductsTasksReadyTaskInfo`**
...
- [cost](IMerchantAmazonProductsTasksReadyTaskInfo.md#cost)
- [data](IMerchantAmazonProductsTasksReadyTaskInfo.md#data)
- [id](IMerchantAmazonProductsTasksReadyTaskInfo.md#id)
- [path](IMerchantAmazonProductsTasksReadyTaskInfo.md#path)
- [result](IMerchantAmazonProductsTasksReadyTaskInfo.md#result)
- [result\_count](IMerchantAmazonProductsTasksReadyTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonProductsTasksReadyTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonProductsTasksReadyTaskInfo.md#status_message)
- [time](IMerchantAmazonProductsTasksReadyTaskInfo.md#time)
...
[main.ts:170594](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L170594)
