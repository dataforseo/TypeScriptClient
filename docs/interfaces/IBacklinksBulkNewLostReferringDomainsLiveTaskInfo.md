[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBulkNewLostReferringDomainsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBulkNewLostReferringDomainsLiveTaskInfo`**
...
- [cost](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#cost)
- [data](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#data)
- [id](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#id)
- [path](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#path)
- [result](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#result)
- [result\_count](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#status_message)
- [time](IBacklinksBulkNewLostReferringDomainsLiveTaskInfo.md#time)
...
[main.ts:141375](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L141375)
