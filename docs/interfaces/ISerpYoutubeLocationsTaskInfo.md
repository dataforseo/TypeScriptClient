...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeLocationsTaskInfo
...
- [cost](ISerpYoutubeLocationsTaskInfo.md#cost)
- [data](ISerpYoutubeLocationsTaskInfo.md#data)
- [id](ISerpYoutubeLocationsTaskInfo.md#id)
- [path](ISerpYoutubeLocationsTaskInfo.md#path)
- [result](ISerpYoutubeLocationsTaskInfo.md#result)
- [result\_count](ISerpYoutubeLocationsTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeLocationsTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeLocationsTaskInfo.md#status_message)
- [time](ISerpYoutubeLocationsTaskInfo.md#time)
...
[main.ts:57308](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L57308)
