[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleImagesTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleImagesTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleImagesTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleImagesTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleImagesTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleImagesTasksReadyTaskInfo.md#time)
...
[main.ts:45822](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L45822)
