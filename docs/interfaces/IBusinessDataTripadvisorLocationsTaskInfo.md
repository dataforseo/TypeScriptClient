...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorLocationsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorLocationsTaskInfo`**
...
- [cost](IBusinessDataTripadvisorLocationsTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorLocationsTaskInfo.md#data)
- [id](IBusinessDataTripadvisorLocationsTaskInfo.md#id)
- [path](IBusinessDataTripadvisorLocationsTaskInfo.md#path)
- [result](IBusinessDataTripadvisorLocationsTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorLocationsTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorLocationsTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorLocationsTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorLocationsTaskInfo.md#time)
...
[main.ts:200476](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L200476)
