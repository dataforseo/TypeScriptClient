[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleTrendsCategoriesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleTrendsCategoriesTaskInfo`**
...
- [cost](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#cost)
- [data](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#data)
- [id](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#id)
- [path](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#path)
- [result](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleTrendsCategoriesTaskInfo.md#time)
...
[main.ts:119725](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L119725)
