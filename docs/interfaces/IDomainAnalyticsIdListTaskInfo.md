[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsIdListTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsIdListTaskInfo`**
...
- [cost](IDomainAnalyticsIdListTaskInfo.md#cost)
- [data](IDomainAnalyticsIdListTaskInfo.md#data)
- [id](IDomainAnalyticsIdListTaskInfo.md#id)
- [path](IDomainAnalyticsIdListTaskInfo.md#path)
- [result](IDomainAnalyticsIdListTaskInfo.md#result)
- [result\_count](IDomainAnalyticsIdListTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsIdListTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsIdListTaskInfo.md#status_message)
- [time](IDomainAnalyticsIdListTaskInfo.md#time)
...
[main.ts:71150](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L71150)
