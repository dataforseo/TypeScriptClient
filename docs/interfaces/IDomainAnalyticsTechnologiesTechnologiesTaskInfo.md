[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesTechnologiesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesTechnologiesTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesTechnologiesTaskInfo.md#time)
...
[main.ts:72368](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L72368)
