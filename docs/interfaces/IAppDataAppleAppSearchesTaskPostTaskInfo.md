...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppSearchesTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppSearchesTaskPostTaskInfo`**
...
- [cost](IAppDataAppleAppSearchesTaskPostTaskInfo.md#cost)
- [data](IAppDataAppleAppSearchesTaskPostTaskInfo.md#data)
- [id](IAppDataAppleAppSearchesTaskPostTaskInfo.md#id)
- [path](IAppDataAppleAppSearchesTaskPostTaskInfo.md#path)
- [result](IAppDataAppleAppSearchesTaskPostTaskInfo.md#result)
- [result\_count](IAppDataAppleAppSearchesTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppSearchesTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppSearchesTaskPostTaskInfo.md#status_message)
- [time](IAppDataAppleAppSearchesTaskPostTaskInfo.md#time)
...
[main.ts:183376](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L183376)
