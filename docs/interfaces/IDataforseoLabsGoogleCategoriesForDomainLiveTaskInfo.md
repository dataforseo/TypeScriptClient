[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleCategoriesForDomainLiveTaskInfo.md#time)
...
[main.ts:83626](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L83626)
