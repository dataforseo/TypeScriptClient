[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamLanguagesTaskInfo
...
- [cost](ISerpSeznamLanguagesTaskInfo.md#cost)
- [data](ISerpSeznamLanguagesTaskInfo.md#data)
- [id](ISerpSeznamLanguagesTaskInfo.md#id)
- [path](ISerpSeznamLanguagesTaskInfo.md#path)
- [result](ISerpSeznamLanguagesTaskInfo.md#result)
- [result\_count](ISerpSeznamLanguagesTaskInfo.md#result_count)
- [status\_code](ISerpSeznamLanguagesTaskInfo.md#status_code)
- [status\_message](ISerpSeznamLanguagesTaskInfo.md#status_message)
- [time](ISerpSeznamLanguagesTaskInfo.md#time)
...
[main.ts:69234](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L69234)
