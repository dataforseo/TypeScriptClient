[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordsForKeywordsLiveTaskInfo.md#time)
...
[main.ts:126275](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L126275)
