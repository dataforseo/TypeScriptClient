[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorLocationsCountryTaskInfo`**
...
- [cost](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#data)
- [id](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#id)
- [path](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#path)
- [result](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorLocationsCountryTaskInfo.md#time)
...
[main.ts:200668](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L200668)
