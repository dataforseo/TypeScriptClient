[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBaiduLocationsCountryTaskInfo`**
...
- [cost](ISerpBaiduLocationsCountryTaskInfo.md#cost)
- [data](ISerpBaiduLocationsCountryTaskInfo.md#data)
- [id](ISerpBaiduLocationsCountryTaskInfo.md#id)
- [path](ISerpBaiduLocationsCountryTaskInfo.md#path)
- [result](ISerpBaiduLocationsCountryTaskInfo.md#result)
- [result\_count](ISerpBaiduLocationsCountryTaskInfo.md#result_count)
- [status\_code](ISerpBaiduLocationsCountryTaskInfo.md#status_code)
- [status\_message](ISerpBaiduLocationsCountryTaskInfo.md#status_message)
- [time](ISerpBaiduLocationsCountryTaskInfo.md#time)
...
[main.ts:65520](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L65520)
