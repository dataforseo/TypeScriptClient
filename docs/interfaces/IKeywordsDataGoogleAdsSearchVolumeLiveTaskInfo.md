[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsSearchVolumeLiveTaskInfo.md#time)
...
[main.ts:114252](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L114252)
