...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageForceStopTaskInfo
...
- [cost](IOnPageForceStopTaskInfo.md#cost)
- [data](IOnPageForceStopTaskInfo.md#data)
- [id](IOnPageForceStopTaskInfo.md#id)
- [path](IOnPageForceStopTaskInfo.md#path)
- [result](IOnPageForceStopTaskInfo.md#result)
- [result\_count](IOnPageForceStopTaskInfo.md#result_count)
- [status\_code](IOnPageForceStopTaskInfo.md#status_code)
- [status\_message](IOnPageForceStopTaskInfo.md#status_message)
- [time](IOnPageForceStopTaskInfo.md#time)
...
[main.ts:142227](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L142227)
