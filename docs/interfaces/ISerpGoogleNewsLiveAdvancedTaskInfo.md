[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleNewsLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleNewsLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleNewsLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleNewsLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleNewsLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleNewsLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleNewsLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleNewsLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleNewsLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleNewsLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleNewsLiveAdvancedTaskInfo.md#time)
...
[main.ts:43294](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L43294)
