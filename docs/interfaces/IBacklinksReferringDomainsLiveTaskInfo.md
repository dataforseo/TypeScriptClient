...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksReferringDomainsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksReferringDomainsLiveTaskInfo`**
...
- [cost](IBacklinksReferringDomainsLiveTaskInfo.md#cost)
- [data](IBacklinksReferringDomainsLiveTaskInfo.md#data)
- [id](IBacklinksReferringDomainsLiveTaskInfo.md#id)
- [path](IBacklinksReferringDomainsLiveTaskInfo.md#path)
- [result](IBacklinksReferringDomainsLiveTaskInfo.md#result)
- [result\_count](IBacklinksReferringDomainsLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksReferringDomainsLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksReferringDomainsLiveTaskInfo.md#status_message)
- [time](IBacklinksReferringDomainsLiveTaskInfo.md#time)
...
[main.ts:135091](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L135091)
