...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksBulkRanksLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksBulkRanksLiveTaskInfo`**
...
- [cost](IBacklinksBulkRanksLiveTaskInfo.md#cost)
- [data](IBacklinksBulkRanksLiveTaskInfo.md#data)
- [id](IBacklinksBulkRanksLiveTaskInfo.md#id)
- [path](IBacklinksBulkRanksLiveTaskInfo.md#path)
- [result](IBacklinksBulkRanksLiveTaskInfo.md#result)
- [result\_count](IBacklinksBulkRanksLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksBulkRanksLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksBulkRanksLiveTaskInfo.md#status_message)
- [time](IBacklinksBulkRanksLiveTaskInfo.md#time)
...
[main.ts:139577](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L139577)
