[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsStatusTaskInfo
...
- [cost](IDataforseoLabsStatusTaskInfo.md#cost)
- [data](IDataforseoLabsStatusTaskInfo.md#data)
- [id](IDataforseoLabsStatusTaskInfo.md#id)
- [path](IDataforseoLabsStatusTaskInfo.md#path)
- [result](IDataforseoLabsStatusTaskInfo.md#result)
- [result\_count](IDataforseoLabsStatusTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsStatusTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsStatusTaskInfo.md#status_message)
- [time](IDataforseoLabsStatusTaskInfo.md#time)
...
[main.ts:76938](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L76938)
