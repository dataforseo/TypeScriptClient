[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleOrganicTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleOrganicTaskPostTaskInfo`**
...
- [cost](ISerpGoogleOrganicTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleOrganicTaskPostTaskInfo.md#data)
- [id](ISerpGoogleOrganicTaskPostTaskInfo.md#id)
- [path](ISerpGoogleOrganicTaskPostTaskInfo.md#path)
- [result](ISerpGoogleOrganicTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleOrganicTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleOrganicTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleOrganicTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleOrganicTaskPostTaskInfo.md#time)
...
[main.ts:24664](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L24664)
