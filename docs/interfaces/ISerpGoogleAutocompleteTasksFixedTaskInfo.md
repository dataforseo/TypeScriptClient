[Documentation](../README.md) / [Exports](../modules.md) / ISerpGoogleAutocompleteTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleAutocompleteTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleAutocompleteTasksFixedTaskInfo.md#time)
