[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonProductsTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonProductsTaskGetHtmlTaskInfo`**
...
- [cost](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#cost)
- [data](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#data)
- [id](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#id)
- [path](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#path)
- [result](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#result)
- [result\_count](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#status_message)
- [time](IMerchantAmazonProductsTaskGetHtmlTaskInfo.md#time)
...
[main.ts:171706](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L171706)
