[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicLiveHtmlTaskInfo`**
...
- [cost](ISerpYahooOrganicLiveHtmlTaskInfo.md#cost)
- [data](ISerpYahooOrganicLiveHtmlTaskInfo.md#data)
- [id](ISerpYahooOrganicLiveHtmlTaskInfo.md#id)
- [path](ISerpYahooOrganicLiveHtmlTaskInfo.md#path)
- [result](ISerpYahooOrganicLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicLiveHtmlTaskInfo.md#status_message)
- [time](ISerpYahooOrganicLiveHtmlTaskInfo.md#time)
...
[main.ts:65140](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L65140)
