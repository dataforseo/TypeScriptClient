...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleLocationsCountryTaskInfo`**
...
- [cost](ISerpGoogleLocationsCountryTaskInfo.md#cost)
- [data](ISerpGoogleLocationsCountryTaskInfo.md#data)
- [id](ISerpGoogleLocationsCountryTaskInfo.md#id)
- [path](ISerpGoogleLocationsCountryTaskInfo.md#path)
- [result](ISerpGoogleLocationsCountryTaskInfo.md#result)
- [result\_count](ISerpGoogleLocationsCountryTaskInfo.md#result_count)
- [status\_code](ISerpGoogleLocationsCountryTaskInfo.md#status_code)
- [status\_message](ISerpGoogleLocationsCountryTaskInfo.md#status_message)
- [time](ISerpGoogleLocationsCountryTaskInfo.md#time)
...
[main.ts:24394](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L24394)
