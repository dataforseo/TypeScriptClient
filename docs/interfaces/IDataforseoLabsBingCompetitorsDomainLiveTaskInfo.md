...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingCompetitorsDomainLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingCompetitorsDomainLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingCompetitorsDomainLiveTaskInfo.md#time)
...
[main.ts:103324](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L103324)
