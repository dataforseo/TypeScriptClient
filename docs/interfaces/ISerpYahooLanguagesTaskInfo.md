...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooLanguagesTaskInfo
...
- [cost](ISerpYahooLanguagesTaskInfo.md#cost)
- [data](ISerpYahooLanguagesTaskInfo.md#data)
- [id](ISerpYahooLanguagesTaskInfo.md#id)
- [path](ISerpYahooLanguagesTaskInfo.md#path)
- [result](ISerpYahooLanguagesTaskInfo.md#result)
- [result\_count](ISerpYahooLanguagesTaskInfo.md#result_count)
- [status\_code](ISerpYahooLanguagesTaskInfo.md#status_code)
- [status\_message](ISerpYahooLanguagesTaskInfo.md#status_message)
- [time](ISerpYahooLanguagesTaskInfo.md#time)
...
[main.ts:63134](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L63134)
