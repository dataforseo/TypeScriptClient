...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleImagesLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleImagesLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleImagesLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleImagesLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleImagesLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleImagesLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleImagesLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleImagesLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleImagesLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleImagesLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleImagesLiveAdvancedTaskInfo.md#time)
...
[main.ts:46874](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L46874)
