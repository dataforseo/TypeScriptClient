[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelInfoLiveAdvancedTaskInfo.md#time)
...
[main.ts:197221](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L197221)
