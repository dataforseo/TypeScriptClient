[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsBingDomainRankOverviewLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsBingDomainRankOverviewLiveTaskInfo`**
...
- [cost](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#cost)
- [data](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#data)
- [id](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#id)
- [path](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#path)
- [result](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsBingDomainRankOverviewLiveTaskInfo.md#time)
...
[main.ts:104244](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L104244)
