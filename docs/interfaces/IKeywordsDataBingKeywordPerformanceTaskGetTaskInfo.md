[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordPerformanceTaskGetTaskInfo.md#time)
...
[main.ts:127483](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L127483)
