...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageForceStopResponseInfo
...
- [cost](IOnPageForceStopResponseInfo.md#cost)
- [status\_code](IOnPageForceStopResponseInfo.md#status_code)
- [status\_message](IOnPageForceStopResponseInfo.md#status_message)
- [tasks](IOnPageForceStopResponseInfo.md#tasks)
- [tasks\_count](IOnPageForceStopResponseInfo.md#tasks_count)
- [tasks\_error](IOnPageForceStopResponseInfo.md#tasks_error)
- [time](IOnPageForceStopResponseInfo.md#time)
- [version](IOnPageForceStopResponseInfo.md#version)
...
[main.ts:142282](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L142282)
