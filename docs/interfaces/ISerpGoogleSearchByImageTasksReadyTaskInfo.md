...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleSearchByImageTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleSearchByImageTasksReadyTaskInfo`**
...
- [cost](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#cost)
- [data](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#data)
- [id](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#id)
- [path](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#path)
- [result](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#result)
- [result\_count](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#status_message)
- [time](ISerpGoogleSearchByImageTasksReadyTaskInfo.md#time)
...
[main.ts:47742](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L47742)
