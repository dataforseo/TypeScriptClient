...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppReviewsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppReviewsTaskPostTaskInfo`**
...
- [cost](IAppDataAppleAppReviewsTaskPostTaskInfo.md#cost)
- [data](IAppDataAppleAppReviewsTaskPostTaskInfo.md#data)
- [id](IAppDataAppleAppReviewsTaskPostTaskInfo.md#id)
- [path](IAppDataAppleAppReviewsTaskPostTaskInfo.md#path)
- [result](IAppDataAppleAppReviewsTaskPostTaskInfo.md#result)
- [result\_count](IAppDataAppleAppReviewsTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppReviewsTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppReviewsTaskPostTaskInfo.md#status_message)
- [time](IAppDataAppleAppReviewsTaskPostTaskInfo.md#time)
...
[main.ts:185946](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L185946)
