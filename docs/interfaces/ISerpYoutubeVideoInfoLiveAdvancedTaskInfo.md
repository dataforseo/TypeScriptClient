[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoInfoLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoInfoLiveAdvancedTaskInfo`**
...
- [cost](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#cost)
- [data](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#data)
- [id](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#id)
- [path](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#path)
- [result](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoInfoLiveAdvancedTaskInfo.md#time)
...
[main.ts:59378](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L59378)
