...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleReviewsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleReviewsTaskPostTaskInfo`**
...
- [cost](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#cost)
- [data](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#data)
- [id](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#id)
- [path](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#path)
- [result](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#status_message)
- [time](IBusinessDataGoogleReviewsTaskPostTaskInfo.md#time)
...
[main.ts:197908](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L197908)
