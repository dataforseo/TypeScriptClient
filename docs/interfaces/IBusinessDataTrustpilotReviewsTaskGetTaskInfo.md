...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTrustpilotReviewsTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTrustpilotReviewsTaskGetTaskInfo`**
...
- [cost](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#cost)
- [data](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#data)
- [id](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#id)
- [path](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#path)
- [result](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataTrustpilotReviewsTaskGetTaskInfo.md#time)
...
[main.ts:200284](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L200284)
