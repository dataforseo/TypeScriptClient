[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsErrorsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsErrorsTaskInfo`**
...
- [cost](IDomainAnalyticsErrorsTaskInfo.md#cost)
- [data](IDomainAnalyticsErrorsTaskInfo.md#data)
- [id](IDomainAnalyticsErrorsTaskInfo.md#id)
- [path](IDomainAnalyticsErrorsTaskInfo.md#path)
- [result](IDomainAnalyticsErrorsTaskInfo.md#result)
- [result\_count](IDomainAnalyticsErrorsTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsErrorsTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsErrorsTaskInfo.md#status_message)
- [time](IDomainAnalyticsErrorsTaskInfo.md#time)
...
[main.ts:71492](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L71492)
