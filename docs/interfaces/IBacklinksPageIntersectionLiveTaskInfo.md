...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksPageIntersectionLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBacklinksPageIntersectionLiveTaskInfo`**
...
- [cost](IBacklinksPageIntersectionLiveTaskInfo.md#cost)
- [data](IBacklinksPageIntersectionLiveTaskInfo.md#data)
- [id](IBacklinksPageIntersectionLiveTaskInfo.md#id)
- [path](IBacklinksPageIntersectionLiveTaskInfo.md#path)
- [result](IBacklinksPageIntersectionLiveTaskInfo.md#result)
- [result\_count](IBacklinksPageIntersectionLiveTaskInfo.md#result_count)
- [status\_code](IBacklinksPageIntersectionLiveTaskInfo.md#status_code)
- [status\_message](IBacklinksPageIntersectionLiveTaskInfo.md#status_message)
- [time](IBacklinksPageIntersectionLiveTaskInfo.md#time)
...
[main.ts:138295](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L138295)
