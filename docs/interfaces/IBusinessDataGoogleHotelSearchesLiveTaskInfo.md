...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelSearchesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelSearchesLiveTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelSearchesLiveTaskInfo.md#time)
...
[main.ts:194756](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L194756)
