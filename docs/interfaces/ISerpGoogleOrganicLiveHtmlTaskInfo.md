...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleOrganicLiveHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleOrganicLiveHtmlTaskInfo`**
...
- [cost](ISerpGoogleOrganicLiveHtmlTaskInfo.md#cost)
- [data](ISerpGoogleOrganicLiveHtmlTaskInfo.md#data)
- [id](ISerpGoogleOrganicLiveHtmlTaskInfo.md#id)
- [path](ISerpGoogleOrganicLiveHtmlTaskInfo.md#path)
- [result](ISerpGoogleOrganicLiveHtmlTaskInfo.md#result)
- [result\_count](ISerpGoogleOrganicLiveHtmlTaskInfo.md#result_count)
- [status\_code](ISerpGoogleOrganicLiveHtmlTaskInfo.md#status_code)
- [status\_message](ISerpGoogleOrganicLiveHtmlTaskInfo.md#status_message)
- [time](ISerpGoogleOrganicLiveHtmlTaskInfo.md#time)
...
[main.ts:37252](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L37252)
