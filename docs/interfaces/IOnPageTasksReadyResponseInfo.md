...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageTasksReadyResponseInfo
...
- [cost](IOnPageTasksReadyResponseInfo.md#cost)
- [status\_code](IOnPageTasksReadyResponseInfo.md#status_code)
- [status\_message](IOnPageTasksReadyResponseInfo.md#status_message)
- [tasks](IOnPageTasksReadyResponseInfo.md#tasks)
- [tasks\_count](IOnPageTasksReadyResponseInfo.md#tasks_count)
- [tasks\_error](IOnPageTasksReadyResponseInfo.md#tasks_error)
- [time](IOnPageTasksReadyResponseInfo.md#time)
- [version](IOnPageTasksReadyResponseInfo.md#version)
...
[main.ts:143196](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L143196)
