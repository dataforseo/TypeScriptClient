[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleMapsLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleMapsLiveAdvancedTaskInfo`**
...
- [cost](ISerpGoogleMapsLiveAdvancedTaskInfo.md#cost)
- [data](ISerpGoogleMapsLiveAdvancedTaskInfo.md#data)
- [id](ISerpGoogleMapsLiveAdvancedTaskInfo.md#id)
- [path](ISerpGoogleMapsLiveAdvancedTaskInfo.md#path)
- [result](ISerpGoogleMapsLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpGoogleMapsLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleMapsLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleMapsLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpGoogleMapsLiveAdvancedTaskInfo.md#time)
...
[main.ts:39574](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L39574)
