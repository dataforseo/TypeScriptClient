...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo`**
...
- [cost](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#cost)
- [data](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#data)
- [id](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#id)
- [path](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#path)
- [result](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoSubtitlesLiveAdvancedTaskInfo.md#time)
...
[main.ts:60982](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L60982)
