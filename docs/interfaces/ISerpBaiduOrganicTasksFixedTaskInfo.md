[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduOrganicTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBaiduOrganicTasksFixedTaskInfo`**
...
- [cost](ISerpBaiduOrganicTasksFixedTaskInfo.md#cost)
- [data](ISerpBaiduOrganicTasksFixedTaskInfo.md#data)
- [id](ISerpBaiduOrganicTasksFixedTaskInfo.md#id)
- [path](ISerpBaiduOrganicTasksFixedTaskInfo.md#path)
- [result](ISerpBaiduOrganicTasksFixedTaskInfo.md#result)
- [result\_count](ISerpBaiduOrganicTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpBaiduOrganicTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpBaiduOrganicTasksFixedTaskInfo.md#status_message)
- [time](ISerpBaiduOrganicTasksFixedTaskInfo.md#time)
...
[main.ts:66532](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L66532)
