[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpSeznamOrganicTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpSeznamOrganicTasksReadyTaskInfo`**
...
- [cost](ISerpSeznamOrganicTasksReadyTaskInfo.md#cost)
- [data](ISerpSeznamOrganicTasksReadyTaskInfo.md#data)
- [id](ISerpSeznamOrganicTasksReadyTaskInfo.md#id)
- [path](ISerpSeznamOrganicTasksReadyTaskInfo.md#path)
- [result](ISerpSeznamOrganicTasksReadyTaskInfo.md#result)
- [result\_count](ISerpSeznamOrganicTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpSeznamOrganicTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpSeznamOrganicTasksReadyTaskInfo.md#status_message)
- [time](ISerpSeznamOrganicTasksReadyTaskInfo.md#time)
...
[main.ts:69844](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L69844)
