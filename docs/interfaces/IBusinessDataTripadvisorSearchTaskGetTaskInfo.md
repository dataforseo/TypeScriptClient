...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataTripadvisorSearchTaskGetTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataTripadvisorSearchTaskGetTaskInfo`**
...
- [cost](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#cost)
- [data](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#data)
- [id](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#id)
- [path](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#path)
- [result](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#result)
- [result\_count](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#result_count)
- [status\_code](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#status_code)
- [status\_message](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#status_message)
- [time](IBusinessDataTripadvisorSearchTaskGetTaskInfo.md#time)
...
[main.ts:201658](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L201658)
