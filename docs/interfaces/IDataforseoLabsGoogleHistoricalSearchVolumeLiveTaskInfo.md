...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleHistoricalSearchVolumeLiveTaskInfo.md#time)
...
[main.ts:82154](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L82154)
