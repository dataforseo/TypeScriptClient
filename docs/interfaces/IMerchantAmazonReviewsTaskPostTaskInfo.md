...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonReviewsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonReviewsTaskPostTaskInfo`**
...
- [cost](IMerchantAmazonReviewsTaskPostTaskInfo.md#cost)
- [data](IMerchantAmazonReviewsTaskPostTaskInfo.md#data)
- [id](IMerchantAmazonReviewsTaskPostTaskInfo.md#id)
- [path](IMerchantAmazonReviewsTaskPostTaskInfo.md#path)
- [result](IMerchantAmazonReviewsTaskPostTaskInfo.md#result)
- [result\_count](IMerchantAmazonReviewsTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonReviewsTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonReviewsTaskPostTaskInfo.md#status_message)
- [time](IMerchantAmazonReviewsTaskPostTaskInfo.md#time)
...
[main.ts:175280](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L175280)
