...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisPhraseTrendsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisPhraseTrendsLiveTaskInfo`**
...
- [cost](IContentAnalysisPhraseTrendsLiveTaskInfo.md#cost)
- [data](IContentAnalysisPhraseTrendsLiveTaskInfo.md#data)
- [id](IContentAnalysisPhraseTrendsLiveTaskInfo.md#id)
- [path](IContentAnalysisPhraseTrendsLiveTaskInfo.md#path)
- [result](IContentAnalysisPhraseTrendsLiveTaskInfo.md#result)
- [result\_count](IContentAnalysisPhraseTrendsLiveTaskInfo.md#result_count)
- [status\_code](IContentAnalysisPhraseTrendsLiveTaskInfo.md#status_code)
- [status\_message](IContentAnalysisPhraseTrendsLiveTaskInfo.md#status_message)
- [time](IContentAnalysisPhraseTrendsLiveTaskInfo.md#time)
...
[main.ts:159127](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L159127)
