...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListingsCategoriesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListingsCategoriesTaskInfo`**
...
- [cost](IAppDataGoogleAppListingsCategoriesTaskInfo.md#cost)
- [data](IAppDataGoogleAppListingsCategoriesTaskInfo.md#data)
- [id](IAppDataGoogleAppListingsCategoriesTaskInfo.md#id)
- [path](IAppDataGoogleAppListingsCategoriesTaskInfo.md#path)
- [result](IAppDataGoogleAppListingsCategoriesTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListingsCategoriesTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListingsCategoriesTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListingsCategoriesTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListingsCategoriesTaskInfo.md#time)
...
[main.ts:181998](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L181998)
