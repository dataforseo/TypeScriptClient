[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicTasksReadyTaskInfo`**
...
- [cost](ISerpYahooOrganicTasksReadyTaskInfo.md#cost)
- [data](ISerpYahooOrganicTasksReadyTaskInfo.md#data)
- [id](ISerpYahooOrganicTasksReadyTaskInfo.md#id)
- [path](ISerpYahooOrganicTasksReadyTaskInfo.md#path)
- [result](ISerpYahooOrganicTasksReadyTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicTasksReadyTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicTasksReadyTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicTasksReadyTaskInfo.md#status_message)
- [time](ISerpYahooOrganicTasksReadyTaskInfo.md#time)
...
[main.ts:63450](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L63450)
