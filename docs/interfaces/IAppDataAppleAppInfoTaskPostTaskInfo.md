[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppInfoTaskPostTaskInfo`**
...
- [cost](IAppDataAppleAppInfoTaskPostTaskInfo.md#cost)
- [data](IAppDataAppleAppInfoTaskPostTaskInfo.md#data)
- [id](IAppDataAppleAppInfoTaskPostTaskInfo.md#id)
- [path](IAppDataAppleAppInfoTaskPostTaskInfo.md#path)
- [result](IAppDataAppleAppInfoTaskPostTaskInfo.md#result)
- [result\_count](IAppDataAppleAppInfoTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppInfoTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppInfoTaskPostTaskInfo.md#status_message)
- [time](IAppDataAppleAppInfoTaskPostTaskInfo.md#time)
...
[main.ts:184114](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L184114)
