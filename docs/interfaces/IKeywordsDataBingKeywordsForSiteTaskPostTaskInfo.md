...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo`**
...
- [cost](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#data)
- [id](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#id)
- [path](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#path)
- [result](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataBingKeywordsForSiteTaskPostTaskInfo.md#time)
...
[main.ts:123947](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L123947)
