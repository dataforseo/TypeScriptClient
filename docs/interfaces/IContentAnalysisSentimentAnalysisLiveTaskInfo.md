[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisSentimentAnalysisLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisSentimentAnalysisLiveTaskInfo`**
...
- [cost](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#cost)
- [data](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#data)
- [id](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#id)
- [path](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#path)
- [result](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#result)
- [result\_count](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#result_count)
- [status\_code](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#status_code)
- [status\_message](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#status_message)
- [time](IContentAnalysisSentimentAnalysisLiveTaskInfo.md#time)
...
[main.ts:158091](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L158091)
