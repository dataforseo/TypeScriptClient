[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppSearchesTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppSearchesTaskPostTaskInfo`**
...
- [cost](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#cost)
- [data](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#data)
- [id](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#id)
- [path](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#path)
- [result](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#status_message)
- [time](IAppDataGoogleAppSearchesTaskPostTaskInfo.md#time)
...
[main.ts:177540](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L177540)
