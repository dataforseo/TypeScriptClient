...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleEventsTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleEventsTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleEventsTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleEventsTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleEventsTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleEventsTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleEventsTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleEventsTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleEventsTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleEventsTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleEventsTasksFixedTaskInfo.md#time)
...
[main.ts:44360](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L44360)
