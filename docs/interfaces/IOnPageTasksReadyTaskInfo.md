[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageTasksReadyTaskInfo
...
- [cost](IOnPageTasksReadyTaskInfo.md#cost)
- [data](IOnPageTasksReadyTaskInfo.md#data)
- [id](IOnPageTasksReadyTaskInfo.md#id)
- [path](IOnPageTasksReadyTaskInfo.md#path)
- [result](IOnPageTasksReadyTaskInfo.md#result)
- [result\_count](IOnPageTasksReadyTaskInfo.md#result_count)
- [status\_code](IOnPageTasksReadyTaskInfo.md#status_code)
- [status\_message](IOnPageTasksReadyTaskInfo.md#status_message)
- [time](IOnPageTasksReadyTaskInfo.md#time)
...
[main.ts:143141](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L143141)
