...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleKeywordSuggestionsLiveTaskInfo.md#time)
...
[main.ts:81114](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L81114)
