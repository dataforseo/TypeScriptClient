[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleOrganicLiveRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleOrganicLiveRegularTaskInfo`**
...
- [cost](ISerpGoogleOrganicLiveRegularTaskInfo.md#cost)
- [data](ISerpGoogleOrganicLiveRegularTaskInfo.md#data)
- [id](ISerpGoogleOrganicLiveRegularTaskInfo.md#id)
- [path](ISerpGoogleOrganicLiveRegularTaskInfo.md#path)
- [result](ISerpGoogleOrganicLiveRegularTaskInfo.md#result)
- [result\_count](ISerpGoogleOrganicLiveRegularTaskInfo.md#result_count)
- [status\_code](ISerpGoogleOrganicLiveRegularTaskInfo.md#status_code)
- [status\_message](ISerpGoogleOrganicLiveRegularTaskInfo.md#status_message)
- [time](ISerpGoogleOrganicLiveRegularTaskInfo.md#time)
...
[main.ts:36772](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L36772)
