[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYahooOrganicTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYahooOrganicTaskPostTaskInfo`**
...
- [cost](ISerpYahooOrganicTaskPostTaskInfo.md#cost)
- [data](ISerpYahooOrganicTaskPostTaskInfo.md#data)
- [id](ISerpYahooOrganicTaskPostTaskInfo.md#id)
- [path](ISerpYahooOrganicTaskPostTaskInfo.md#path)
- [result](ISerpYahooOrganicTaskPostTaskInfo.md#result)
- [result\_count](ISerpYahooOrganicTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpYahooOrganicTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpYahooOrganicTaskPostTaskInfo.md#status_message)
- [time](ISerpYahooOrganicTaskPostTaskInfo.md#time)
...
[main.ts:63238](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L63238)
