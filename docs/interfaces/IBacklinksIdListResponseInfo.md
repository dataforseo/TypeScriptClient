[dataforseo-client](../README.md) / [Exports](../modules.md) / IBacklinksIdListResponseInfo
...
- [cost](IBacklinksIdListResponseInfo.md#cost)
- [status\_code](IBacklinksIdListResponseInfo.md#status_code)
- [status\_message](IBacklinksIdListResponseInfo.md#status_message)
- [tasks](IBacklinksIdListResponseInfo.md#tasks)
- [tasks\_count](IBacklinksIdListResponseInfo.md#tasks_count)
- [tasks\_error](IBacklinksIdListResponseInfo.md#tasks_error)
- [time](IBacklinksIdListResponseInfo.md#time)
- [version](IBacklinksIdListResponseInfo.md#version)
...
[main.ts:128282](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L128282)
