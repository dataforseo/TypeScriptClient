[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageLighthouseTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageLighthouseTasksReadyTaskInfo`**
...
- [cost](IOnPageLighthouseTasksReadyTaskInfo.md#cost)
- [data](IOnPageLighthouseTasksReadyTaskInfo.md#data)
- [id](IOnPageLighthouseTasksReadyTaskInfo.md#id)
- [path](IOnPageLighthouseTasksReadyTaskInfo.md#path)
- [result](IOnPageLighthouseTasksReadyTaskInfo.md#result)
- [result\_count](IOnPageLighthouseTasksReadyTaskInfo.md#result_count)
- [status\_code](IOnPageLighthouseTasksReadyTaskInfo.md#status_code)
- [status\_message](IOnPageLighthouseTasksReadyTaskInfo.md#status_message)
- [time](IOnPageLighthouseTasksReadyTaskInfo.md#time)
...
[main.ts:154529](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L154529)
