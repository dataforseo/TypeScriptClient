...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleSellersTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleSellersTaskPostTaskInfo`**
...
- [cost](IMerchantGoogleSellersTaskPostTaskInfo.md#cost)
- [data](IMerchantGoogleSellersTaskPostTaskInfo.md#data)
- [id](IMerchantGoogleSellersTaskPostTaskInfo.md#id)
- [path](IMerchantGoogleSellersTaskPostTaskInfo.md#path)
- [result](IMerchantGoogleSellersTaskPostTaskInfo.md#result)
- [result\_count](IMerchantGoogleSellersTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleSellersTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleSellersTaskPostTaskInfo.md#status_message)
- [time](IMerchantGoogleSellersTaskPostTaskInfo.md#time)
...
[main.ts:166181](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L166181)
