[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBaiduLocationsTaskInfo
...
- [cost](ISerpBaiduLocationsTaskInfo.md#cost)
- [data](ISerpBaiduLocationsTaskInfo.md#data)
- [id](ISerpBaiduLocationsTaskInfo.md#id)
- [path](ISerpBaiduLocationsTaskInfo.md#path)
- [result](ISerpBaiduLocationsTaskInfo.md#result)
- [result\_count](ISerpBaiduLocationsTaskInfo.md#result_count)
- [status\_code](ISerpBaiduLocationsTaskInfo.md#status_code)
- [status\_message](ISerpBaiduLocationsTaskInfo.md#status_message)
- [time](ISerpBaiduLocationsTaskInfo.md#time)
...
[main.ts:65330](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L65330)
