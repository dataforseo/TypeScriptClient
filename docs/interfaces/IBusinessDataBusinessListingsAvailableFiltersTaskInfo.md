[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataBusinessListingsAvailableFiltersTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataBusinessListingsAvailableFiltersTaskInfo`**
...
- [cost](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#cost)
- [data](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#data)
- [id](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#id)
- [path](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#path)
- [result](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#result)
- [result\_count](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#result_count)
- [status\_code](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#status_code)
- [status\_message](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#status_message)
- [time](IBusinessDataBusinessListingsAvailableFiltersTaskInfo.md#time)
...
[main.ts:188294](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L188294)
