...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationGenerateMetaTagsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationGenerateMetaTagsLiveTaskInfo`**
...
- [cost](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#cost)
- [data](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#data)
- [id](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#id)
- [path](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#path)
- [result](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#result)
- [result\_count](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#status_message)
- [time](IContentGenerationGenerateMetaTagsLiveTaskInfo.md#time)
...
[main.ts:160781](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L160781)
