...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleTopSearchesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleTopSearchesLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleTopSearchesLiveTaskInfo.md#time)
...
[main.ts:85418](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L85418)
