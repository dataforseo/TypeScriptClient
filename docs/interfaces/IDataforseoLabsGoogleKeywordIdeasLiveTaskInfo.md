...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleKeywordIdeasLiveTaskInfo.md#time)
...
[main.ts:81676](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L81676)
