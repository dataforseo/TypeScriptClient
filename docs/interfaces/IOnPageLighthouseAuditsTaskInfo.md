...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageLighthouseAuditsTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IOnPageLighthouseAuditsTaskInfo`**
...
- [cost](IOnPageLighthouseAuditsTaskInfo.md#cost)
- [data](IOnPageLighthouseAuditsTaskInfo.md#data)
- [id](IOnPageLighthouseAuditsTaskInfo.md#id)
- [path](IOnPageLighthouseAuditsTaskInfo.md#path)
- [result](IOnPageLighthouseAuditsTaskInfo.md#result)
- [result\_count](IOnPageLighthouseAuditsTaskInfo.md#result_count)
- [status\_code](IOnPageLighthouseAuditsTaskInfo.md#status_code)
- [status\_message](IOnPageLighthouseAuditsTaskInfo.md#status_message)
- [time](IOnPageLighthouseAuditsTaskInfo.md#time)
...
[main.ts:153787](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L153787)
