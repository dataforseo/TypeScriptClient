[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleCategoriesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleCategoriesTaskInfo`**
...
- [cost](IAppDataAppleCategoriesTaskInfo.md#cost)
- [data](IAppDataAppleCategoriesTaskInfo.md#data)
- [id](IAppDataAppleCategoriesTaskInfo.md#id)
- [path](IAppDataAppleCategoriesTaskInfo.md#path)
- [result](IAppDataAppleCategoriesTaskInfo.md#result)
- [result\_count](IAppDataAppleCategoriesTaskInfo.md#result_count)
- [status\_code](IAppDataAppleCategoriesTaskInfo.md#status_code)
- [status\_message](IAppDataAppleCategoriesTaskInfo.md#status_message)
- [time](IAppDataAppleCategoriesTaskInfo.md#time)
...
[main.ts:182670](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L182670)
