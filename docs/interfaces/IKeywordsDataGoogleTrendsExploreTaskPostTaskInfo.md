[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo`**
...
- [cost](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#data)
- [id](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#id)
- [path](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#path)
- [result](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleTrendsExploreTaskPostTaskInfo.md#time)
...
[main.ts:120133](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L120133)
