...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppListTaskGetAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppListTaskGetAdvancedTaskInfo`**
...
- [cost](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#cost)
- [data](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#data)
- [id](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#id)
- [path](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#path)
- [result](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#result)
- [result\_count](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#status_message)
- [time](IAppDataAppleAppListTaskGetAdvancedTaskInfo.md#time)
...
[main.ts:185592](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L185592)
