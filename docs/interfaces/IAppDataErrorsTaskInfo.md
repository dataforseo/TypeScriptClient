...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataErrorsTaskInfo
...
- [cost](IAppDataErrorsTaskInfo.md#cost)
- [data](IAppDataErrorsTaskInfo.md#data)
- [id](IAppDataErrorsTaskInfo.md#id)
- [path](IAppDataErrorsTaskInfo.md#path)
- [result](IAppDataErrorsTaskInfo.md#result)
- [result\_count](IAppDataErrorsTaskInfo.md#result_count)
- [status\_code](IAppDataErrorsTaskInfo.md#status_code)
- [status\_message](IAppDataErrorsTaskInfo.md#status_message)
- [time](IAppDataErrorsTaskInfo.md#time)
...
[main.ts:176906](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L176906)
