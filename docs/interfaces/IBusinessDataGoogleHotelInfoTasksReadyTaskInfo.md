[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataGoogleHotelInfoTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataGoogleHotelInfoTasksReadyTaskInfo`**
...
- [cost](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#cost)
- [data](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#data)
- [id](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#id)
- [path](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#path)
- [result](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#result)
- [result\_count](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#result_count)
- [status\_code](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#status_code)
- [status\_message](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#status_message)
- [time](IBusinessDataGoogleHotelInfoTasksReadyTaskInfo.md#time)
...
[main.ts:195217](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L195217)
