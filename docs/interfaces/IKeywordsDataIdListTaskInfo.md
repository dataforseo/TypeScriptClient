[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataIdListTaskInfo
...
- [cost](IKeywordsDataIdListTaskInfo.md#cost)
- [data](IKeywordsDataIdListTaskInfo.md#data)
- [id](IKeywordsDataIdListTaskInfo.md#id)
- [path](IKeywordsDataIdListTaskInfo.md#path)
- [result](IKeywordsDataIdListTaskInfo.md#result)
- [result\_count](IKeywordsDataIdListTaskInfo.md#result_count)
- [status\_code](IKeywordsDataIdListTaskInfo.md#status_code)
- [status\_message](IKeywordsDataIdListTaskInfo.md#status_message)
- [time](IKeywordsDataIdListTaskInfo.md#time)
...
[main.ts:112506](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L112506)
