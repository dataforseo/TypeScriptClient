[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsAdTrafficByKeywordsTaskPostTaskInfo.md#time)
...
[main.ts:117933](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L117933)
