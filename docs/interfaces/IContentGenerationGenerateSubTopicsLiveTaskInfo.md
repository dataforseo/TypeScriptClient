[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationGenerateSubTopicsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationGenerateSubTopicsLiveTaskInfo`**
...
- [cost](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#cost)
- [data](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#data)
- [id](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#id)
- [path](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#path)
- [result](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#result)
- [result\_count](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#status_message)
- [time](IContentGenerationGenerateSubTopicsLiveTaskInfo.md#time)
...
[main.ts:161053](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L161053)
