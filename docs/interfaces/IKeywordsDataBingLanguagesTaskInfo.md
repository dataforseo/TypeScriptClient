[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataBingLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataBingLanguagesTaskInfo`**
...
- [cost](IKeywordsDataBingLanguagesTaskInfo.md#cost)
- [data](IKeywordsDataBingLanguagesTaskInfo.md#data)
- [id](IKeywordsDataBingLanguagesTaskInfo.md#id)
- [path](IKeywordsDataBingLanguagesTaskInfo.md#path)
- [result](IKeywordsDataBingLanguagesTaskInfo.md#result)
- [result\_count](IKeywordsDataBingLanguagesTaskInfo.md#result_count)
- [status\_code](IKeywordsDataBingLanguagesTaskInfo.md#status_code)
- [status\_message](IKeywordsDataBingLanguagesTaskInfo.md#status_message)
- [time](IKeywordsDataBingLanguagesTaskInfo.md#time)
...
[main.ts:122225](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L122225)
