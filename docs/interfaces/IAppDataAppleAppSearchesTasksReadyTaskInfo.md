[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppSearchesTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppSearchesTasksReadyTaskInfo`**
...
- [cost](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#cost)
- [data](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#data)
- [id](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#id)
- [path](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#path)
- [result](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#status_message)
- [time](IAppDataAppleAppSearchesTasksReadyTaskInfo.md#time)
...
[main.ts:183570](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L183570)
