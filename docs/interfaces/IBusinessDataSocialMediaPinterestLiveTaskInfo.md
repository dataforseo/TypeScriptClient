[dataforseo-client](../README.md) / [Exports](../modules.md) / IBusinessDataSocialMediaPinterestLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IBusinessDataSocialMediaPinterestLiveTaskInfo`**
...
- [cost](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#cost)
- [data](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#data)
- [id](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#id)
- [path](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#path)
- [result](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#result)
- [result\_count](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#result_count)
- [status\_code](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#status_code)
- [status\_message](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#status_message)
- [time](IBusinessDataSocialMediaPinterestLiveTaskInfo.md#time)
...
[main.ts:205822](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L205822)
