[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationGenerateLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationGenerateLiveTaskInfo`**
...
- [cost](IContentGenerationGenerateLiveTaskInfo.md#cost)
- [data](IContentGenerationGenerateLiveTaskInfo.md#data)
- [id](IContentGenerationGenerateLiveTaskInfo.md#id)
- [path](IContentGenerationGenerateLiveTaskInfo.md#path)
- [result](IContentGenerationGenerateLiveTaskInfo.md#result)
- [result\_count](IContentGenerationGenerateLiveTaskInfo.md#result_count)
- [status\_code](IContentGenerationGenerateLiveTaskInfo.md#status_code)
- [status\_message](IContentGenerationGenerateLiveTaskInfo.md#status_message)
- [time](IContentGenerationGenerateLiveTaskInfo.md#time)
...
[main.ts:160143](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L160143)
