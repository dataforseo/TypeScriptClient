[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppListTaskGetAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppListTaskGetAdvancedTaskInfo`**
...
- [cost](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#cost)
- [data](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#data)
- [id](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#id)
- [path](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#path)
- [result](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#status_message)
- [time](IAppDataGoogleAppListTaskGetAdvancedTaskInfo.md#time)
...
[main.ts:178968](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L178968)
