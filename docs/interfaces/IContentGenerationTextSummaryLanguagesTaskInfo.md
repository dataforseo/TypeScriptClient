...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentGenerationTextSummaryLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentGenerationTextSummaryLanguagesTaskInfo`**
...
- [cost](IContentGenerationTextSummaryLanguagesTaskInfo.md#cost)
- [data](IContentGenerationTextSummaryLanguagesTaskInfo.md#data)
- [id](IContentGenerationTextSummaryLanguagesTaskInfo.md#id)
- [path](IContentGenerationTextSummaryLanguagesTaskInfo.md#path)
- [result](IContentGenerationTextSummaryLanguagesTaskInfo.md#result)
- [result\_count](IContentGenerationTextSummaryLanguagesTaskInfo.md#result_count)
- [status\_code](IContentGenerationTextSummaryLanguagesTaskInfo.md#status_code)
- [status\_message](IContentGenerationTextSummaryLanguagesTaskInfo.md#status_message)
- [time](IContentGenerationTextSummaryLanguagesTaskInfo.md#time)
...
[main.ts:162591](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L162591)
