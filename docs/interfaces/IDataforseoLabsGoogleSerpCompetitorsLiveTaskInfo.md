...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo`**
...
- [cost](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#cost)
- [data](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#data)
- [id](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#id)
- [path](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#path)
- [result](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#result)
- [result\_count](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#result_count)
- [status\_code](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#status_code)
- [status\_message](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#status_message)
- [time](IDataforseoLabsGoogleSerpCompetitorsLiveTaskInfo.md#time)
...
[main.ts:87946](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L87946)
