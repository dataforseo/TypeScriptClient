[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataAppleAppInfoTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataAppleAppInfoTasksReadyTaskInfo`**
...
- [cost](IAppDataAppleAppInfoTasksReadyTaskInfo.md#cost)
- [data](IAppDataAppleAppInfoTasksReadyTaskInfo.md#data)
- [id](IAppDataAppleAppInfoTasksReadyTaskInfo.md#id)
- [path](IAppDataAppleAppInfoTasksReadyTaskInfo.md#path)
- [result](IAppDataAppleAppInfoTasksReadyTaskInfo.md#result)
- [result\_count](IAppDataAppleAppInfoTasksReadyTaskInfo.md#result_count)
- [status\_code](IAppDataAppleAppInfoTasksReadyTaskInfo.md#status_code)
- [status\_message](IAppDataAppleAppInfoTasksReadyTaskInfo.md#status_message)
- [time](IAppDataAppleAppInfoTasksReadyTaskInfo.md#time)
...
[main.ts:184308](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L184308)
