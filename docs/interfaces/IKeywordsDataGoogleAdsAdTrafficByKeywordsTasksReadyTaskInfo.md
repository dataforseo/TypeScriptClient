...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo`**
...
- [cost](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#cost)
- [data](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#data)
- [id](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#id)
- [path](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#path)
- [result](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#result)
- [result\_count](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#result_count)
- [status\_code](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#status_code)
- [status\_message](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#status_message)
- [time](IKeywordsDataGoogleAdsAdTrafficByKeywordsTasksReadyTaskInfo.md#time)
...
[main.ts:118125](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L118125)
