...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesLanguagesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesLanguagesTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesLanguagesTaskInfo.md#time)
...
[main.ts:72038](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L72038)
