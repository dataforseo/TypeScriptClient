...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleSearchByImageTasksFixedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleSearchByImageTasksFixedTaskInfo`**
...
- [cost](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#cost)
- [data](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#data)
- [id](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#id)
- [path](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#path)
- [result](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#result)
- [result\_count](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#result_count)
- [status\_code](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#status_code)
- [status\_message](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#status_message)
- [time](ISerpGoogleSearchByImageTasksFixedTaskInfo.md#time)
...
[main.ts:47954](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L47954)
