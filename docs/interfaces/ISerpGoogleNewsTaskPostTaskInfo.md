...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpGoogleNewsTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpGoogleNewsTaskPostTaskInfo`**
...
- [cost](ISerpGoogleNewsTaskPostTaskInfo.md#cost)
- [data](ISerpGoogleNewsTaskPostTaskInfo.md#data)
- [id](ISerpGoogleNewsTaskPostTaskInfo.md#id)
- [path](ISerpGoogleNewsTaskPostTaskInfo.md#path)
- [result](ISerpGoogleNewsTaskPostTaskInfo.md#result)
- [result\_count](ISerpGoogleNewsTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpGoogleNewsTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpGoogleNewsTaskPostTaskInfo.md#status_message)
- [time](ISerpGoogleNewsTaskPostTaskInfo.md#time)
...
[main.ts:42004](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L42004)
