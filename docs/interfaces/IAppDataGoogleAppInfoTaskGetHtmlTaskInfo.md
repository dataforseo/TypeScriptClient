[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleAppInfoTaskGetHtmlTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleAppInfoTaskGetHtmlTaskInfo`**
...
- [cost](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#cost)
- [data](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#data)
- [id](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#id)
- [path](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#path)
- [result](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#result)
- [result\_count](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#status_message)
- [time](IAppDataGoogleAppInfoTaskGetHtmlTaskInfo.md#time)
...
[main.ts:180524](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L180524)
