...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicLiveAdvancedTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicLiveAdvancedTaskInfo`**
...
- [cost](ISerpBingOrganicLiveAdvancedTaskInfo.md#cost)
- [data](ISerpBingOrganicLiveAdvancedTaskInfo.md#data)
- [id](ISerpBingOrganicLiveAdvancedTaskInfo.md#id)
- [path](ISerpBingOrganicLiveAdvancedTaskInfo.md#path)
- [result](ISerpBingOrganicLiveAdvancedTaskInfo.md#result)
- [result\_count](ISerpBingOrganicLiveAdvancedTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicLiveAdvancedTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicLiveAdvancedTaskInfo.md#status_message)
- [time](ISerpBingOrganicLiveAdvancedTaskInfo.md#time)
...
[main.ts:55408](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L55408)
