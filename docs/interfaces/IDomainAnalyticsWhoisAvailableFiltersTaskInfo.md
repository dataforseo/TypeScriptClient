[Documentation](../README.md) / [Exports](../modules.md) / IDomainAnalyticsWhoisAvailableFiltersTaskInfo
...
- [cost](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#cost)
- [data](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#data)
- [id](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#id)
- [path](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#path)
- [result](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#result)
- [result\_count](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#status_message)
- [time](IDomainAnalyticsWhoisAvailableFiltersTaskInfo.md#time)
