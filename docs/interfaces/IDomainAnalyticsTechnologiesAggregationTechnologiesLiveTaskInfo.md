...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo`**
...
- [cost](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#cost)
- [data](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#data)
- [id](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#id)
- [path](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#path)
- [result](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#result)
- [result\_count](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#result_count)
- [status\_code](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#status_code)
- [status\_message](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#status_message)
- [time](IDomainAnalyticsTechnologiesAggregationTechnologiesLiveTaskInfo.md#time)
...
[main.ts:72942](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L72942)
