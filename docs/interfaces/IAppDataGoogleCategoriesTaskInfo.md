...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IAppDataGoogleCategoriesTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IAppDataGoogleCategoriesTaskInfo`**
...
- [cost](IAppDataGoogleCategoriesTaskInfo.md#cost)
- [data](IAppDataGoogleCategoriesTaskInfo.md#data)
- [id](IAppDataGoogleCategoriesTaskInfo.md#id)
- [path](IAppDataGoogleCategoriesTaskInfo.md#path)
- [result](IAppDataGoogleCategoriesTaskInfo.md#result)
- [result\_count](IAppDataGoogleCategoriesTaskInfo.md#result_count)
- [status\_code](IAppDataGoogleCategoriesTaskInfo.md#status_code)
- [status\_message](IAppDataGoogleCategoriesTaskInfo.md#status_message)
- [time](IAppDataGoogleCategoriesTaskInfo.md#time)
...
[main.ts:177074](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L177074)
