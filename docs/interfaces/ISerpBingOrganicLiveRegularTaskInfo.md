...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingOrganicLiveRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingOrganicLiveRegularTaskInfo`**
...
- [cost](ISerpBingOrganicLiveRegularTaskInfo.md#cost)
- [data](ISerpBingOrganicLiveRegularTaskInfo.md#data)
- [id](ISerpBingOrganicLiveRegularTaskInfo.md#id)
- [path](ISerpBingOrganicLiveRegularTaskInfo.md#path)
- [result](ISerpBingOrganicLiveRegularTaskInfo.md#result)
- [result\_count](ISerpBingOrganicLiveRegularTaskInfo.md#result_count)
- [status\_code](ISerpBingOrganicLiveRegularTaskInfo.md#status_code)
- [status\_message](ISerpBingOrganicLiveRegularTaskInfo.md#status_message)
- [time](ISerpBingOrganicLiveRegularTaskInfo.md#time)
...
[main.ts:55148](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L55148)
