...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageResourcesTaskInfo
...
- [cost](IOnPageResourcesTaskInfo.md#cost)
- [data](IOnPageResourcesTaskInfo.md#data)
- [id](IOnPageResourcesTaskInfo.md#id)
- [path](IOnPageResourcesTaskInfo.md#path)
- [result](IOnPageResourcesTaskInfo.md#result)
- [result\_count](IOnPageResourcesTaskInfo.md#result_count)
- [status\_code](IOnPageResourcesTaskInfo.md#status_code)
- [status\_message](IOnPageResourcesTaskInfo.md#status_message)
- [time](IOnPageResourcesTaskInfo.md#time)
...
[main.ts:146617](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L146617)
