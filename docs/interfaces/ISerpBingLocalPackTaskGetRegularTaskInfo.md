...
[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpBingLocalPackTaskGetRegularTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpBingLocalPackTaskGetRegularTaskInfo`**
...
- [cost](ISerpBingLocalPackTaskGetRegularTaskInfo.md#cost)
- [data](ISerpBingLocalPackTaskGetRegularTaskInfo.md#data)
- [id](ISerpBingLocalPackTaskGetRegularTaskInfo.md#id)
- [path](ISerpBingLocalPackTaskGetRegularTaskInfo.md#path)
- [result](ISerpBingLocalPackTaskGetRegularTaskInfo.md#result)
- [result\_count](ISerpBingLocalPackTaskGetRegularTaskInfo.md#result_count)
- [status\_code](ISerpBingLocalPackTaskGetRegularTaskInfo.md#status_code)
- [status\_message](ISerpBingLocalPackTaskGetRegularTaskInfo.md#status_message)
- [time](ISerpBingLocalPackTaskGetRegularTaskInfo.md#time)
...
[main.ts:56414](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L56414)
