[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpYoutubeVideoInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpYoutubeVideoInfoTaskPostTaskInfo`**
...
- [cost](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#cost)
- [data](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#data)
- [id](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#id)
- [path](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#path)
- [result](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#result)
- [result\_count](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#status_message)
- [time](ISerpYoutubeVideoInfoTaskPostTaskInfo.md#time)
...
[main.ts:58010](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L58010)
