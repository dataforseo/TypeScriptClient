...
[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPagePagesTaskInfo
...
- [cost](IOnPagePagesTaskInfo.md#cost)
- [data](IOnPagePagesTaskInfo.md#data)
- [id](IOnPagePagesTaskInfo.md#id)
- [path](IOnPagePagesTaskInfo.md#path)
- [result](IOnPagePagesTaskInfo.md#result)
- [result\_count](IOnPagePagesTaskInfo.md#result_count)
- [status\_code](IOnPagePagesTaskInfo.md#status_code)
- [status\_message](IOnPagePagesTaskInfo.md#status_message)
- [time](IOnPagePagesTaskInfo.md#time)
...
[main.ts:145269](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L145269)
