[dataforseo-client](../README.md) / [Exports](../modules.md) / IOnPageWaterfallTaskInfo
...
- [cost](IOnPageWaterfallTaskInfo.md#cost)
- [data](IOnPageWaterfallTaskInfo.md#data)
- [id](IOnPageWaterfallTaskInfo.md#id)
- [path](IOnPageWaterfallTaskInfo.md#path)
- [result](IOnPageWaterfallTaskInfo.md#result)
- [result\_count](IOnPageWaterfallTaskInfo.md#result_count)
- [status\_code](IOnPageWaterfallTaskInfo.md#status_code)
- [status\_message](IOnPageWaterfallTaskInfo.md#status_message)
- [time](IOnPageWaterfallTaskInfo.md#time)
...
[main.ts:149979](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L149979)
