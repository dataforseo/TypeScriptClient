[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantAmazonLocationsCountryTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantAmazonLocationsCountryTaskInfo`**
...
- [cost](IMerchantAmazonLocationsCountryTaskInfo.md#cost)
- [data](IMerchantAmazonLocationsCountryTaskInfo.md#data)
- [id](IMerchantAmazonLocationsCountryTaskInfo.md#id)
- [path](IMerchantAmazonLocationsCountryTaskInfo.md#path)
- [result](IMerchantAmazonLocationsCountryTaskInfo.md#result)
- [result\_count](IMerchantAmazonLocationsCountryTaskInfo.md#result_count)
- [status\_code](IMerchantAmazonLocationsCountryTaskInfo.md#status_code)
- [status\_message](IMerchantAmazonLocationsCountryTaskInfo.md#status_message)
- [time](IMerchantAmazonLocationsCountryTaskInfo.md#time)
...
[main.ts:170071](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L170071)
