...
- [depth](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#depth)
- [device](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#device)
- [keyword](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#keyword)
- [language\_code](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#language_code)
- [language\_name](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#language_name)
- [location\_code](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#location_code)
- [location\_coordinate](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#location_coordinate)
- [location\_name](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#location_name)
- [min\_rating](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#min_rating)
- [os](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#os)
- [priority](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#priority)
- [tag](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#tag)
- [time\_filter](ISerpGoogleLocalFinderLiveAdvancedRequestInfo.md#time_filter)
