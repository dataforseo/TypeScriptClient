[dataforseo-client](../README.md) / [Exports](../modules.md) / IMerchantGoogleProductInfoTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IMerchantGoogleProductInfoTaskPostTaskInfo`**
...
- [cost](IMerchantGoogleProductInfoTaskPostTaskInfo.md#cost)
- [data](IMerchantGoogleProductInfoTaskPostTaskInfo.md#data)
- [id](IMerchantGoogleProductInfoTaskPostTaskInfo.md#id)
- [path](IMerchantGoogleProductInfoTaskPostTaskInfo.md#path)
- [result](IMerchantGoogleProductInfoTaskPostTaskInfo.md#result)
- [result\_count](IMerchantGoogleProductInfoTaskPostTaskInfo.md#result_count)
- [status\_code](IMerchantGoogleProductInfoTaskPostTaskInfo.md#status_code)
- [status\_message](IMerchantGoogleProductInfoTaskPostTaskInfo.md#status_message)
- [time](IMerchantGoogleProductInfoTaskPostTaskInfo.md#time)
...
[main.ts:168715](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L168715)
