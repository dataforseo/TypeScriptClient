[dataforseo-client](../README.md) / [Exports](../modules.md) / ISerpNaverOrganicTaskPostTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`ISerpNaverOrganicTaskPostTaskInfo`**
...
- [cost](ISerpNaverOrganicTaskPostTaskInfo.md#cost)
- [data](ISerpNaverOrganicTaskPostTaskInfo.md#data)
- [id](ISerpNaverOrganicTaskPostTaskInfo.md#id)
- [path](ISerpNaverOrganicTaskPostTaskInfo.md#path)
- [result](ISerpNaverOrganicTaskPostTaskInfo.md#result)
- [result\_count](ISerpNaverOrganicTaskPostTaskInfo.md#result_count)
- [status\_code](ISerpNaverOrganicTaskPostTaskInfo.md#status_code)
- [status\_message](ISerpNaverOrganicTaskPostTaskInfo.md#status_message)
- [time](ISerpNaverOrganicTaskPostTaskInfo.md#time)
...
[main.ts:67522](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L67522)
