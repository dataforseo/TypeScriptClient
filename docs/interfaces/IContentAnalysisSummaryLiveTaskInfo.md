[dataforseo-client](../README.md) / [Exports](../modules.md) / IContentAnalysisSummaryLiveTaskInfo
...
- [`IBaseResponseTaskInfo`](IBaseResponseTaskInfo.md)
  ...
  ↳ **`IContentAnalysisSummaryLiveTaskInfo`**
...
- [cost](IContentAnalysisSummaryLiveTaskInfo.md#cost)
- [data](IContentAnalysisSummaryLiveTaskInfo.md#data)
- [id](IContentAnalysisSummaryLiveTaskInfo.md#id)
- [path](IContentAnalysisSummaryLiveTaskInfo.md#path)
- [result](IContentAnalysisSummaryLiveTaskInfo.md#result)
- [result\_count](IContentAnalysisSummaryLiveTaskInfo.md#result_count)
- [status\_code](IContentAnalysisSummaryLiveTaskInfo.md#status_code)
- [status\_message](IContentAnalysisSummaryLiveTaskInfo.md#status_message)
- [time](IContentAnalysisSummaryLiveTaskInfo.md#time)
...
[main.ts:157549](https://github.com/dataforseo/TypeScriptClient/blob/7ca1aa4/main.ts#L157549)
