...
**cid** | **string** | *google-defined client id*. unique id of a local establishment. learn more about the `cid` identifier in [this help center article](https://dataforseo.com/help-center/what-is-cid-place-id-feature-id) |[optional]|
