...
**tag** | **string** |  |[optional]|
**endpoint_advanced** | **string** | *URL for collecting the results of the {{up_se_name}} {{normal_se_type}} task* |[optional]|
**endpoint_html** | **string** | *URL for collecting the results of the {{up_se_name}} {{normal_se_type}} HTML task*. if HTML tasks are not supported in the specified endpoint, the value will be `null` |[optional]|