...
**block_rank** | **number** | *block rank in SERP*. position among all the blocks in SERP |[optional]|
**block_name** | **string** | *name of the block in SERP*. example:. `'People also watched'` |[optional]|
**channel_id** | **string** | *ID of the channel* |[optional]|
**url** | **string** | *URL of the channel* |[optional]|