...
**product_id** | **string** | product_id received in a POST array. ilearn more about the parameter in this help center guide |[optional]|
...
**gid** | **string** | global product identifier on Google Shopping. note that there is no full list of possible values as the gid is a dynamic value assigned by Google. if there are no values, you will get null. example:. 4702526954592161872. learn more about gid in this help center guide |[optional]|
