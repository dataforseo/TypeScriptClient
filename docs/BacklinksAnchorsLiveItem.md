...
**first_seen** | **string** | *date and time when our crawler found the backlink with this anchor for the first time*. in the UTC format: “yyyy-mm-dd hh-mm-ss +00:00”. example:. `2019-11-15 12:57:46 +00:00` |[optional]|
...
**backlinks_spam_score** | **number** | *average spam score of all backlinks with this anchor*. learn more about how the metric is calculated on [this help center page](https://dataforseo.com/help-center/what-is-spam-score-and-how-is-it-calculated) |[optional]|
