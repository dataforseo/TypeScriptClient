...
**offset** | **number** | offset in the results array of the returned mentions data<br>offset specified in the request |[optional]|
...
**items** | **AiOptimizationLlmMentionsTopMentionedBrandCategoriesLiteLiveItem[]** | contains relevant mentions data |[optional]|